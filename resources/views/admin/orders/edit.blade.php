...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Update Order: {{ $order->order_number }}</div>
            <div class="card-body">
                <form action="{{ route('admin.orders.update', $order) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Base Price (Plan)</label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Use positive (e.g. 2 for +$2) or negative (e.g. -2 for -$2)</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($order->package)
                        <small class="d-block text-muted">Calculated as: Plan (${{ $order->package->price }}) + Adjustment</small>
                        @endif
                    </div>
