    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 16px; color: #374151; line-height: 1.6; margin: 0 0 30px;">
                Thank you for choosing 4khdiptv! Your payment has been successfully processed, and your IPTV subscription is now active. Below you'll find everything you need to get started.
            </p>
            ...
            <div class="credentials-box">
                ...
                <div class="credential-item">
                    ...
                    <div class="credential-value">http://4khdiptv.org:8080</div>
                </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 12px;">
                © {{ date('Y') }} 4khdiptv. All rights reserved.
            </p>
        </div>
    </div>
</body>
