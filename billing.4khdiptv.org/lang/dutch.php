...
$_LANG['addToCartButton'] = "Add to Cart";
$_LANG['addToGetFreeDomain'] = "Voeg toe om een gratis domein te krijgen";
...
$_LANG['billing']['ledger']['date'] = "Date";
$_LANG['billing']['ledger']['reference'] = "Referentie";
$_LANG['billing']['ledger']['title'] = "Grootboek";
$_LANG['billing']['ledger']['type'] = "Type";
$_LANG['billing']['type']['affiliatepayout'] = "Uitbetaling via een affiliate";
$_LANG['billing']['type']['clientaccountcredit'] = "Krediet op klantenaccount";
$_LANG['billing']['type']['clientaccountdebit'] = "Debitering van klantenrekening";
$_LANG['billing']['type']['creditnoteadjustment'] = "Aanpassing van de kredietnota";
$_LANG['billing']['type']['invoiceadjustment'] = "Aanpassing van de factuur";
$_LANG['billing']['type']['payment'] = "Betaling";
$_LANG['billing']['type']['refund'] = "Terugbetalen";
...
$_LANG['cartItemType']['addons'] = "Addons";
$_LANG['cartItemType']['bundle'] = "Bundeltje";
$_LANG['cartItemType']['bundles'] = "bundels";
$_LANG['cartItemType']['domain'] = "Domain";
$_LANG['cartItemType']['domainRegistration'] = "Domain Registration";
$_LANG['cartItemType']['domainRenewal'] = "Domain Renewal";
$_LANG['cartItemType']['domainRenewals'] = "Domain Renewals";
$_LANG['cartItemType']['domainTransfer'] = "Domain Transfer";
...
$_LANG['cartItemsSelected'] = "Je hebt :count geselecteerd en klaar om te kopen.";
...
$_LANG['choosePackages'] = "Kies uit verschillende pakketten";
...
$_LANG['designedToFitAnyBudget'] = "Ontworpen voor elk budget";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Zoek op trefwoord, beschrijving of domein.&#10;Bijvoorbeeld: &quot;Leuke zakelijke evenementen &quot;, &quot;Een uitgebreide financiële planningsservice voor professionals&quot;, of &quot;example.com&quot;.";
...
$_LANG['domainSearch']['notAvailable'] = "Not Available";
$_LANG['domainSearch']['safeSearch'] = "Veilig zoeken";
$_LANG['domainSearch']['tlds'] = "TLD's opnemen";
$_LANG['domainSearch']['topAiSuggestion'] = "Topsuggestie voor AI";
$_LANG['domainSearch']['topSuggestion'] = "Topsuggestie";
...
$_LANG['dynamicServiceFields']['validation']['accepted'] = "U moet de servicevoorwaarden accepteren door :attributeaan te vinken.";
...
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute moet een geldige reguliere expressie zijn.";
...
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Homepage";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Je hebt te veel verzoeken verzonden.";
...
$_LANG['estimateTaxes'] = "Estimate Taxes";
$_LANG['every'] = "Elke";
$_LANG['exampledomain'] = "Typ hier je gewenste domeinnaam";
$_LANG['excludeTLDs'] = "Excludes certain TLDs and recently renewed domains";
...
$_LANG['extendYourDomainBy1Year'] = "Verleng je domein met 1 jaar*";
...
$_LANG['freeDomainHostingPromo'] = "Ontvang een gratis domein bij aankoop van hosting.";
$_LANG['from'] = "Van";
...
$_LANG['incApplicableTaxes'] = "inclusief toepasselijke belastingen";
...
$_LANG['invalid_ticket_id_or_reply_id'] = "Ongeldig ticketnummer of antwoordnummer.";
...
$_LANG['marketConnect']['socialbee']['manage'] = "Meld je aan bij SocialBee";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dynamische services";
...
$_LANG['orderForm']['additionalInformation'] = "Additional Information";
...
$_LANG['ordererrortldsnotconfigured'] = "Er zijn momenteel geen domeinextensies beschikbaar voor verkoop. Neem voor hulp contact met ons op.";
...
$_LANG['orderpaymenttermadjectivefree'] = "Free";
$_LANG['orderpaymenttermadjectivemonthly'] = "Monthly";
$_LANG['orderpaymenttermadjectiveonetime'] = "One Time";
$_LANG['orderpaymenttermadjectivequarterly'] = "Quarterly";
...
$_LANG['orderselectterm'] = "Selecteer een term";
...
$_LANG['priceForThisTerm'] = "Prijs voor deze termijn";
$_LANG['priceStandard'] = "Wordt elk jaar verlengd op :renewalPrice, plus belasting.";
...
$_LANG['pwstrengthfail'] = "Dit wachtwoord is niet sterk genoeg. Voer een complexer wachtwoord in.";
...
$_LANG['renewPrice'] = "Prijs vernieuwen";
...
$_LANG['searchResults'] = "Search Results";
...
$_LANG['selectCountry'] = "Select Country";
$_LANG['selectDomain'] = "Domein selecteren";
$_LANG['selectDomainForHosting'] = "Aan welk domein zou je dit shared hostingpakket willen koppelen?";
$_LANG['selectDomainsForSsl'] = "Op welk (e) domein (en) wilt u de basis-SSL toepassen? Je kunt er meerdere selecteren.";
$_LANG['selectState'] = "Selecteer een staat";
...
$_LANG['ssl']['installFurtherInfo'] = "Zie voor meer informatie de pagina :anchorRapidSSL-installatiehulp:endAnchor.";
...
$_LANG['store']['error']['serviceUnavailable'] = "Kan je aanvraag op dit moment niet verwerken. Dit kan te wijten zijn aan een time-out of een tijdelijk serviceprobleem. Probeer het nog eens.";
$_LANG['store']['error']['validationFailed'] = "Controleer en corrigeer de onderstaande fouten.";
$_LANG['store']['faq'] = "Veel gestelde vragen";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo biedt u een bewezen, begeleid SEO-proces zonder dat u een expert hoeft te zijn. <br> marketgoo is betaalbaar en biedt uitgebreide SEO-rapporten, plannen en aanbevelingen, allemaal in een intuïtieve interface.";
...
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Inzending van zoekmachines";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Compatibiliteit met Website Builder";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Maandelijks voortgangsrapport";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Verkeersanalyses";
...
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-aangedreven functies: automatische generatie van titel en metabeschrijving";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Gescande pagina's";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Concurrenten volgen";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Trefwoorden volgen en optimaliseren";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Bijgewerkt rapport en plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "SEO-plan op maat";
$_LANG['store']['marketgoo']['features']['1'] = "Verkrijg je SEO-plan";
$_LANG['store']['marketgoo']['features']['2'] = "Volg de stapsgewijze instructies";
$_LANG['store']['marketgoo']['features']['3'] = "Bewaak de voortgang met een maandelijks rapport";
$_LANG['store']['marketgoo']['features']['4'] = "Concurrenten volgen en volgen";
$_LANG['store']['marketgoo']['features']['5'] = "Individuele pagina-optimalisatie";
$_LANG['store']['marketgoo']['features']['6'] = "Eenvoudig trefwoordonderzoek en -monitoring";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Meld u aan en ontvang direct uw SEO-rapport en -plan. Kijk waar er ruimte is voor verbetering en ontvang aanbevelingen op maat van je site.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "De instructies zijn geschreven voor niet-technisch onderlegde gebruikers en begeleiden u bij elke aanbeveling, met voorbeelden en uitleg.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Ontvang elke maand een e-mail met de SEO-voortgang van je site en download deze als PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Houd concurrenten in de gaten om te zien wat ze doen om bezoekers te trekken en hoe uw cijfers zich verhouden tot die van hen. Ze zullen nooit weten dat je kijkt!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo helpt u bij het optimaliseren van elke afzonderlijke pagina op uw site door deze te koppelen aan een van de door u gekozen trefwoorden en ervoor te zorgen dat de frequentie en plaatsing correct zijn.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Trefwoorden kunnen overweldigend zijn als u niet bekend bent met SEO. Marketgoo raadt trefwoorden aan en stelt u ook in staat om te zoeken naar de trefwoorden waarvoor u wilt optimaliseren en deze in te voeren.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline4'] = "Het gaat niemand aan wat je online doet. Daarom volgen, verzamelen of delen we uw privégegevens niet. We kunnen geen informatie over u verstrekken aan derden, zelfs niet als ze daarom vragen.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Telkens wanneer u een bestand downloadt, inspecteert Threat Protection Pro™ het op malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokkeert opdringerige advertenties en webtrackers en scant automatisch URL's en blokkeert kwaadaardige URL's.";
...
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "De :tagOpenThreat Protection Pro™:tagClose -functie van NordVPN is een doorbraak die nog meer beveiligingsvoordelen en betere bescherming biedt met een enkele extra klik.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Smart home-technologieën, met name onveilige IoT-apparaten, kunnen kwetsbaarheden in de thuisnetwerken veroorzaken.";
...
$_LANG['store']['nordvpn']['features']['world']['tagline'] = "Kies uit duizenden supersnelle VPN-servers wereldwijd.:tagBreakProfiteer van een stabiele verbinding, waar u ook bent.";
...
$_LANG['store']['ox']['faq8']['answer'] = "OX App Suite ondersteunt de volgende talen: Engels, Duits, Spaans, Frans, Italiaans, Nederlands, Pools, Engels, Engels, Engels, Pools,";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Ontwerp nieuwe inhoud, verbeter de betrokkenheid en houd je resultaten bij met SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee beheer van sociale media";
$_LANG['store']['socialbee']['comparison']['2years'] = "Tot 2 jaar";
$_LANG['store']['socialbee']['comparison']['3months'] = "Tot 3 maanden";
$_LANG['store']['socialbee']['comparison']['AICreation'] = "Creatie van AI-inhoud";
$_LANG['store']['socialbee']['comparison']['accounts'] = "Accounts op sociale media";
$_LANG['store']['socialbee']['comparison']['addons'] = "Add-ons voor gebruikers, werkruimten en profielen";
$_LANG['store']['socialbee']['comparison']['analytics'] = "Analyse van sociale media";
$_LANG['store']['socialbee']['comparison']['approval'] = "Goedkeuring van de inhoud";
$_LANG['store']['socialbee']['comparison']['automation'] = "Integraties van automatiseringstools";
...
$_LANG['store']['socialbee']['comparison']['categories'] = "Inhoudscategorieën (mappen)";
$_LANG['store']['socialbee']['comparison']['collaboration'] = "Samenwerking tussen teams";
$_LANG['store']['socialbee']['comparison']['comparePlans'] = "Abonnementen vergelijken";
$_LANG['store']['socialbee']['comparison']['comparePrices'] = "Prijzen vergelijken";
$_LANG['store']['socialbee']['comparison']['contentSchedulingPublishing'] = "Planning en publicatie van inhoud";
$_LANG['store']['socialbee']['comparison']['curation'] = "Curatie van inhoud";
$_LANG['store']['socialbee']['comparison']['curator'] = "Integraties van contentcuratoren";
$_LANG['store']['socialbee']['comparison']['dataAccess'] = "Toegang tot historische gegevens";
$_LANG['store']['socialbee']['comparison']['drafts'] = "Concepten plaatsen";
$_LANG['store']['socialbee']['comparison']['exportBrandedReports'] = "Rapporten van merken exporteren";
...
$_LANG['store']['socialbee']['comparison']['notes'] = "Interne notities (feedback)";
$_LANG['store']['socialbee']['comparison']['postSuggestions'] = "Beste suggesties voor de publicatietijd";
$_LANG['store']['socialbee']['comparison']['posts'] = "Berichten per categorie";
$_LANG['store']['socialbee']['comparison']['resharing'] = "Herdelen van inhoud";
$_LANG['store']['socialbee']['comparison']['sminbox'] = "Inbox voor sociale media";
...
$_LANG['store']['socialbee']['comparison']['uniposting'] = "Universele plaatsing";
$_LANG['store']['socialbee']['comparison']['unlimited'] = "Ongelimiteerd";
$_LANG['store']['socialbee']['comparison']['unsplash'] = "Unsplash-integratie";
$_LANG['store']['socialbee']['comparison']['urlshorteners'] = "Integraties van URL-verkorters";
$_LANG['store']['socialbee']['comparison']['users'] = "Gebruikers";
$_LANG['store']['socialbee']['comparison']['workspaces'] = "Toegewijde werkruimten";
$_LANG['store']['socialbee']['content']['header'] = "Behandel al je social media-taken vanaf één plek.";
$_LANG['store']['socialbee']['content']['p1'] = "Als je je social media-accounts handmatig beheert, ben je waarschijnlijk uren bezig met het jongleren met meerdere platforms en tabbladen.";
$_LANG['store']['socialbee']['content']['p2'] = "SocialBee maakt het eenvoudiger door je vooraf berichten te laten maken en plannen, zodat je accounts actief blijven, zelfs als je het druk hebt of even pauze neemt. Het regelt het posten voor je, bespaart je de stress van handmatig posten, en biedt AI-tools waarmee je in een mum van tijd inhoud kunt creëren.";
$_LANG['store']['socialbee']['content']['p3'] = "Je kunt ook reageren op opmerkingen, vermeldingen en berichten, samenwerken met je team en je prestaties volgen, allemaal zonder een tweede tabblad te openen.";
$_LANG['store']['socialbee']['faq']['a1'] = "Je kunt content beheren en plannen voor populaire platforms zoals Facebook, Instagram, Threads, X™ (voorheen Twitter™), LinkedIn, Pinterest, Google Business Profile™, TikTok, YouTube™ en Bluesky.";
$_LANG['store']['socialbee']['faq']['a2']['i1'] = "Een alles-in-één beheertool voor sociale media die alles afhandelt, van het maken, plannen en delen van inhoud tot analyses, sociale inbox en teamsamenwerking.";
$_LANG['store']['socialbee']['faq']['a2']['i2'] = "Ondersteuning via <a href='href=https://socialbee.com/calendar/'>-gesprekken</a>, chat- of e-mailcommunicatie. We zijn een van de weinige tools voor sociale media die nog steeds oproepondersteuning bieden.";
$_LANG['store']['socialbee']['faq']['a2']['i3'] = "<a href='https://socialbee.com/webinars/'>Maandelijkse live demo's</a> over het gebruik van SocialBee, <a href='https://help.socialbee.com/'>gedetailleerde helpdocumentatie</a>, <a href='https://www.youtube.com/@SocialBeeHQ'>korte tutorials</a>en vele <a href='https://socialbee.com/resources/'>andere bronnen voor sociale media</a>.";
$_LANG['store']['socialbee']['faq']['a2']['i4'] = "Een <a href='https://socialbee.com/roadmap/'>transparante productroadmap</a> voor wat er komt na SocialBee.";
$_LANG['store']['socialbee']['faq']['a2']['i5'] = "<a href='https://changelog.socialbee.com/'>Maandelijkse productreleases</a>.";
$_LANG['store']['socialbee']['faq']['a2']['text'] = "Werken met SocialBee geeft je:";
...
$_LANG['store']['socialbee']['faq']['a4']['text'] = "De agency-abonnementen (Pro50, Pro100 en Pro150) hebben dezelfde functies als het Pro-abonnement. De belangrijkste verschillen zijn het aantal social media-profielen dat je kunt koppelen, het aantal werkruimten en de gebruikers die je aan een werkruimte kunt toevoegen:";
$_LANG['store']['socialbee']['faq']['a5'] = "De servers van SocialBee bevinden zich in Ierland, Europa.";
$_LANG['store']['socialbee']['faq']['q1'] = "Welke social media platforms kan ik beheren met SocialBee?";
$_LANG['store']['socialbee']['faq']['q2'] = "Waarom zou ik voor SocialBee kiezen in plaats van andere tools?";
$_LANG['store']['socialbee']['faq']['q3'] = "Welke ondersteuningsopties zijn beschikbaar voor SocialBee-gebruikers?";
$_LANG['store']['socialbee']['faq']['q4'] = "Zijn de bureauabonnementen van SocialBee anders dan het reguliere Pro-abonnement?";
...
$_LANG['store']['socialbee']['faq']['unanswered'] = "Heb je nog meer vragen?";
$_LANG['store']['socialbee']['features']['analyze']['i1'] = "Krijg een duidelijk beeld van de voortgang van je sociale media met eenvoudig te begrijpen statistieken, visuele grafieken, kaarten en meer.";
$_LANG['store']['socialbee']['features']['analyze']['i2'] = "Volg de betrokkenheid, vertoningen, klikfrequenties en de groei van het aantal volgers in de loop van de tijd voor al je sociale media-accounts.";
$_LANG['store']['socialbee']['features']['analyze']['i3'] = "Volg individuele prestaties na afloop om te zien wat je publiek aanspreekt.";
$_LANG['store']['socialbee']['features']['analyze']['i4'] = "Vergelijk de prestaties van het platform om te bepalen waar je inspanningen het meeste opleveren.";
$_LANG['store']['socialbee']['features']['analyze']['i5'] = "Filter je analyses op platform en datumbereik om een duidelijker beeld te krijgen van je prestaties.";
$_LANG['store']['socialbee']['features']['analyze']['i6'] = "Download professionele PDF-analyserapporten om te delen met klanten of teamleden.";
$_LANG['store']['socialbee']['features']['collaborate']['i1'] = "Deel feedback en tag je collega's rechtstreeks op inhoudsconcepten.";
$_LANG['store']['socialbee']['features']['collaborate']['i2'] = "Keur berichten goed voordat ze live gaan om typefouten of fouten op te sporen.";
$_LANG['store']['socialbee']['features']['collaborate']['i3'] = "Houd de teamactiviteit bij om te weten wie waaraan heeft gewerkt en wanneer.";
$_LANG['store']['socialbee']['features']['collaborate']['i4'] = "Voorkom dubbel werk met een gedeelde ruimte voor samenwerking.";
$_LANG['store']['socialbee']['features']['collaborate']['i5'] = "Geef teamleden specifieke machtigingen op basis van hun rollen.";
$_LANG['store']['socialbee']['features']['collaborate']['i6'] = "Beheer meerdere merken of klanten met aparte, georganiseerde werkruimten.";
$_LANG['store']['socialbee']['features']['create']['i1'] = "SocialBee integreert met Canva, Unsplash en GIPHY, zodat je eenvoudig beelden voor je berichten kunt maken en beheren.";
$_LANG['store']['socialbee']['features']['create']['i2'] = "Genereer binnen enkele seconden ondertitels en afbeeldingen met AI en krijg toegang tot meer dan 1.000 vooraf gemaakte prompts om tijd te besparen.";
$_LANG['store']['socialbee']['features']['create']['i3'] = "Pas berichten automatisch aan met AI of handmatig voor elk platform om ervoor te zorgen dat je content het beste werkt, waar deze ook wordt gedeeld.";
$_LANG['store']['socialbee']['features']['create']['i4'] = "Laat Copilot, de AI-assistent van SocialBee, binnen enkele minuten een gepersonaliseerd contentplan voor je maken. Je hoeft niet meer te raden wat je moet posten en wanneer.";
$_LANG['store']['socialbee']['features']['create']['i5'] = "Organiseer berichten in mappen op onderwerp, zodat je contentplan divers en goed gestructureerd blijft.";
$_LANG['store']['socialbee']['features']['create']['i6'] = "Experimenteer met verschillende soorten berichten, zoals afbeeldingen, video's, carrousels, verhalen en rollen, om te ontdekken wat het beste aansluit bij je publiek.";
$_LANG['store']['socialbee']['features']['engage']['i1'] = "Reageer op al je opmerkingen, vermeldingen en DM's op sociale mediaplatforms vanuit één eenvoudig te beheren inbox.";
$_LANG['store']['socialbee']['features']['engage']['i2'] = "Bespaar tijd en blijf op de hoogte van gesprekken zonder te hoeven schakelen tussen verschillende social media-accounts.";
$_LANG['store']['socialbee']['features']['engage']['i3'] = "Ontvang een melding wanneer iemand je content gebruikt, zodat je nooit belangrijke berichten of engagementkansen mist.";
$_LANG['store']['socialbee']['features']['engage']['i4'] = "Communiceer in realtime met volgers om je community te laten groeien en vragen van klanten te beantwoorden met snelle antwoorden.";
$_LANG['store']['socialbee']['features']['engage']['i5'] = "Houd de vermeldingen van je merk in de gaten om te zien wat mensen zeggen, en houd gesprekken en feedback bij.";
$_LANG['store']['socialbee']['features']['engage']['i6'] = "Gebruik borden en streams om je opmerkingen, vermeldingen en berichten te ordenen op een manier die je eenvoudig kunt beheren.";
$_LANG['store']['socialbee']['features']['schedule']['i1'] = "Plan berichten voor grote platforms zoals Facebook®, Instagram, LinkedIn®, TikTok, Pinterest en meer, allemaal vanaf één plek.";
$_LANG['store']['socialbee']['features']['schedule']['i2'] = "Organiseer je berichten met een visuele kalender die je volledige social media-strategie in één oogopslag laat zien.";
$_LANG['store']['socialbee']['features']['schedule']['i3'] = "Plan berichten van tevoren en zet ze in de wachtrij om je social media-accounts actief te houden zonder dat je ze handmatig hoeft te posten.";
$_LANG['store']['socialbee']['features']['schedule']['i4'] = "Plan je content op specifieke momenten waarop je publiek actief is en laat SocialBee de beste tijden voorstellen op basis van je prestaties in het verleden.";
$_LANG['store']['socialbee']['features']['schedule']['i5'] = "Hergebruik succesvolle Evergreen-content door berichten opnieuw in te plannen om je feed actueel te houden, zonder dat je constant nieuwe content hoeft te creëren.";
$_LANG['store']['socialbee']['features']['schedule']['i6'] = "Pauzeer, bewerk of herplan berichten wanneer je plannen veranderen. SocialBee biedt u de flexibiliteit om uw inhoudskalender naar behoefte aan te passen.";
$_LANG['store']['socialbee']['header'] = "SocialBee, de gemakkelijkste manier om al je social media-accounts te beheren";
$_LANG['store']['socialbee']['hero'] = "Creëer, plan, publiceer, analyseer, betrek en werk samen zonder een seconde van je tijd te verspillen.";
$_LANG['store']['socialbee']['packages'] = "Bekijk prijzen en pakketten";
$_LANG['store']['socialbee']['plan']['accelerate'] = "Versnel";
...
$_LANG['store']['socialbee']['pricing']['header']['body'] = "Bekijk prijzen en pakketten";
$_LANG['store']['socialbee']['pricing']['header']['title'] = "Probeer SocialBee en begin met groeien op sociale media.";
$_LANG['store']['socialbee']['profiles'] = ":num sociale profielen";
$_LANG['store']['socialbee']['promo']['sidebar']['body'] = "Beheer al je social media-profielen vanaf één plek.";
$_LANG['store']['socialbee']['promo']['sidebar']['title'] = "SocialBee";
$_LANG['store']['socialbee']['title'] = "SocialBee";
$_LANG['store']['socialbee']['websitePricing']['title'] = "Kosten";
$_LANG['store']['socialbee']['workspaces'] = ":num werkplekken";
...
$_LANG['store']['ssl']['landingPage']['encrypts'] = "Versleutelt de communicatie om gevoelige informatie te beschermen die uw klanten verstrekken.";
...
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet5'] = "Zichtbaarheidsscores bijhouden en vergelijken";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Ongeldig btw-nummerformaat voor :countryName.";
...
$_LANG['updateProductQuantity'] = "Update";
$_LANG['updateTotals'] = "Update Totals";
