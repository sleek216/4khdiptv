...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Remoção de caracteres inválidos";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "O sistema detectou e removeu caracteres UTF-8 inválidos de 4 bytes nos valores de configuração guardados.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Feedback Adicional (Opcional)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Ajustar tom e comprimento";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "A IA está a analisar o contexto da conversa e a elaborar uma resposta personalizada";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Sugestão de IA gerada. Reveja a sugestão antes de a inserir na sua resposta.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Sugestão de IA inserida. Reveja antes de enviar.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugestão de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Falha ao extrair o ticket digest. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Recebeu uma resposta inválida do serviço de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Falha na validação da licença. Verifique as suas credenciais e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Falha ao gerar um prompt de IA. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Falha ao salvar a resposta da IA. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "O serviço de suporte de IA atingiu o tempo limite. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "O serviço de suporte de IA está temporariamente indisponível.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Falha na autenticação. Verifique as suas credenciais de Agente de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Não é possível estabelecer ligação ao serviço de IA. Verifique a ligação à rede e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Falha na operação da base de dados. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Falha ao descriptografar dados. Por favor contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Falha na encriptação de dados. Por favor contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Ocorreu um erro inesperado. Tente novamente ou contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Saldo de crédito insuficiente. Adicione créditos à sua conta e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Ocorreu um erro interno. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "A entrada fornecida é inválida. Verifique os seus dados e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Formato de pedido inválido. Verifique os dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Falha na verificação da assinatura do pedido. Verifique a sua chave de licença.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "A classificação por estrelas deve estar entre 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Os dados do bilhete são inválidos ou mal formados.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "O código de rastreamento deve ser um formato UUID válido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Artigo da base de conhecimento não encontrado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Esta licença já está registada no sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "A sua licença de IA expirou. Renove a sua subscrição.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "A licença fornecida é inválida.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licença não encontrada. Verifique a sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "A sua licença de IA foi suspensa. Por favor contacte o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "A chave da API do fornecedor de IA é inválida. Verifique a sua configuração.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Não foram encontrados artigos relevantes na base de conhecimento para este bilhete.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "O fornecedor de IA retornou um erro. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Limite de taxa do fornecedor de IA excedido. Tente novamente em alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "O sistema falhou ao gerar uma resposta de IA. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Falha ao pesquisar a base de conhecimento com IA. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "O fornecedor de IA está temporariamente indisponível. Por favor, tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "O serviço de IA demorou demasiado tempo a responder. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Falta o campo de dados encriptados obrigatório.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "As credenciais do cliente OAuth são inválidas.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "O token OAuth é inválido ou foi revogado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "O token OAuth expirou. Por favor, autentique-se novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Falha ao descriptografar os dados do ticket. Verifique as chaves de encriptação.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Os dados fornecidos são inválidos ou corrompidos.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Falha ao higienizar dados confidenciais. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "A higienização de dados atingiu o tempo limite. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "O serviço de higienização de dados está temporariamente indisponível.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Excedeu a sua quota mensal de token de IA. Por favor, atualize o seu plano.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Demasiados pedidos. Tente novamente em alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "O registo solicitado não foi encontrado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "O serviço de IA está temporariamente indisponível. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Não tem permissão para aceder a este bilhete.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Bilhete não encontrado no sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Falha na validação do pedido. Verifique a sua entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Falha na execução do fluxo de trabalho de IA. Tente novamente.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Cancelar";
$_ADMINLANG['aiSuggestions']['collapse'] = "Colapso";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Recolher tudo";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Tem a certeza de que pretende eliminar a sua classificação?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Confirme se revisou os dados higienizados e está pronto para gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Dados carregados e higienizados (%s respostas). Revise e gere sugestões.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Eliminar Avaliação";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documentos encontrados";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Editar Conteúdo da Mensagem:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Editar Classificação";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Editar esta mensagem...";
$_ADMINLANG['aiSuggestions']['error'] = "Erro:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Não foi possível gerar uma sugestão de IA. Tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['expand'] = "Expandir";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Expandir tudo";
$_ADMINLANG['aiSuggestions']['generate'] = "Gerar";
$_ADMINLANG['aiSuggestions']['generating'] = "Gerando...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Gerando sugestão de IA...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Gerando sugestão de IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Falha na geração: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Como foi esta sugestão?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserir na resposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Data inválida";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Resposta inválida do ponto final de higienização - campos obrigatórios ausentes";
$_ADMINLANG['aiSuggestions']['length'] = "Comprimento";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Conciso";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Detalhado";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Carregando dados do bilhete...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Falta %s na resposta da API";
$_ADMINLANG['aiSuggestions']['networkError'] = "Erro de rede";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Erro de rede durante a operação %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Nenhuma sugestão de IA disponível.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Não foram utilizados documentos de referência para esta resposta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Nenhuma mensagem de resposta encontrada.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Não existem dados higienizados disponíveis. Recarregar dados do bilhete.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Sem assunto";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "A operação %s falhou";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Por favor seleccione a classificação";
$_ADMINLANG['aiSuggestions']['processing'] = "A processar…";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "A processar o seu pedido, aguarde...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Sugestão de Avalie AI";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Classificação eliminada com sucesso";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Excelente";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Falha ao enviar a classificação. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Feira";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Bom";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Pobre";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Obrigado pelo seu feedback!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Muito Bom";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Acções recomendadas:";
$_ADMINLANG['aiSuggestions']['references'] = "Referências";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Para gerar esta resposta foram utilizados os seguintes artigos e documentos da base de conhecimento:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Atingiu o número máximo de regenerações (3). Por favor, use a sugestão atual.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerando...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Regenerações restantes: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Remoção de informações confidenciais e preparação de conteúdos para análise de IA";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Resposta #%s reset.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Tópico de resposta (%s mensagens)";
$_ADMINLANG['aiSuggestions']['reset'] = "Redefinir";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Resposta gerada com sucesso";
$_ADMINLANG['aiSuggestions']['responseReady'] = "A sua resposta gerada por IA está pronta";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Resposta regenerada com novos parâmetros";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Recuperar o histórico de conversas e detalhes do ticket";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Rever Conversação para Análise de IA";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Reveja cuidadosamente os dados do bilhete higienizado abaixo. Verifique se removeu ou mascarou todas as informações confidenciais antes de gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Revisar Dados Sanitizados Antes de Gerar";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Falha na higienização.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Higienização e carregamento de dados de bilhetes...";
$_ADMINLANG['aiSuggestions']['staff'] = "Operador";
$_ADMINLANG['aiSuggestions']['stars'] = "estrelas";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Submeter Avaliação";
$_ADMINLANG['aiSuggestions']['submitting'] = "Submetendo...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Resposta Sugerida:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "A sugestão falhou.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Equipe de Apoio";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Conte-nos mais sobre a sua experiência...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Análise de Bilhetes:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Dados do bilhete não disponíveis";
$_ADMINLANG['aiSuggestions']['tone'] = "Tom";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formal";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Amigável";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Técnico";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Não foi possível encontrar a caixa de resposta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Data Desconhecida";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Erro desconhecido";
$_ADMINLANG['aiSuggestions']['youRated'] = "Avaliou isto:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "A sua opinião:";
...
$_ADMINLANG['billing']['creditnote'] = "Nota de Crédito";
$_ADMINLANG['billing']['debitnote'] = "Nota de Débito";
...
$_ADMINLANG['billing']['nocomments'] = "Não há comentários voltados para o cliente para este documento.";
$_ADMINLANG['billing']['offlinecc'] = "Processamento Offline de CC";
$_ADMINLANG['billing']['title'] = "Transações";
$_ADMINLANG['billing']['transaction'] = "Transação";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Trata-se de um projecto de nota de crédito. O cliente não pode ver ou aceder a esta nota de crédito até que clique em Emitir.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Itens de Nota de Crédito";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Gerir Nota de Crédito";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Número da Nota de Crédito";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Ver Nota de Crédito";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Trata-se de um projecto de nota de débito. O cliente não pode ver ou aceder a esta nota de débito até que clique em Emitir.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Itens de Nota de Débito";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Gerir Nota de Débito";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Número da Nota de Débito";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Ver Nota de Débito";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "O sistema não pode modificar o atributo \":attribute\" numa nota de faturação que esteja no estado \":status\".";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "O sistema não pode adicionar um item de linha a uma nota de faturação que não esteja no estado Rascunho.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "O sistema não pode atribuir ou modificar um item de linha numa nota de faturação que não esteja no estado Rascunho (ID do Item de Linha: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "O sistema só pode modificar as notas de faturação enquanto estiverem no estado Rascunho.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Último Login";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Anfitrião";
...
$_ADMINLANG['credit']['cannotEditSystemGenerated'] = "Não é possível modificar as entradas de crédito geradas pelo sistema.";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Tente novamente mais tarde.";
$_ADMINLANG['errorPage']['429']['title'] = "Limite de taxa excedido";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Não é possível modificar este item.";
...
$_ADMINLANG['fields']['clientcredit'] = "Crédito ao Cliente";
...
$_ADMINLANG['fields']['reference'] = "Referência";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Introduza o incremento desejado entre os números das notas de crédito geradas (Padrão:1, Máximo: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Incrementação do número da nota de crédito";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Introduza o incremento desejado entre os números das notas de débito geradas (Padrão:1, Máximo: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Incrementação do Número da Nota de Débito";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Desactivar a renovação automática e cancelar os itens da fatura para este domínio?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Esta ação eliminará os seguintes itens da fatura: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "O valor :inputLabel deve estar entre 1 e 999.";
...
$_ADMINLANG['general']['mixpaneltrackingenabledinfo'] = "Marque para ativar a análise e o acompanhamento da atividade do utilizador. <a href=\"https://go.whmcs.com/2401/analytics\">Saiba mais.</a>";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Redefinição de palavra-passe (Exigir que os utilizadores concluam um CAPTCHA após várias tentativas de redefinição de palavra-passe.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Reveja o Registo de Actividades para obter mais detalhes.";
...
$_ADMINLANG['gettingStartedWizard']['company']['about']['exploringOptions'] = "Estou apenas a explorar opções.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['notSellingProducts'] = "Ainda não estou a vender nada.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingNotOnline'] = "Só vendo produtos offline.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingWithDifferentSystem'] = "Vendo produtos noutro sistema.";
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Escolha o idioma que verá na Área de administração.";
$_ADMINLANG['gettingStartedWizard']['description']['analytics'] = "Ajude-nos a tornar o WHMCS ainda melhor.";
$_ADMINLANG['gettingStartedWizard']['description']['checkPayment'] = "Utilize o nosso gateway de pagamento Mail In Payment para registar cheques e outros pagamentos físicos.";
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Escolha o idioma que os seus clientes verão quando iniciarem sessão na Área do Cliente.";
$_ADMINLANG['gettingStartedWizard']['description']['companyLogo'] = "O logótipo da sua empresa será apresentado nas suas faturas, e-mails e na Área do Cliente.";
$_ADMINLANG['gettingStartedWizard']['description']['connectionError'] = "Verifique as informações do servidor e tente novamente.";
$_ADMINLANG['gettingStartedWizard']['description']['controlPanel'] = "Seleccione o seu painel de controlo de alojamento web.";
$_ADMINLANG['gettingStartedWizard']['description']['domains'] = "Conecte pelo menos um registrador de domínio ao WHMCS para começar a vender domínios.";
$_ADMINLANG['gettingStartedWizard']['description']['firstServerConnected'] = "Ligou com êxito um servidor. Aceda a <strong>Configuration (:wrenchIcon) > System Settings > Servers</strong> para editar a configuração do servidor.";
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Escolha o idioma que o utilizador e os seus clientes veem por predefinição.";
$_ADMINLANG['gettingStartedWizard']['description']['marketConnect'] = "Revenda produtos e complementos de alta qualidade dos principais prestadores de serviços.";
$_ADMINLANG['gettingStartedWizard']['description']['paymentDeactivationProhibited'] = "Não é possível desativar este módulo a partir do Assistente de Introdução. Para desativar os gateways de pagamento, aceda a <strong>Configuration (:wrenchIcon) > System Settings > Payment Gateways</strong>.";
$_ADMINLANG['gettingStartedWizard']['description']['paypal'] = "Pagamentos com um clique com PayPal®.";
$_ADMINLANG['gettingStartedWizard']['description']['primaryIp'] = "Os e-mails de boas-vindas exibirão este endereço.";
$_ADMINLANG['gettingStartedWizard']['description']['registrarConnect'] = "Já tem uma conta?";
$_ADMINLANG['gettingStartedWizard']['description']['serverDetails'] = "Pode modificar a configuração do servidor após a instalação.";
$_ADMINLANG['gettingStartedWizard']['description']['serverName'] = "Introduza um nome para identificar o servidor.";
$_ADMINLANG['gettingStartedWizard']['description']['setupComplete'] = "Para encontrar estes passos novamente, aceda a <strong>Configuração (:wrenchIcon) > Assistente de introdução</strong>.";
$_ADMINLANG['gettingStartedWizard']['description']['stripe'] = "Pagamentos com um clique com o Stripe™.";
$_ADMINLANG['gettingStartedWizard']['description']['stripePublishableKey'] = "A sua chave de API publicável identifica o seu website para o Stripe durante as comunicações.";
$_ADMINLANG['gettingStartedWizard']['description']['stripeSecretKey'] = "A sua chave API secreta garante que apenas as comunicações da Stripe sejam validadas.";
$_ADMINLANG['gettingStartedWizard']['description']['suggestedPrices'] = "Utilize os preços de retalho sugeridos ou personalize-os abaixo.";
$_ADMINLANG['gettingStartedWizard']['description']['tldToSell'] = "Pode adicionar mais TLDs na sua configuração de Preços de Domínio depois de terminar a instalação.";
$_ADMINLANG['gettingStartedWizard']['description']['tlds'] = "Escolha Domínios de Nível Superior (TLDs) para vender. Pode adicionar mais TLDs na sua configuração de Preços de Domínio depois de terminar a instalação.";
$_ADMINLANG['gettingStartedWizard']['description']['tracking'] = "Usamos <a href=\"https://go.whmcs.com/2397/mixpanel\" target=\"_blank\">Mixpanel®</a> para rastrear estatísticas do utilizador, como a frequência com que clica em diferentes funcionalidades. Ao marcar esta caixa, concorda com a recolha destes dados durante as suas interações connosco.";
$_ADMINLANG['gettingStartedWizard']['description']['uploadFile'] = "Carregue um ficheiro JPG ou PNG (tamanho máximo: 20MB).";
$_ADMINLANG['gettingStartedWizard']['description']['wireTransfers'] = "Utilize o nosso gateway de pagamento por Transferências Bancárias para aceitar transferências eletrônicas.";
$_ADMINLANG['gettingStartedWizard']['domains']['countryBased'] = "Baseado no País (ccTLDs)";
$_ADMINLANG['gettingStartedWizard']['domains']['enomBadPasswordMessage'] = "O Enom exige que as palavras-passe da API contenham pelo menos uma letra minúscula (a — z), uma letra maiúscula (A — Z), um número (0—9) e um dos seguintes caracteres especiais: @ * - _ . /";
$_ADMINLANG['gettingStartedWizard']['domains']['enomIpNotPermitted'] = "Tem de autorizar o seu endereço IP a utilizar esta API. O seu endereço IP é :ip. <a class='underline' target='_blank' href='https://go.whmcs.com/1885/enom#activation'>Saber Mais</a>.";
$_ADMINLANG['gettingStartedWizard']['domains']['featured'] = "Destaque (gTLDs)";
$_ADMINLANG['gettingStartedWizard']['domains']['popular'] = "Popular";
$_ADMINLANG['gettingStartedWizard']['domains']['radix'] = "Domínios Radix";
$_ADMINLANG['gettingStartedWizard']['domains']['registrarSignInError'] = "Falha no início de sessão. Verifique as suas credenciais.";
$_ADMINLANG['gettingStartedWizard']['extra']['centralNic'] = "Venda extensões de domínio como <b>.store</b>, <b>.online</b>, .es</b>, <b>.co.uk</b>, ou <b>.eu .eu.</b>";
$_ADMINLANG['gettingStartedWizard']['extra']['enom'] = "Venda extensões de domínio como <b>.com</b>, <b>.net</b>, <b>.biz</b>ou <b>.info</b>.";
$_ADMINLANG['gettingStartedWizard']['extra']['paypal'] = "O PayPal pode aumentar as suas conversões <b>em até 66%.</b>";
$_ADMINLANG['gettingStartedWizard']['fileUpload']['noFile'] = "Nenhum ficheiro seleccionado.";
...
$_ADMINLANG['gettingStartedWizard']['group']['company'] = "A sua Empresa";
$_ADMINLANG['gettingStartedWizard']['group']['domains'] = "Configurar vendas de domínio";
$_ADMINLANG['gettingStartedWizard']['group']['hosting'] = "Configurar servidores de alojamento";
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Localização";
$_ADMINLANG['gettingStartedWizard']['group']['logIntoMarketConnect'] = "Inicie sessão na sua conta WHMCS Marketplace.";
...
$_ADMINLANG['gettingStartedWizard']['label']['address'] = "Endereço 1";
$_ADMINLANG['gettingStartedWizard']['label']['address2'] = "Endereço 2";
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Idioma da Área de Administração";
$_ADMINLANG['gettingStartedWizard']['label']['allowTracking'] = "Permitir o rastreamento de terceiros";
$_ADMINLANG['gettingStartedWizard']['label']['bankRoutingNumber'] = "Número de Roteamento";
$_ADMINLANG['gettingStartedWizard']['label']['centralNic'] = "Criar uma conta de revendedor CentralNIC";
$_ADMINLANG['gettingStartedWizard']['label']['checkPayment'] = "Cheque de Pagamentos";
$_ADMINLANG['gettingStartedWizard']['label']['city'] = "Cidade";
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Idioma Padrão";
$_ADMINLANG['gettingStartedWizard']['label']['company'] = "Empresa";
$_ADMINLANG['gettingStartedWizard']['label']['companyName'] = "Nome da Empresa";
$_ADMINLANG['gettingStartedWizard']['label']['companySize'] = "Quantos colaboradores tem a sua empresa?";
$_ADMINLANG['gettingStartedWizard']['label']['connectedEnom'] = "Conta Enom ligada com êxito.";
$_ADMINLANG['gettingStartedWizard']['label']['copyRight'] = "Direitos de Autor &copy; WHMCS :year";
$_ADMINLANG['gettingStartedWizard']['label']['country'] = "País";
$_ADMINLANG['gettingStartedWizard']['label']['createNewAccount'] = "Criar uma nova conta";
$_ADMINLANG['gettingStartedWizard']['label']['currentRevenue'] = "Qual é a sua receita anual atual em USD?";
$_ADMINLANG['gettingStartedWizard']['label']['dashboard'] = "Ir para o Painel de Administração";
$_ADMINLANG['gettingStartedWizard']['label']['dontShowAgain'] = "Não volte a mostrar isto.";
$_ADMINLANG['gettingStartedWizard']['label']['email'] = "Endereço de Email";
$_ADMINLANG['gettingStartedWizard']['label']['enom'] = "Criar uma conta Enom";
$_ADMINLANG['gettingStartedWizard']['label']['exclusivePricing'] = "Obtenha preços exclusivos para TLDs seleccionados:";
...
$_ADMINLANG['gettingStartedWizard']['label']['logInHere'] = "Inicie sessão aqui.";
$_ADMINLANG['gettingStartedWizard']['label']['logOut'] = "Terminar sessão";
$_ADMINLANG['gettingStartedWizard']['label']['login'] = "Iniciar Sessão";
$_ADMINLANG['gettingStartedWizard']['label']['loginNotice'] = "Ao iniciar sessão ou inscrever-se, concorda com os nossos :privacyPolicy e :termsAndConditions.";
$_ADMINLANG['gettingStartedWizard']['label']['marketConnectFromVendor'] = "de :vendorName";
$_ADMINLANG['gettingStartedWizard']['label']['minusMarkdown'] = "- :markdown Marcação";
...
$_ADMINLANG['gettingStartedWizard']['label']['paypal'] = "Pagamentos PayPal";
...
$_ADMINLANG['gettingStartedWizard']['label']['primaryNameserver'] = "Servidor de nomes primário";
$_ADMINLANG['gettingStartedWizard']['label']['privacyPolicy'] = "Política de Privacidade";
$_ADMINLANG['gettingStartedWizard']['label']['readyToSell'] = "Já está a vender os seus produtos?";
$_ADMINLANG['gettingStartedWizard']['label']['secondaryNameserver'] = "Servidor de nomes secundário";
$_ADMINLANG['gettingStartedWizard']['label']['securityAnswer'] = "Resposta Secreta";
$_ADMINLANG['gettingStartedWizard']['label']['securityQuestion'] = "Pergunta Secreta";
...
$_ADMINLANG['gettingStartedWizard']['label']['setUp'] = "Vamos configurá-lo para si.";
$_ADMINLANG['gettingStartedWizard']['label']['setupComplete'] = "Etapas iniciais de configuração concluídas!";
$_ADMINLANG['gettingStartedWizard']['label']['signUp'] = "Registar";
$_ADMINLANG['gettingStartedWizard']['label']['state'] = "Estado ou Província";
$_ADMINLANG['gettingStartedWizard']['label']['step'] = "Passo :step de :maxSteps";
...
$_ADMINLANG['gettingStartedWizard']['label']['stripeSecretKey'] = "Chave da API Stripe Secret";
$_ADMINLANG['gettingStartedWizard']['label']['termsAndConditions'] = "Termos e Condições";
$_ADMINLANG['gettingStartedWizard']['label']['testConnection'] = "Conexão de teste";
...
$_ADMINLANG['gettingStartedWizard']['label']['yourPrice'] = "O Seu Preço";
$_ADMINLANG['gettingStartedWizard']['label']['zipCode'] = "Código Postal";
$_ADMINLANG['gettingStartedWizard']['marketConnectInvalidCredentials'] = "Falha no início de sessão. Verifique as suas credenciais e tente novamente.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['centralNic'] = "Crie uma conta no CentralNIC Registry para receber preços exclusivos para utilizadores WHMCS em TLDs seleccionados.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['checkPayment'] = "Introduza o endereço de pagamento a apresentar nas faturas.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['enom'] = "Crie uma conta no Enom instantaneamente.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['registrar'] = "Conecte pelo menos um registrador de domínio ao WHMCS para começar a vender domínios.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['wireTransfers'] = "Introduza os detalhes da conta bancária que irá receber transferências eletrônicas.";
$_ADMINLANG['gettingStartedWizard']['payments']['gatewayError'] = "O módulo do gateway de pagamento encontrou um erro inesperado.";
$_ADMINLANG['gettingStartedWizard']['payments']['stripePublishableKeyError'] = "O valor :stripePublishableKeyName deve começar com 'pk_'.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['accountNumber'] = "Introduza o número da sua conta.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['address'] = "Introduza uma morada.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['bankRoutingNumber'] = "Introduza o seu número de encaminhamento bancário.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['city'] = "Introduza a sua cidade.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyEmail'] = "Introduza o endereço de correio electrónico principal da empresa.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyName'] = "Introduza o nome da sua empresa.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['country'] = "Pesquise ou selecione o país da sua empresa.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['email'] = "Introduza o seu endereço de e-mail.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['enterAnswer'] = "Introduza uma resposta.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['firstName'] = "Introduza o seu primeiro nome.";
...
$_ADMINLANG['gettingStartedWizard']['placeholder']['lastName'] = "Introduza o seu apelido.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['nameOnAccount'] = "Introduza o nome na sua conta bancária.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['password'] = "Introduza uma palavra-passe.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['phoneNumber'] = "Introduza um número de telefone.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['securityQuestion'] = "Seleccione uma pergunta.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['state'] = "Seleccione um estado ou província.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['username'] = "Introduza um nome de utilizador.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['zipCode'] = "Introduza um código postal.";
$_ADMINLANG['gettingStartedWizard']['servers']['connectionErrorMessage'] = "Verifique as suas credenciais de início de sessão.";
$_ADMINLANG['gettingStartedWizard']['title']['aboutCompany'] = "Ajude-nos a personalizar a sua experiência.";
$_ADMINLANG['gettingStartedWizard']['title']['analytics'] = "A sua privacidade é importante para nós.";
$_ADMINLANG['gettingStartedWizard']['title']['centralNic'] = "Criar uma conta de revendedor de registo CentralNIC";
$_ADMINLANG['gettingStartedWizard']['title']['centralNicModal'] = "Iniciar sessão no registo CentralNIC";
$_ADMINLANG['gettingStartedWizard']['title']['checkPayment'] = "Configurar pagamentos por correio.";
$_ADMINLANG['gettingStartedWizard']['title']['company'] = "Conte-nos sobre a sua empresa.";
$_ADMINLANG['gettingStartedWizard']['title']['companyAddress'] = "Definir o seu endereço comercial";
$_ADMINLANG['gettingStartedWizard']['title']['companyLogo'] = "Carregue o seu logótipo.";
$_ADMINLANG['gettingStartedWizard']['title']['connectionVerified'] = "Sucesso! Ligação verificada.";
$_ADMINLANG['gettingStartedWizard']['title']['domainRegistrar'] = "Escolha como registar domínios.";
...
$_ADMINLANG['gettingStartedWizard']['title']['enomModal'] = "Iniciar sessão no Enom";
$_ADMINLANG['gettingStartedWizard']['title']['hosting'] = "Ligue o seu primeiro servidor.";
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Seleccione o seu idioma predefinido.";
$_ADMINLANG['gettingStartedWizard']['title']['loggedIn'] = "Inicie sessão na sua conta WHMCS Marketplace.";
$_ADMINLANG['gettingStartedWizard']['title']['marketConnect'] = "Impulsione as vendas com o MarketConnect.";
$_ADMINLANG['gettingStartedWizard']['title']['offlinePayments'] = "Escolha os métodos de pagamento offline que pretende configurar:";
$_ADMINLANG['gettingStartedWizard']['title']['onlinePayments'] = "Ligue o seu processador de pagamento online ao WHMCS:";
$_ADMINLANG['gettingStartedWizard']['title']['payments'] = "Escolha como processa os pagamentos.";
$_ADMINLANG['gettingStartedWizard']['title']['registrar'] = "Registrante";
$_ADMINLANG['gettingStartedWizard']['title']['retailPrice'] = "Preço de retalho";
$_ADMINLANG['gettingStartedWizard']['title']['serverDetails'] = "Detalhes do servidor";
$_ADMINLANG['gettingStartedWizard']['title']['setPricing'] = "Defina o preço do seu TLD.";
$_ADMINLANG['gettingStartedWizard']['title']['setupComplete'] = "Instalação concluída.";
$_ADMINLANG['gettingStartedWizard']['title']['tld'] = "TLD";
$_ADMINLANG['gettingStartedWizard']['title']['tldToSell'] = "Escolha Domínios de Nível Superior (TLDs) para vender.";
$_ADMINLANG['gettingStartedWizard']['title']['wireTransfers'] = "Configurar transferências eletrônicas.";
$_ADMINLANG['gettingStartedWizard']['title']['yourCost'] = "O Seu Custo";
...
$_ADMINLANG['global']['lastActive'] = "Último Ativo";
...
$_ADMINLANG['global']['manageMember'] = "Gerir Administrador";
...
$_ADMINLANG['global']['online'] = "On-line";
...
$_ADMINLANG['global']['products'] = "Produtos";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "A imutabilidade da fatura está desativada. Depreciamos a capacidade de editar faturas e removeremos a opção de habilitar a mutabilidade da fatura em uma versão futura.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Configurou o sistema para permitir a edição de faturas (mutabilidade da fatura) para faturas que não sejam rascunhos. Descontinuámos esta capacidade no WHMCS 9.0 e removeremos a configuração que permite este comportamento numa versão futura.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Imutabilidade da Fatura";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "A encriptação do armazenamento da Autenticação de Dois Fatores está em curso.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "O armazenamento de autenticação de dois fatores é seguro.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Armazenamento de autenticação de dois fatores";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Pode saber mais sobre isso na nossa documentação.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "O armazenamento da sessão PHP não é gravável. Para obter ajuda, contacte o administrador do sistema. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Saiba mais.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Tem a certeza de que deseja cancelar esta fatura? Os artigos recorrentes na fatura não serão novamente faturados para esta data.";
$_ADMINLANG['invoices']['cancelPayment'] = "Cancelar pagamento";
$_ADMINLANG['invoices']['cancelTitle'] = "Cancelar fatura";
...
$_ADMINLANG['invoices']['delete'] = "Tem a certeza de que pretende eliminar esta fatura?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "O sistema não pode modificar o atributo \":attribute\" numa fatura que esteja no estado \":status\".";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "O sistema não pode adicionar um item de linha a uma fatura a menos que esteja no estado Rascunho.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "O sistema não pode atribuir ou modificar um item de linha numa fatura a menos que esteja no estado Rascunho (ID do Item de Linha: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "O sistema só pode modificar faturas enquanto estiverem no estado Rascunho.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "A imutabilidade da fatura está desativada. Pode solicitar alterações de estado inválidas no separador Gerir Fatura &raquo; Opções.";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "O sistema só pode fazer a transição de uma fatura para Cancelada a partir dos seguintes estados: Não Pago, Pagamento Pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "O sistema só pode eliminar um Rascunho de fatura.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "O sistema só pode fazer a transição de uma fatura para Pago a partir dos seguintes status: Não Pago, Pagamento Pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "O sistema só pode aplicar pagamentos a uma fatura no estado Não Pago, Pagamento Pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "O sistema só pode reembolsar pagamentos de uma fatura no estado Não Pago, Pagamento Pendente, Pago ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Clique para aplicar uma nota de crédito para o saldo restante, marque Pago e execute quaisquer ações de pós-pagamento.";
$_ADMINLANG['invoices']['invoiceCreditResult'] = "Essas transações resultaram em um crédito concedido ao usuário no valor de ";
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Esta é uma Fatura Cancelada.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Por favor, %s primeiro para aplicar um pagamento";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Esta é uma Fatura de Cobranças.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Este é um rascunho de fatura.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Não é possível modificar uma Fatura que seja :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Esta é uma Fatura Pago.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Esta é uma Fatura Pendente de Pagamento.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Esta fatura é ReEMBOLSADA.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Esta é uma fatura não paga.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Clique para gerar e aplicar as notas de crédito ou débito necessárias para fazer a transição da fatura para Cancelada.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Clique para gerar e aplicar uma nota de crédito para o saldo remanescente e fazer a transição da fatura para Pago. Isso também executará quaisquer ações de pós-pagamento.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "O sistema fez a transição com êxito :successes das faturas :attempted para Canceladas.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "O sistema eliminou com êxito :successes das faturas :attempted .";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "O sistema fez a transição com êxito :successes das faturas :attempted para Pago.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "O sistema fez a transição com sucesso :successes das faturas :attempted para Não Pago.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Tem certeza de que deseja excluir as faturas selecionadas?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "A sua seleção inclui faturas sem rascunho. O sistema modificará essas faturas porque a imutabilidade da fatura está desativada.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "O sistema falhou ao descriptografar um token da API do MarketConnect. Verifique o hash de criptografia da CC ou desconecte e reconecte sua conta do WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Falha na autenticação. Verifique as suas credenciais do WHMCS Marketplace em Configuração <i class='far fa-wrench' aria-hidden='true'></i> > Definições do Sistema > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Ofereça todos os produtos <b>:serviceName</b> .";
$_ADMINLANG['marketConnect']['gdprConsent'] = "Para se inscrever no WHMCS Marketplace, a WHMCS Ltd. e suas afiliadas precisam armazenar e processar os seus dados pessoais de acordo com a Política de Privacidade <a href=\"https://www.webpros.com/legal\">WebPros</a>.";
$_ADMINLANG['marketConnect']['introModalTitle'] = "Bem-vindo ao MarketConnect";
$_ADMINLANG['marketConnect']['lastUpdated'] = "Updated";
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "Sobre";
$_ADMINLANG['marketConnect']['learn']['tab']['faq'] = "PERGUNTAS FREQUENTES";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "A WHMCS Ltd. e as suas afiliadas no grupo WebPros podem fornecer-me notícias e ofertas individuais sobre os produtos WebPros de acordo com a Política de Privacidade <a href=\"https://www.webpros.com/legal\">WebPros</a>. Posso revogar este consentimento clicando no link em qualquer comunicação recebida.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/mês";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/mês";
$_ADMINLANG['marketConnect']['points'] = "Pontos";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Preço de varejo recomendado";
$_ADMINLANG['marketConnect']['refresh'] = "Atualizar";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Status de venda";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "Sobre Nós";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Ativar";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Desativar";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Saber mais";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Gerenciar";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Começar a Vender";
...
$_ADMINLANG['marketConnect']['socialbee']['about']['p1'] = "SocialBee é uma ferramenta de gestão de redes sociais tudo-em-um que capacita os seus utilizadores a partilhar conteúdo através de várias redes sociais a partir de um só lugar. Pode definir um calendário de publicação, partilhar conteúdo, analisar o desempenho e interagir com os seus seguidores.";
$_ADMINLANG['marketConnect']['socialbee']['about']['p2'] = "A SocialBee foi fundada para simplificar a gestão de redes sociais para empresas de todos os tamanhos. Desde o seu lançamento em 2016, a plataforma tornou-se uma ferramenta robusta que permite aos utilizadores criar, programar, analisar e interagir com conteúdos em várias plataformas — tudo a partir de um só lugar. Com ênfase no design fácil de usar e recursos poderosos, como agendamento e análise baseados em categorias, o SocialBee tem a confiança de empreendedores, profissionais de marketing e agências para otimizar sua presença social e construir conexões significativas com seus públicos.";
$_ADMINLANG['marketConnect']['socialbee']['about']['quote'] = "“Na SocialBee, a nossa missão é capacitar as empresas para terem sucesso nas redes sociais sem o stress de fazer malabarismos com múltiplas ferramentas. Com a confiança de milhares de utilizadores em todo o mundo, combinamos funcionalidades poderosas com uma abordagem em primeiro lugar para garantir o seu sucesso. Quer esteja a começar ou a gerir uma tonelada de contas nas redes sociais, a SocialBee está aqui para o ajudar em cada passo do caminho.”";
$_ADMINLANG['marketConnect']['socialbee']['about']['title'] = "Sobre Nós";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h1'] = "Que plataformas de redes sociais consegue gerir com o SocialBee?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h2'] = "Que opções de suporte estão disponíveis para os utilizadores do SocialBee?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h3'] = "Os planos de agência da SocialBee são diferentes do plano Pro normal?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h4'] = "Onde estão localizados os servidores da SocialBee? Onde são armazenados os dados da SocialBee?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h5'] = "Porque é que devo vender uma ferramenta de gestão de redes sociais?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h6'] = "As empresas vão pagar pelas ferramentas de redes sociais?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q1'] = "Pode gerir e programar conteúdos para plataformas populares como Facebook, Instagram, Threads, X™ (anteriormente Twitter™), LinkedIn, Pinterest, Google Business Profile™, TikTok, YouTube™ e Bluesky.";
...
$_ADMINLANG['marketConnect']['socialbee']['faq']['q3'] = "Os planos da agência (Pro50, Pro100 e Pro150) têm as mesmas características do plano Pro. As principais diferenças são o número de perfis de redes sociais que pode ligar, o número de espaços de trabalho e os utilizadores que pode adicionar a um espaço de trabalho:";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q4'] = "Os servidores da SocialBee estão localizados na Irlanda, Europa.";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q5'] = "Vender uma ferramenta de gestão de redes sociais como a SocialBee permite-lhe explorar a crescente procura de soluções de marketing de redes sociais. As pequenas e médias empresas precisam de ferramentas para cuidar dos seus perfis nas redes sociais, poupar tempo e aumentar o envolvimento — criando um mercado forte para estes serviços para revendedores como você.";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q6'] = "Sim, as pequenas e médias empresas estão a investir rapidamente em ferramentas de redes sociais para gerir a sua presença nas redes sociais. Como um dos canais de marketing mais utilizados, as redes sociais contribuem para o crescimento do negócio, e as empresas estão ansiosas para investir em ferramentas fiáveis para as ajudar a alcançar os seus objetivos.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p1'] = "O SocialBee integra-se com o Canva, Unsplash e GIPHY, para que possa facilmente criar e fazer a curadoria de imagens para as suas postagens.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p2'] = "Gere legendas e imagens em segundos com IA e obtenha acesso a mais de 1.000 solicitações pré-fabricadas para poupar tempo.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p3'] = "Experimente diferentes tipos de post, como imagens, vídeos, carrosséis, histórias e Reels, para descobrir o que melhor se conecta ao seu público.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['title'] = "Criar";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p1'] = "Agende postagens para as principais plataformas como Facebook®, Instagram, LinkedIn®, TikTok, Pinterest e muito mais, tudo a partir de um só lugar.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p2'] = "Organize as suas publicações com um calendário visual que mostre toda a sua estratégia de redes sociais num relance.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p3'] = "Planeie e coloque as publicações na fila com antecedência para manter as suas contas de redes sociais ativas sem a necessidade de publicar manualmente.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['title'] = "Cronograma";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p1'] = "Responda a todos os seus comentários, menções e DMs nas plataformas de redes sociais a partir de uma única caixa de entrada fácil de gerir.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p2'] = "Poupe tempo e fique a par das conversas sem ter de alternar entre diferentes contas de redes sociais.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p3'] = "Seja notificado sempre que alguém se envolver com o seu conteúdo, para que nunca perca mensagens importantes ou oportunidades de envolvimento.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['title'] = "Envolver";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p1'] = "Partilhe comentários e etiquetar os seus colegas diretamente nos rascunhos de conteúdo.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p2'] = "Gerir várias marcas ou clientes com espaços de trabalho separados e organizados.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p3'] = "Evite trabalhos duplicados com um espaço partilhado para colaboração.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['title'] = "Colaborar";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p1'] = "Tenha uma visão clara do seu progresso nas redes sociais com métricas fáceis de entender, gráficos visuais, mapas e muito mais.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p2'] = "Compare o desempenho da plataforma para identificar onde os seus esforços são mais recompensados.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p3'] = "Acompanhe o envolvimento, as impressões, as taxas de cliques e o crescimento de seguidores ao longo do tempo para todas as suas contas de redes sociais.";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['AICreation'] = "Criação de Conteúdos de IA";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['GIPHY'] = "Integração GIPHY";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['RRP'] = ":price RRP";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['URL'] = "Integrações do encurtador de URL";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['accounts'] = "Contas nas Redes Sociais";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['addons'] = "Complementos para Utilizadores, Espaços de Trabalho,<br>e Perfis";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['automationTool'] = "Integrações de ferramentas de automação";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['browserExtension'] = "Extensão do Browser";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['canva'] = "Integração Canva";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCuration'] = "Curadoria de Conteúdos";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCurator'] = "Integrações com Curadores de Conteúdos";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentResharing'] = "Repartilha de Conteúdos";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentSchedulingPublishing'] = "Agendamento de Conteúdos<br>e Publicação";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['dataAccess'] = "Histórico<br>Acesso aos Dados";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['exportBrandedReports'] = "Exportar Relatórios de Marca";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['importFeeds'] = "Importar RSS Feeds";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['internalNotes'] = "Notas Internas<br>(Feedback)";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['mobileApp'] = "Aplicação Móvel";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postDrafts'] = "Pós Rascunhos";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postingTimeSuggestions'] = "Melhores Sugestões de Tempo de Publicação";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['posts'] = "Posts por Categoria";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['socialMediaAnalytics'] = "Análise de Redes Sociais";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['socialMediaInbox'] = "Caixa de entrada de Redes Sociais";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['tagAccelerate'] = "Acelerar";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['teamCollaboration'] = "Colaboração em Equipa";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['universalPosting'] = "Publicação Universal";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['unlimited'] = "Ilimitado";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['unsplash'] = "Integração Unsplash";
...
$_ADMINLANG['marketConnect']['socialbee']['workspaces'] = ":num espaços de trabalho";
$_ADMINLANG['marketConnect']['socialbee']['workspaceusers'] = ":num utilizadores por espaço de trabalho";
...
$_ADMINLANG['mergefields']['configoptions'] = "Config. Opções (Matriz)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Config. Opções (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Listar Notas de Crédito e Débito";
$_ADMINLANG['permissions']['165'] = "Criar Nota de Crédito ou Débito";
$_ADMINLANG['permissions']['166'] = "Ver Nota de Crédito ou Débito";
$_ADMINLANG['permissions']['167'] = "Gerir Nota de Crédito ou Débito";
$_ADMINLANG['permissions']['168'] = "Eliminar Nota de Crédito ou Débito";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Falta a permissão necessária.";
...
$_ADMINLANG['products']['productgroupicon'] = "Ícone de grupo";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "por exemplo, fa-house de madeira maciça";
...
$_ADMINLANG['status']['issued'] = "Emitido";
...
$_ADMINLANG['support']['aiAssisted'] = "Assistido por IA";
$_ADMINLANG['support']['aiConfirmReview'] = "Confirmar revisão de dados";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Confirme se revisou os dados do ticket higienizado e está pronto para gerar sugestões de IA. Remover ou mascarar toda a informação sensível.";
$_ADMINLANG['support']['aiContentRequired'] = "O conteúdo é obrigatório";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Nenhuma permissão para esta funcionalidade para a sua função";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Introduzir conteúdo higienizado";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Introduzir assunto higienizado";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Feedback opcional";
$_ADMINLANG['support']['aiGenerate'] = "Gerar";
$_ADMINLANG['support']['aiGenerateResponse'] = "Gerar Sugestão de IA";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Ajude-nos a melhorar as respostas da IA";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Quão útil foi esta resposta?";
$_ADMINLANG['support']['aiInitialMessage'] = "Mensagem Inicial";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Mensagem Inicial";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Assunto do Bilhete";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Diga-nos como podemos melhorar esta sugestão";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Números de cartão de crédito, palavras-passe ou dados sensíveis";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Nomes de clientes, e-mails, números de telefone";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Revise e remova qualquer Informação Pessoal Identificável (PII) antes de gerar sugestões de IA:";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Aviso de Privacidade:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Endereços pessoais ou informações privadas";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Classifique esta sugestão";
$_ADMINLANG['support']['aiRatingFeedback'] = "Fornecer Feedback";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Partilhe a sua Experiência Positiva";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Como podemos melhorar?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Agradecemos o seu feedback. Por favor, deixe-nos saber como podemos melhorar as sugestões de IA.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "Estamos felizes que tenha achado isto útil! Por favor, partilhe o que tornou esta sugestão eficaz para si.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Lamentamos que esta sugestão não tenha correspondido às suas expectativas. Por favor, deixe-nos saber o que podemos fazer melhor.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Introduza aqui os seus comentários...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Partilhe o que tornou isto útil...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Diga-nos como podemos melhorar...";
$_ADMINLANG['support']['aiReplyThread'] = "Responder Tópico";
$_ADMINLANG['support']['aiResponseGenerated'] = "Resposta de IA gerada:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "O sistema gerou uma resposta sugerida. Agora pode inseri-lo na sua resposta.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Rever Análise de Conversação";
$_ADMINLANG['support']['aiSubject'] = "Assunto do Bilhete";
$_ADMINLANG['support']['aiSubjectRequired'] = "Assunto obrigatório";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Enviar Feedback";
$_ADMINLANG['support']['aiSuggestions'] = "Sugestões de IA";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Obrigado pelo seu feedback!";
$_ADMINLANG['support']['aiTicketContent'] = "Conteúdo do Bilhete";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Ocorreu um erro ao tentar fixar o ticket.";
$_ADMINLANG['support']['pinTicket'] = "Bilhete Pin";
...
$_ADMINLANG['support']['ticket']['action']['customFieldValueUpdatePlaceholder'] = "Se não introduzir um valor, a acção agendada actualizará o campo personalizado com um valor vazio.";
...
$_ADMINLANG['support']['ticket']['action']['scheduleDuplicateError'] = "O sistema não pôde salvar a ação. Não é possível programar várias actualizações para o mesmo campo personalizado.";
...
$_ADMINLANG['support']['ticket']['action']['skip']['any_reply'] = "Desmarcar o agendamento após uma atualização de ticket";
$_ADMINLANG['support']['ticket']['action']['skip']['no_skip'] = "Não desmarcar o agendamento após uma atualização de ticket";
$_ADMINLANG['support']['ticket']['action']['skip']['nonadmin_reply'] = "Desagendar após uma atualização de ticket não administrativo";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Erro ao salvar o anexo: a pasta de destino não pode ser gravada.</br>Verifique as permissões da sua pasta.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Tem de especificar um cliente existente ou introduzir o endereço de correio electrónico do destinatário manualmente.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Tem de introduzir o nome da pessoa para a qual está a criar este ticket ou especificar um cliente existente.";
...
$_ADMINLANG['support']['unpinTicket'] = "Bilhete Desfixar";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "Tem de desactivar o Captcha para Formulários de Login em <a href='configgeneral.php#tab=10'>Definições de Segurança</a> para utilizar o Código de Integração";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "Tem de desactivar o Captcha para o Verificador de Domínio em <a href='configgeneral.php#tab=10'>Definições de Segurança</a> para utilizar o Código de Integração";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Permite repor automaticamente o número de crédito periodicamente.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Notas de Crédito Personalizadas";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Formato de Numeração de Notas de Crédito Personalizado";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "O formato do número das notas de crédito. Se incluir etiquetas, o sistema irá substituí-las automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Numeração Personalizada de Notas de Crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Marque para activar formatos de numeração personalizados para notas de crédito.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Próximo Número da Nota de Crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "O próximo número da nota de crédito a atribuir.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Notas de débito personalizadas";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Formato de Numeração de Notas de Débito Personalizado";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "O formato do número das notas de débito. Se incluir etiquetas, o sistema irá substituí-las automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Numeração de Notas de Débito Personalizada";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Marque para activar formatos de numeração personalizados para notas de débito.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Próximo Número da Nota de Débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "O próximo número da nota de débito a atribuir.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Validar o formato durante a finalização da compra";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Não Validar (Desactivado)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Validar com a Autoridade Relevante";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Valide na finalização da compra e com Autoridade Relevante";
...
$_ADMINLANG['taxconfig']['vat']['modeUK']['label'] = "Modo de validação do IVA no Reino Unido";
$_ADMINLANG['taxconfig']['vat']['provider']['VIES']['name'] = "VISTOS";
$_ADMINLANG['taxconfig']['vat']['provider']['WhmcsVatService']['name'] = "Verificação Remota";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAll']['name'] = "Aceitar Todos os Números de IVA";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAllToDo']['name'] = "Aceitar Todos os Números de IVA e Criar um Item a Fazer";
$_ADMINLANG['taxconfig']['vat']['provider']['denyAll']['name'] = "Negar tudo";
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Actualizar Automaticamente as Regras do IVA";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Alterne para habilitar verificações automáticas para regras de IVA atualizadas. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Saber mais</a>.";
...
$_ADMINLANG['user']['changePasswordForEmail'] = "Alterar Palavra-passe: :email";
...
$_ADMINLANG['user']['sendPasswordResetEmail'] = "Enviar e-mail de redefinição de palavra-passe";
...
$_ADMINLANG['userLogin']['createAccount'] = "Criar conta";
...
$_ADMINLANG['validation']['password']['max'] = "As palavras-passe não podem conter mais do que :max caracteres.";
...
$_ADMINLANG['whois']['invalidtld'] = "Não é possível realizar pesquisas WHOIS para o %s TLD.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Permitir Rastreamento";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Negar Rastreamento";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Ajude-nos a melhorar o WHMCS</strong><br /> Utilizamos o rastreio anónimo para melhorar o WHMCS. A sua participação ajuda-nos a tornar o WHMCS mais intuitivo e fácil de usar. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Saiba mais sobre os dados que recolhemos</a>.";
