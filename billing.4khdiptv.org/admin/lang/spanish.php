...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Eliminación de caracteres no válidos";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "El sistema detectó y eliminó caracteres UTF-8 de 4 bytes no válidos en los valores de configuración guardados.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Comentarios adicionales (opcional)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Ajustar el tono y la duración";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "La IA está analizando el contexto de la conversación y elaborando una respuesta personalizada";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Sugerencia de IA generada. Revisa la sugerencia antes de insertarla en tu respuesta.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Se ha insertado una sugerencia de IA. Revisa antes de enviar.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugerencia de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "No se pudo extraer el resumen del billete. Inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Recibí una respuesta no válida del servicio de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Fallo en la validación de la licencia. Compruebe sus credenciales e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "No se pudo generar un mensaje de IA. Inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "No se pudo guardar la respuesta de la IA. Inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "Se agotó el tiempo de espera del servicio de soporte de IA. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "El servicio de soporte de IA no está disponible temporalmente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Fallo de autenticación. Comprueba las credenciales de tu agente de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "No se puede conectar al servicio de IA. Comprueba la conexión de red e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Error en la operación de base de datos. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "No se pudieron descifrar los datos. Póngase en contacto con el servicio de asistencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Fallo en el cifrado de datos. Póngase en contacto con el servicio de asistencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Se ha producido un error inesperado. Vuelve a intentarlo o ponte en contacto con el servicio de asistencia";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Saldo crediticio insuficiente. Añade créditos a tu cuenta e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Se ha producido un error interno. Vuelva a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "La entrada proporcionada no es válida. Comprueba los datos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Formato de solicitud no válido. Comprueba los datos introducidos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Falló la verificación de la firma de la solicitud. Comprueba tu clave de licencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "La clasificación por estrellas debe estar entre 1 y 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Los datos del billete no son válidos o están mal formados.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "El identificador de seguimiento debe tener un formato de UUID válido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "No se encontró el artículo de la base de conocimientos.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Esta licencia ya está registrada en el sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Tu licencia de IA ha caducado. Renueva tu suscripción.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licencia proporcionada no es válida.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "No se encontró la licencia. Compruebe la configuración e inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Se ha suspendido tu licencia de IA. Ponte en contacto con el servicio de asistencia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La clave de API del proveedor de IA no es válida. Comprueba tu configuración.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "No se ha encontrado ningún artículo relevante en la base de conocimientos de este ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "El proveedor de IA ha devuelto un error. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Se ha superado el límite de frecuencia del proveedor de IA. Vuelve a intentarlo en unos instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "El sistema no pudo generar una respuesta de IA. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "No se pudo buscar en la base de conocimientos con IA. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "El proveedor de IA no está disponible temporalmente. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "El servicio de IA tardó demasiado en responder. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Falta el campo de datos cifrados obligatorio.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Las credenciales del cliente de OAuth no son válidas.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "El token de OAuth no es válido o se ha revocado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "El token de OAuth ha caducado. Vuelva a autenticarse.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "No se pudieron descifrar los datos del ticket. Compruebe las claves de cifrado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Los datos proporcionados no son válidos o están dañados.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "No se pudieron desinfectar los datos confidenciales. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Se agotó el tiempo de espera de la desinfección de datos. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "El servicio de desinfección de datos no está disponible temporalmente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Has superado tu cuota mensual de fichas de IA. Actualiza tu plan.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Demasiadas solicitudes. Vuelva a intentarlo en unos instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "No se encontró el registro solicitado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "El servicio de IA no está disponible temporalmente. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "No tienes permiso para acceder a esta entrada.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "No se encontró el ticket en el sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Fallo en la validación de la solicitud. Comprueba los datos introducidos e inténtalo de nuevo.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Falló la ejecución del flujo de trabajo de IA. Vuelva a intentarlo.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Cancelar";
$_ADMINLANG['aiSuggestions']['collapse'] = "Colapso";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Colapsar todo";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "¿Estás seguro de que quieres eliminar tu valoración?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Confirme que ha revisado los datos desinfectados y que está listo para generar sugerencias de IA.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Datos cargados y desinfectados (respuestas%s ). Revisa y genera sugerencias.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Eliminar calificación";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documentos encontrados";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Editar el contenido del mensaje:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Editar calificación";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Editar este mensaje...";
$_ADMINLANG['aiSuggestions']['error'] = "Error:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "No se ha podido generar una sugerencia de IA. Vuelve a intentarlo más tarde.";
$_ADMINLANG['aiSuggestions']['expand'] = "Expandir";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Expandir todo";
$_ADMINLANG['aiSuggestions']['generate'] = "Generar";
$_ADMINLANG['aiSuggestions']['generating'] = "Generando...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generando una sugerencia de IA...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generando una sugerencia de IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Generación fallida: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "¿Cómo fue esta sugerencia?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insertar en la respuesta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Fecha no válida";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Respuesta no válida de sanitize endpoint; faltan campos obligatorios";
$_ADMINLANG['aiSuggestions']['length'] = "Longitud";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Conciso";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Detallado";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Cargando los datos del billete...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Falta %s en la respuesta de la API";
$_ADMINLANG['aiSuggestions']['networkError'] = "Error de red";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Error de red durante la operación %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "No hay ninguna sugerencia de IA disponible.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "No se utilizaron documentos de referencia para esta respuesta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "No se han encontrado mensajes de respuesta.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "No hay datos desinfectados disponibles. Recarga los datos de los tickets.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Sin tema";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "Error en la operación %s";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Por favor, selecciona una valoración";
$_ADMINLANG['aiSuggestions']['processing'] = "Procesando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Procesando su solicitud, espere...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Califica la sugerencia de IA";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "La calificación se ha eliminado correctamente";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Excelente";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "No se pudo enviar la calificación. Por favor, inténtelo de nuevo.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Feria";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Buena";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Pobre";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "¡Gracias por tus comentarios!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Muy bueno";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Acciones recomendadas:";
$_ADMINLANG['aiSuggestions']['references'] = "Referencias";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Se utilizaron los siguientes artículos y documentos de la base de conocimientos para generar esta respuesta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Has alcanzado el número máximo de regeneraciones (3). Utilice la sugerencia actual.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerador...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Regeneraciones restantes: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Eliminar información confidencial y preparar el contenido para el análisis de IA";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Respuesta%s restablecer.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Hilo de respuesta (mensajes%s )";
$_ADMINLANG['aiSuggestions']['reset'] = "Reiniciar";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Respuesta generada correctamente";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Su respuesta generada por IA está lista";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Respuesta regenerada con nuevos parámetros";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Recuperar el historial de conversaciones y los detalles del ticket";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Conversación de revisión para el análisis de IA";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Revisa cuidadosamente los datos desinfectados de las entradas que aparecen a continuación. Asegúrate de haber eliminado o ocultado toda la información confidencial antes de generar sugerencias de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Revise los datos desinfectados antes de generarlos";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Fallo en la desinfección.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Desinfectar y cargar los datos de los tickets...";
$_ADMINLANG['aiSuggestions']['staff'] = "Empleados";
$_ADMINLANG['aiSuggestions']['stars'] = "estrellas";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Enviar valoración";
$_ADMINLANG['aiSuggestions']['submitting'] = "Enviando...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Respuesta sugerida:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "La sugerencia ha fallado.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Personal de apoyo";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Cuéntanos más sobre tu experiencia...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Análisis de entradas:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Los datos de las entradas no están disponibles";
$_ADMINLANG['aiSuggestions']['tone'] = "Tono";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formal";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Amistoso";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Técnico";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "No se ha podido encontrar el cuadro de respuesta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Fecha desconocida";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Error desconocido";
$_ADMINLANG['aiSuggestions']['youRated'] = "Calificaste esto:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Sus comentarios:";
...
$_ADMINLANG['billing']['ledger'] = "Libro mayor";
$_ADMINLANG['billing']['netIncome'] = "Ingresos netos";
$_ADMINLANG['billing']['nocomments'] = "No hay comentarios dirigidos al cliente para este documento.";
$_ADMINLANG['billing']['offlinecc'] = "Cobros por tarjeta";
$_ADMINLANG['billing']['title'] = "Facturación";
$_ADMINLANG['billing']['transaction'] = "Transacción";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Este es un borrador de nota de crédito. El cliente no puede ver ni acceder a esta nota de crédito hasta que hagas clic en Emitir.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Artículos de notas de crédito";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Administrar nota de crédito";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Número de nota de crédito";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Ver nota de crédito";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Se trata de un borrador de nota de débito. El cliente no puede ver ni acceder a esta nota de débito hasta que hagas clic en Emitir.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Artículos de notas de débito";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Administrar nota de débito";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Número de nota de débito";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Ver nota de débito";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "El sistema no puede modificar el atributo \":attribute\" de un albarán que esté en el estado \":status».";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "El sistema no puede agregar una partida a una nota de facturación que no esté en estado Borrador.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "El sistema no puede asignar ni modificar una partida de una nota de facturación que no esté en estado Borrador (ID de línea de pedido: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "El sistema solo puede modificar las notas de facturación mientras están en estado Borrador.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Último Acceso";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Anfitrión";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Vuelve a intentarlo más tarde.";
$_ADMINLANG['errorPage']['429']['title'] = "Se ha superado el límite de velocidad";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "No puedes modificar este artículo.";
...
$_ADMINLANG['fields']['clientcredit'] = "Crédito de cliente";
...
$_ADMINLANG['fields']['reference'] = "Referencia";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Introduzca el incremento deseado entre los números de nota de crédito generados (predeterminado:1, máximo: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Incremento del número de nota de crédito";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Introduzca el incremento deseado entre los números de nota de débito generados (predeterminado:1, máximo: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Incremento del número de nota de débito";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "¿Deshabilitar la renovación automática y cancelar los artículos de la factura para este dominio?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Esta acción eliminará los siguientes artículos de la factura: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "El valor :inputLabel debe estar entre 1 y 999.";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Restablecimiento de contraseña (requiere que los usuarios completen un CAPTCHA después de varios intentos de restablecimiento de contraseña).";
...
$_ADMINLANG['general']['seeActivityLog'] = "Revisa el registro de actividad para obtener más información.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Elige el idioma que verás en el área de administración.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Elija el idioma que verán sus clientes cuando inicien sesión en el área de clientes.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Elige el idioma que tú y tus clientes ven de forma predeterminada.";
...
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Localización";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Idioma del área de administración";
...
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Idioma por defecto";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Selecciona tu idioma predeterminado.";
...
$_ADMINLANG['global']['lastActive'] = "Último activo";
...
$_ADMINLANG['global']['manageMember'] = "Administrar administrador";
...
$_ADMINLANG['global']['online'] = "En Servicio";
...
$_ADMINLANG['global']['products'] = "Productos";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "La inmutabilidad de las facturas está desactivada. Hemos dejado de usar la posibilidad de editar las facturas y eliminaremos la opción para habilitar la mutabilidad de las facturas en una versión futura.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Ha configurado su sistema para permitir la edición de facturas (mutabilidad de facturas) para las facturas que no sean de borrador. Hemos dejado de usar esta capacidad en WHMCS 9.0 y eliminaremos la configuración que permite este comportamiento en una versión futura.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Inmutabilidad de la factura";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "El cifrado del almacenamiento con autenticación de dos factores está en curso.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "El almacenamiento de autenticación de dos factores es seguro.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Almacenamiento de autenticación de dos factores";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Puedes obtener más información sobre esto en nuestra documentación.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "No se puede escribir en el almacenamiento de sesiones de PHP. Para obtener ayuda, póngase en contacto con el administrador del sistema. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Obtenga más información.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "¿Estás seguro de que deseas cancelar esta factura? Los artículos recurrentes de la factura no se volverán a facturar en esta fecha.";
$_ADMINLANG['invoices']['cancelPayment'] = "Cancelar pago";
$_ADMINLANG['invoices']['cancelTitle'] = "Cancelar factura";
...
$_ADMINLANG['invoices']['delete'] = "¿Estás seguro de que deseas eliminar esta factura?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "El sistema no puede modificar el atributo \":attribute\" de una factura con el estado \":status».";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "El sistema no puede agregar una línea de pedido a una factura a menos que esté en estado Borrador.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "El sistema no puede asignar ni modificar una línea de pedido en una factura a menos que esté en estado Borrador (ID de línea de pedido: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "El sistema solo puede modificar las facturas mientras están en estado Borrador.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "La inmutabilidad de las facturas está desactivada. Puedes solicitar cambios de estado no válidos en la pestaña de opciones de Gestionar facturas &raquo; .";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "El sistema solo puede hacer la transición de una factura a Cancelada desde los siguientes estados: Impagada, Pago pendiente o Cobros.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "El sistema solo puede eliminar un borrador de factura.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "El sistema solo puede hacer la transición de una factura a Pagada desde los siguientes estados: Impagada, Pago pendiente o Cobros.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "El sistema solo puede aplicar pagos a una factura en estado Impagado, Pago pendiente o Cobros.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "El sistema solo puede reembolsar los pagos de una factura en estado Impagado, Pago pendiente, Pagado o Cobrados.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Haga clic para aplicar una nota de crédito al saldo restante, marcar Pagado y ejecutar cualquier acción posterior al pago.";
...
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Se trata de una factura cancelada.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Por favor, %s primero para aplicar un pago";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Se trata de una factura de cobro.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Se trata de un borrador de factura.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "No puedes modificar una factura que sea :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Se trata de una factura pagada.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Se trata de una factura de pago pendiente.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Esta factura se reembolsa.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Se trata de una factura impaga.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Haga clic aquí para generar y aplicar las notas de crédito o débito necesarias para hacer la transición de la factura a Cancelada.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Haga clic aquí para generar y aplicar una nota de crédito para el saldo restante y pasar la factura a Pagada. Esto también ejecutará cualquier acción posterior al pago.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "El sistema hizo la transición exitosa de :successes de :attempted facturas a canceladas.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "El sistema ha eliminado correctamente :successes de las :attempted facturas.";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "El sistema hizo la transición exitosa de :successes de :attempted facturas a pagadas.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "El sistema hizo la transición exitosa de :successes de las :attempted facturas a impagadas.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "¿Está seguro que desea eliminar las facturas seleccionadas?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Tu selección incluye las facturas que no son de borrador. El sistema modificará estas facturas porque la inmutabilidad de las facturas está desactivada.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "El sistema no pudo descifrar un token de API de MarketConnect. Compruebe el hash de cifrado de su CC o desconecte y vuelva a conectar su cuenta de WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Fallo de autenticación. Compruebe sus credenciales de WHMCS Marketplace en Configuración <i class='far fa-wrench' aria-hidden='true'></i> > Configuración del sistema > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Ofrece todos los productos <b>:serviceName</b> .";
...
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "Acerca de";
$_ADMINLANG['marketConnect']['learn']['tab']['faq'] = "PREGUNTAS MÁS FRECUENTES";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "WHMCS Ltd. y sus filiales del grupo WebPros pueden proporcionarme noticias y ofertas individuales sobre los productos WebPros de acuerdo con la Política de privacidad <a href=\"https://www.webpros.com/legal\">de WebPros</a>. Puedo revocar este consentimiento haciendo clic en el enlace de cualquier comunicación recibida.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/mes";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/mes";
$_ADMINLANG['marketConnect']['points'] = "Puntos";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Precio de venta recomendado";
$_ADMINLANG['marketConnect']['refresh'] = "Refrescar";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Estado de venta";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "Acerca de nosotros";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Activar";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Desactivar";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Más información";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Gestionar";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Empieza a vender";
...
$_ADMINLANG['mergefields']['configoptions'] = "Configuración. Opciones (matriz)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Configuración. Opciones (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Listar notas de crédito y débito";
$_ADMINLANG['permissions']['165'] = "Crear nota de crédito o débito";
$_ADMINLANG['permissions']['166'] = "Ver nota de crédito o débito";
$_ADMINLANG['permissions']['167'] = "Administrar notas de crédito o débito";
$_ADMINLANG['permissions']['168'] = "Eliminar nota de crédito o débito";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Falta el permiso requerido.";
...
$_ADMINLANG['products']['productgroupicon'] = "Icono de grupo";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "p. ej., una casa de ventilador muy sólida";
...
$_ADMINLANG['support']['aiAssisted'] = "Asistido por IA";
$_ADMINLANG['support']['aiConfirmReview'] = "Confirme la revisión de datos";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Confirma que has revisado los datos de los tickets desinfectados y que estás listo para generar sugerencias de IA. Elimine o oculte toda la información confidencial.";
$_ADMINLANG['support']['aiContentRequired'] = "El contenido es obligatorio";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "No tienes permiso para usar esta función";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Introducir contenido desinfectado";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Ingresa el tema desinfectado";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Comentarios opcionales";
$_ADMINLANG['support']['aiGenerate'] = "Generar";
$_ADMINLANG['support']['aiGenerateResponse'] = "Generar sugerencias de IA";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Ayúdenos a mejorar las respuestas de la IA";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "¿Qué tan útil fue esta respuesta?";
$_ADMINLANG['support']['aiInitialMessage'] = "Mensaje inicial";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Mensaje inicial";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Asunto del billete";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Cuéntanos cómo podemos mejorar esta sugerencia";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Números de tarjetas de crédito, contraseñas o datos confidenciales";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Nombres de clientes, correos electrónicos, números de teléfono";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Revisa y elimina cualquier información de identificación personal (PII) antes de generar sugerencias de IA:";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Aviso de privacidad:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Direcciones personales o información privada";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Valora esta sugerencia";
$_ADMINLANG['support']['aiRatingFeedback'] = "Proporcione comentarios";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Comparta su experiencia positiva";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "¿Cómo podemos mejorar?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Agradecemos tus comentarios. Háganos saber cómo podemos mejorar las sugerencias de la IA.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "¡Nos alegra que lo hayas encontrado útil! Comparta qué hizo que esta sugerencia fuera efectiva para usted.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Lamentamos que esta sugerencia no haya cumplido tus expectativas. Háganos saber qué podemos hacer mejor.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Escriba aquí sus comentarios...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Comparta lo que hizo que esto fuera útil...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Cuéntanos cómo podemos mejorar...";
$_ADMINLANG['support']['aiReplyThread'] = "Hilo de respuesta";
$_ADMINLANG['support']['aiResponseGenerated'] = "Respuesta de IA generada:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "El sistema generó una respuesta sugerida. Ahora puede insertarla en su respuesta.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Revise el análisis de la conversación";
$_ADMINLANG['support']['aiSubject'] = "Asunto del billete";
$_ADMINLANG['support']['aiSubjectRequired'] = "El asunto es obligatorio";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Enviar comentarios";
$_ADMINLANG['support']['aiSuggestions'] = "Sugerencias de IA";
$_ADMINLANG['support']['aiThankYouFeedback'] = "¡Gracias por tus comentarios!";
$_ADMINLANG['support']['aiTicketContent'] = "Contenido de las entradas";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Se ha producido un error al intentar fijar el billete.";
$_ADMINLANG['support']['pinTicket'] = "Boleto PIN";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Error al guardar el archivo adjunto: no se puede escribir en la carpeta de destino.</br>Comprueba los permisos de tu carpeta.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Debe especificar un cliente existente o introducir la dirección de correo electrónico del destinatario manualmente.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Debe introducir el nombre de la persona para la que está creando este ticket o especificar un cliente existente.";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "Debes deshabilitar Captcha para los formularios de inicio de sesión en <a href='configgeneral.php#tab=10'>Security Settings</a> para usar el código de integración";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "Debes deshabilitar Captcha for Domain Checker en <a href='configgeneral.php#tab=10'>Security Settings</a> para usar el código de integración";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Le permite restablecer automáticamente el número de crédito de forma periódica.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Formato de numeración de notas de crédito personalizado";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "El formato numérico de las notas de crédito. Si incluye etiquetas, el sistema las reemplazará automáticamente.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Numeración personalizada de notas de crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Active esta casilla para habilitar los formatos de numeración personalizados para las notas de crédito.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Siguiente número de nota de crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "El siguiente número de nota de crédito que se va a asignar.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Notas de débito personalizadas";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Formato de numeración de notas de débito personalizado";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "El formato numérico de las notas de débito. Si incluyes etiquetas, el sistema las reemplazará automáticamente.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Numeración personalizada de notas de débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Active esta casilla para habilitar los formatos de numeración personalizados para las notas de débito.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Siguiente número de nota de débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "El siguiente número de nota de débito que se va a asignar.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Validar el formato durante el proceso de pago";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "No validar (desactivado)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Validar con la autoridad pertinente";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Validar al finalizar la compra y con la autoridad pertinente";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Actualización automática de las normas de IVA";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Activa para activar las comprobaciones automáticas de las normas de IVA actualizadas. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Más información</a>.";
...
$_ADMINLANG['userLogin']['createAccount'] = "Crear cuenta";
...
$_ADMINLANG['validation']['password']['max'] = "Las contraseñas no pueden contener más de :max caracteres.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Permitir seguimiento";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Denegar el seguimiento";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Ayúdenos a mejorar el WHMCS</strong><br /> Utilizamos el seguimiento anónimo para mejorar el WHMCS. Su participación nos ayuda a hacer que WHMCS sea más intuitivo y fácil de usar. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Obtenga más información sobre los datos que recopilamos</a>.";
