...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Suppression de caractères non valides";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "Le système a détecté et supprimé des caractères UTF-8 de 4 octets non valides dans les valeurs de configuration enregistrées.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Feedback supplémentaire (facultatif)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Régler le ton et la longueur";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "L'IA analyse le contexte de la conversation et élabore une réponse personnalisée";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Suggestion d'IA générée. Passez en revue la suggestion avant de l'insérer dans votre réponse.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Suggestion d'IA insérée. Révisez avant d'envoyer.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Suggestion d'IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Impossible d'extraire le résumé du ticket. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "J'ai reçu une réponse non valide de la part du service AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "La validation de la licence a échoué. Vérifiez vos informations d'identification et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Impossible de générer une invite d'IA. Réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Impossible d'enregistrer la réponse de l'IA. Essaie encore une fois.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "Le délai du service d'assistance en matière d'IA a expiré. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "Le service d'assistance AI est temporairement indisponible.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "L'authentification a échoué. Vérifiez les informations d'identification de votre agent AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Impossible de se connecter au service AI. Vérifiez votre connexion réseau et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "L'opération de base de données a échoué. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Impossible de déchiffrer les données. Veuillez contacter le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Le chiffrement des données a échoué. Veuillez contacter le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Une erreur inattendue s'est produite. Réessayez ou contactez le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Solde créditeur insuffisant. Ajoutez des crédits à votre compte et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Une erreur interne s'est produite. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "L'entrée fournie n'est pas valide. Vérifiez vos données et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Format de demande non valide. Vérifiez les données saisies et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "La vérification de la signature de la demande a échoué. Vérifiez votre clé de licence.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Le nombre d'étoiles doit être compris entre 1 et 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Les données du ticket ne sont pas valides ou sont mal formées.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "L'ID de trace doit être au format UUID valide.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "L'article de la base de connaissances n'a pas été trouvé.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Cette licence est déjà enregistrée dans le système.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Votre licence AI a expiré. Renouvelez votre abonnement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licence fournie n'est pas valide.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licence introuvable. Vérifiez votre configuration et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Votre licence AI a été suspendue. Veuillez contacter le support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La clé d'API du fournisseur d'IA n'est pas valide. Vérifiez votre configuration.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Aucun article pertinent n'a été trouvé dans la base de connaissances pour ce ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "Le fournisseur d'IA a renvoyé une erreur. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "La limite de débit des fournisseurs d'IA est dépassée. Réessayez dans quelques instants.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Le système n'a pas réussi à générer de réponse IA. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Impossible de faire une recherche dans la base de connaissances à l'aide de l'IA. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "Le fournisseur d'IA est temporairement indisponible. Veuillez réessayer ultérieurement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Le service d'IA a mis trop de temps à répondre. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Champ de données crypté obligatoire manquant.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Les informations d'identification du client OAuth ne sont pas valides.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Le jeton OAuth n'est pas valide ou a été révoqué.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Le jeton OAuth a expiré. Veuillez vous authentifier à nouveau.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Impossible de déchiffrer les données du ticket. Vérifiez les clés de chiffrement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Les données fournies ne sont pas valides ou sont corrompues.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Impossible de nettoyer les données sensibles. Réessayez, s'il vous plaît.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Le délai de nettoyage des données a expiré. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "Le service de nettoyage des données est temporairement indisponible.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Vous avez dépassé votre quota mensuel de jetons IA. Veuillez mettre à jour votre plan.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Trop de demandes. Réessayez dans quelques instants.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "L'enregistrement demandé n'a pas été trouvé.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "Le service d'IA est temporairement indisponible. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Vous n'êtes pas autorisé à accéder à ce ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Le ticket n'a pas été trouvé dans le système.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "La validation de la demande a échoué. Vérifiez votre saisie et réessayez.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "L'exécution du flux de travail AI a échoué. Réessayez.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Annuler";
$_ADMINLANG['aiSuggestions']['collapse'] = "Effondrement";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Tout réduire";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Êtes-vous sûr de vouloir supprimer votre évaluation ?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Vérifiez que vous avez examiné les données nettoyées et que vous êtes prêt à générer des suggestions d'IA.";
$_ADMINLANG['aiSuggestions']['customer'] = "Client";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Données chargées et nettoyées (réponses%s ). Passez en revue et générez des suggestions.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Supprimer l'évaluation";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documents trouvés";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Modifier le contenu du message :";
$_ADMINLANG['aiSuggestions']['editRating'] = "Modifier la note";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Modifiez ce message...";
$_ADMINLANG['aiSuggestions']['error'] = "Erreur:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Impossible de générer une suggestion d'IA. Réessayez plus tard.";
$_ADMINLANG['aiSuggestions']['expand'] = "Élargir";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Tout développer";
$_ADMINLANG['aiSuggestions']['generate'] = "Produire";
$_ADMINLANG['aiSuggestions']['generating'] = "Génération de...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Génération de suggestions d'IA...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Génération de suggestions d'IA...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "La génération a échoué : %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Comment s'est passée cette suggestion ?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insérer dans la réponse";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Date non valide";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Réponse non valide du terminal de désinfection - champs obligatoires manquants";
$_ADMINLANG['aiSuggestions']['length'] = "Longueur";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Concis";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Détaillé";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Chargement des données des tickets...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "%s manquant dans la réponse de l'API";
$_ADMINLANG['aiSuggestions']['networkError'] = "Erreur réseau";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Erreur réseau lors de l'opération %s  : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Aucune suggestion d'IA n'est disponible.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Aucun document de référence n'a été utilisé pour cette réponse.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Aucun message de réponse n'a été trouvé.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Aucune donnée aseptisée n'est disponible. Rechargez les données du ticket.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Pas de sujet";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "L'opération %s a échoué";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Veuillez sélectionner une note";
$_ADMINLANG['aiSuggestions']['processing'] = "Traitement...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Votre demande est en cours de traitement, veuillez patienter...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Évaluez la suggestion d'IA";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Évaluation supprimée avec succès";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Excellent";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Impossible de soumettre l'évaluation. Veuillez réessayer.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Juste";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Bien";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Mauvais";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Merci pour vos commentaires !";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Très bien";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Actions recommandées :";
$_ADMINLANG['aiSuggestions']['references'] = "Références";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Les articles et documents de la base de connaissances suivants ont été utilisés pour générer cette réponse :";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Régénérez";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Vous avez atteint le nombre maximum de régénérations (3). Veuillez utiliser la suggestion actuelle.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Régénérant...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Régénérations restantes : %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Suppression des informations sensibles et préparation du contenu pour l'analyse de l'IA";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Réinitialiser la réponse%s .";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Fil de réponse (messages%s )";
$_ADMINLANG['aiSuggestions']['reset'] = "Réinitialiser";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Réponse générée avec succès";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Votre réponse générée par l'IA est prête";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Réponse régénérée avec de nouveaux paramètres";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Récupération de l'historique des conversations et des détails des tickets";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Écrire un avis sur Conversation for AI Analysis";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Lisez attentivement les données des billets assainies ci-dessous. Assurez-vous d'avoir supprimé ou masqué toutes les informations sensibles avant de générer des suggestions d'IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Passez en revue les données nettoyées avant de les générer";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "La désinfection a échoué.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Désinfection et chargement des données des tickets...";
$_ADMINLANG['aiSuggestions']['staff'] = "Personnel";
$_ADMINLANG['aiSuggestions']['stars'] = "étoiles";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Soumettre une évaluation";
$_ADMINLANG['aiSuggestions']['submitting'] = "Soumettre...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Réponse suggérée :";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "La suggestion a échoué.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Personnel de soutien";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Dites-nous en plus sur votre expérience...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Analyse des tickets :";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Les données relatives aux billets ne sont pas disponibles";
$_ADMINLANG['aiSuggestions']['tone'] = "Ton";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formelle";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Convivial";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Technique";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Impossible de trouver la boîte de réponse.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Date inconnue";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Erreur inconnue";
$_ADMINLANG['aiSuggestions']['youRated'] = "Vous avez évalué ceci :";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Vos commentaires :";
...
$_ADMINLANG['billing']['creditnote'] = "Note de crédit";
$_ADMINLANG['billing']['debitnote'] = "Note de débit";
...
$_ADMINLANG['billing']['ledger'] = "Grand livre";
$_ADMINLANG['billing']['netIncome'] = "Revenu net";
$_ADMINLANG['billing']['nocomments'] = "Il n'y a aucun commentaire destiné aux clients pour ce document.";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Il s'agit d'une ébauche de note de crédit. Le client ne peut pas voir ni accéder à cette note de crédit tant que vous n'avez pas cliqué sur Émettre.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Articles relatifs aux notes de crédit";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Gérer la note de crédit";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Numéro de note de crédit";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Afficher la note de crédit";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Il s'agit d'un projet de note de débit. Le client ne peut pas voir ni accéder à cette note de débit tant que vous n'avez pas cliqué sur Émettre.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Éléments relatifs aux notes de débit";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Gérer la note de débit";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Numéro de la note de débit";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Afficher la note de débit";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "Le système ne peut pas modifier l'attribut « :attribute » sur une note de facturation dont le statut est « :status ».";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "Le système ne peut pas ajouter à une note de facturation un poste qui n'est pas au statut Brouillon.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "Le système ne peut pas attribuer ou modifier un poste sur une note de facturation qui n'est pas au statut Brouillon (numéro de ligne : :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "Le système ne peut modifier les notes de facturation que lorsqu'elles sont au statut Brouillon.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Dernière connexion";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Hôte";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Réessayez plus tard.";
$_ADMINLANG['errorPage']['429']['title'] = "Limite de débit dépassée";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Vous ne pouvez pas modifier cet article.";
...
$_ADMINLANG['fields']['clientcredit'] = "Crédit à la clientèle";
...
$_ADMINLANG['fields']['reference'] = "Référence";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Entrez l'incrément souhaité entre les numéros de note de crédit générés (par défaut:1, maximum : 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Incrémentation du numéro de note de crédit";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Entrez l'incrément souhaité entre les numéros de note de débit générés (par défaut:1, maximum : 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Incrémentation du numéro de la note de débit";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Désactiver le renouvellement automatique et annuler les éléments de facture pour ce domaine ?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Cette action supprimera les éléments de facture suivants : <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "La valeur :inputLabel doit être comprise entre 1 et 999.";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Réinitialisation du mot de passe (obliger les utilisateurs à remplir un CAPTCHA après plusieurs tentatives de réinitialisation du mot de passe.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Consultez le journal d'activité pour plus de détails.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Choisissez la langue que vous verrez dans la zone d'administration.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Choisissez la langue que vos clients verront lorsqu'ils se connecteront à l'espace client.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Choisissez la langue que vous et vos clients voyez par défaut.";
...
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Localisation";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Langue de la zone d'administration";
...
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Langage par défaut";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Sélectionnez votre langue par défaut.";
...
$_ADMINLANG['global']['lastActive'] = "Dernière activité";
...
$_ADMINLANG['global']['manageMember'] = "Gérer l'administrateur";
...
$_ADMINLANG['global']['online'] = "En ligne";
...
$_ADMINLANG['global']['products'] = "Produits";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "L'immuabilité des factures est désactivée. Nous avons rendu obsolète la possibilité de modifier les factures et nous supprimerons l'option permettant d'activer la mutabilité des factures dans une prochaine version.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Vous avez configuré votre système pour autoriser la modification des factures (mutabilité des factures) pour les factures non provisoires. Nous avons déconseillé cette fonctionnalité dans WHMCS 9.0 et supprimerons la configuration qui autorise ce comportement dans une prochaine version.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Immuabilité des factures";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "Le chiffrement du stockage par authentification à deux facteurs est en cours.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "Le stockage de l'authentification à deux facteurs est sécurisé.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Stockage d'authentification à deux facteurs";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Vous pouvez en savoir plus à ce sujet dans notre documentation.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "Le stockage des sessions PHP n'est pas inscriptible. Pour obtenir de l'aide, contactez votre administrateur système. <a href=\"https://go.whmcs.com/2545/php-session-storage\">En savoir plus.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Êtes-vous sûr de vouloir annuler cette facture ? Les articles récurrents figurant sur la facture ne seront pas refacturés à cette date.";
$_ADMINLANG['invoices']['cancelPayment'] = "Annuler le paiement";
$_ADMINLANG['invoices']['cancelTitle'] = "Annuler la facture";
...
$_ADMINLANG['invoices']['delete'] = "Êtes-vous sûr de vouloir supprimer cette facture ?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "Le système ne peut pas modifier l'attribut « :attribute » sur une facture dont le statut est « :status ».";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "Le système ne peut pas ajouter de poste à une facture à moins que celle-ci ne soit en statut Brouillon.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "Le système ne peut pas attribuer ou modifier un poste sur une facture à moins que celui-ci ne soit en statut Brouillon (ID de poste : :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "Le système ne peut modifier les factures que lorsqu'elles sont en statut Brouillon.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "L'immuabilité des factures est désactivée. Vous pouvez demander des modifications de statut non valides dans l'onglet Options de gestion de la facture &raquo; .";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "Le système ne peut faire passer une facture à Annulée qu'à partir des statuts suivants : Impayé, Paiement en attente ou Encaissements.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "Le système ne peut supprimer qu'un brouillon de facture.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "Le système ne peut faire passer une facture à Payée qu'à partir des statuts suivants : Impayé, Paiement en attente ou Encaissements.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "Le système peut uniquement appliquer des paiements à une facture dont le statut est Non payé, Paiement en attente ou Recouvrement.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "Le système ne peut rembourser que les paiements provenant d'une facture dont le statut est Non payé, Paiement en attente, Payé ou Recouvrement.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Cliquez pour appliquer une note de crédit pour le solde restant, cochez Payé et exécutez toutes les actions post-paiement.";
...
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Il s'agit d'une facture annulée.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Veuillez d'abord utiliser le hashtag %s pour effectuer un paiement";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Il s'agit d'une facture de recouvrement.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Il s'agit d'un projet de facture.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Vous ne pouvez pas modifier une facture qui est :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Il s'agit d'une facture payée.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Il s'agit d'une facture en attente de paiement.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Cette facture est remboursée.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Il s'agit d'une facture impayée.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Cliquez pour générer et appliquer les notes de crédit ou de débit requises pour faire passer la facture à Annulée.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Cliquez pour générer et appliquer une note de crédit pour le solde restant et passer de la facture à Payée. Cela exécutera également toutes les actions post-paiement.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "Le système a réussi à faire passer :successes des factures :attempted à Annulées.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "Le système a supprimé :successes des factures :attempted avec succès.";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "Le système a réussi à faire passer :successes des factures :attempted à Paid.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "Le système a réussi à faire passer :successes des factures :attempted à Unpaid.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Êtes-vous sûr de vouloir supprimer les factures sélectionnées ?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Votre sélection inclut des factures non provisoires. Le système modifiera ces factures car l'immuabilité des factures est désactivée.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "Le système n'a pas réussi à déchiffrer un jeton d'API MarketConnect. Vérifiez votre hachage de chiffrement CC ou déconnectez et reconnectez votre compte WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "L'authentification a échoué. Vérifiez vos informations d'identification WHMCS Marketplace dans Configuration <i class='far fa-wrench' aria-hidden='true'></i> > Paramètres système > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Offrez tous les produits <b>:serviceName</b> .";
$_ADMINLANG['marketConnect']['gdprConsent'] = "Pour s'inscrire à WHMCS Marketplace, WHMCS Ltd. et ses filiales doivent stocker et traiter vos données personnelles conformément à la politique de confidentialité <a href=\"https://www.webpros.com/legal\">WebPros</a>.";
...
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "À propos";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "WHMCS Ltd. et ses filiales du groupe WebPros peuvent me fournir des actualités et des offres individuelles concernant les produits WebPros conformément à la politique de confidentialité <a href=\"https://www.webpros.com/legal\">WebPros</a>. Je peux révoquer ce consentement en cliquant sur le lien figurant dans toute communication reçue.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/mois";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/mois";
$_ADMINLANG['marketConnect']['points'] = "Points";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Prix de détail recommandé";
$_ADMINLANG['marketConnect']['refresh'] = "Actualiser";
$_ADMINLANG['marketConnect']['sellingStatus'] = "État de vente";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "À propos de nous";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Activer";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Désactiver";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "En apprendre plus";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Gérer";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Commencez à vendre";
...
$_ADMINLANG['mergefields']['configoptions'] = "Configuration. Options (tableau)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Configuration. Options (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Répertorier les notes de crédit et de débit";
$_ADMINLANG['permissions']['165'] = "Créer une note de crédit ou de débit";
$_ADMINLANG['permissions']['166'] = "Afficher la note de crédit ou de débit";
$_ADMINLANG['permissions']['167'] = "Gérer les notes de crédit ou de débit";
$_ADMINLANG['permissions']['168'] = "Supprimer une note de crédit ou de débit";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Permission requise manquante.";
...
$_ADMINLANG['products']['productgroupicon'] = "Icône de groupe";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "Par exemple, un poulailler à base solide";
...
$_ADMINLANG['status']['issued'] = "Publié";
...
$_ADMINLANG['support']['aiAssisted'] = "Assisté par IA";
$_ADMINLANG['support']['aiConfirmReview'] = "Confirmer l'examen des données";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Vérifiez que vous avez examiné les données de ticket nettoyées et que vous êtes prêt à générer des suggestions d'IA. Supprimez ou masquez toutes les informations sensibles.";
$_ADMINLANG['support']['aiContentRequired'] = "Le contenu est obligatoire";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Aucune autorisation d'accès à cette fonctionnalité pour votre rôle";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Entrez du contenu aseptisé";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Entrez un sujet aseptisé";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Feedback facultatif";
$_ADMINLANG['support']['aiGenerate'] = "Produire";
$_ADMINLANG['support']['aiGenerateResponse'] = "Générer une suggestion d'IA";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Aidez-nous à améliorer les réponses de l'IA";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Dans quelle mesure cette réponse vous a-t-elle été utile ?";
$_ADMINLANG['support']['aiInitialMessage'] = "Message initial";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Message initial";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Objet du ticket";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Dites-nous comment nous pouvons améliorer cette suggestion";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Numéros de cartes de crédit, mots de passe ou données sensibles";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Noms, e-mails, numéros de téléphone des clients";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Vérifiez et supprimez toutes les informations personnelles identifiables (PII) avant de générer des suggestions d'IA :";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Avis de confidentialité :";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Adresses personnelles ou informations privées";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Évaluez cette suggestion";
$_ADMINLANG['support']['aiRatingFeedback'] = "Fournir des commentaires";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Partagez votre expérience positive";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Comment pouvons-nous nous améliorer ?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Nous apprécions vos commentaires. Dites-nous comment nous pouvons améliorer les suggestions d'IA.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "Nous sommes ravis que cela vous ait été utile ! Veuillez expliquer pourquoi cette suggestion a été efficace pour vous.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Nous sommes désolés que cette suggestion n'ait pas répondu à vos attentes. Dites-nous ce que nous pouvons améliorer.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Entrez vos commentaires ici...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Partagez en quoi cela vous a été utile...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Dites-nous comment nous pouvons améliorer...";
$_ADMINLANG['support']['aiReplyThread'] = "Fil de réponse";
$_ADMINLANG['support']['aiResponseGenerated'] = "Réponse générée par l'IA :";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "Le système a généré une réponse suggérée. Vous pouvez maintenant l'insérer dans votre réponse.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Analyser les conversations";
$_ADMINLANG['support']['aiSubject'] = "Objet du ticket";
$_ADMINLANG['support']['aiSubjectRequired'] = "Le sujet est obligatoire";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Soumettre des commentaires";
$_ADMINLANG['support']['aiSuggestions'] = "Conseils d'IA";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Merci pour vos commentaires !";
$_ADMINLANG['support']['aiTicketContent'] = "Contenu du ticket";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Une erreur s'est produite lors de la tentative d'épingler le ticket.";
$_ADMINLANG['support']['pinTicket'] = "Billet Pin";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Erreur lors de l'enregistrement de la pièce jointe : le dossier de destination n'est pas accessible en écriture.</br>Vérifiez les autorisations de vos dossiers.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Vous devez spécifier un client existant ou saisir manuellement l'adresse e-mail du destinataire.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Vous devez saisir le nom de la personne pour laquelle vous créez ce ticket ou spécifier un client existant.";
...
$_ADMINLANG['support']['unpinTicket'] = "Désépingler un ticket";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "Vous devez désactiver le Captcha pour les formulaires de connexion dans <a href='configgeneral.php#tab=10'>Security Settings</a> pour utiliser le code d'intégration";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "Vous devez désactiver Captcha pour Domain Checker dans <a href='configgeneral.php#tab=10'>Security Settings</a> pour utiliser le code d'intégration";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Vous permet de réinitialiser automatiquement le numéro de crédit périodiquement.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Notes de crédit personnalisées";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Format de numérotation personnalisé des notes de crédit";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "Format numérique des notes de crédit. Si vous incluez des balises, le système les remplacera automatiquement.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Numérotation personnalisée des notes de crédit";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Cochez cette case pour activer les formats de numérotation personnalisés pour les notes de crédit.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Numéro de note de crédit suivant";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "Le prochain numéro de note de crédit à attribuer.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Notes de débit personnalisées";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Format de numérotation personnalisé des notes de débit";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "Format numérique des notes de débit. Si vous incluez des balises, le système les remplacera automatiquement.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Numérotation personnalisée des notes de débit";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Cochez cette case pour activer les formats de numérotation personnalisés pour les notes de débit.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Numéro de la note de débit suivante";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "Le numéro de note de débit suivant à attribuer.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Valider le format lors du paiement";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Ne pas valider (désactivé)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Valider auprès de l'autorité compétente";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Validez au moment du paiement et auprès de l'autorité compétente";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Mettre à jour automatiquement les règles de TVA";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Activez cette option pour activer la vérification automatique des règles de TVA mises à jour. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">En savoir plus</a>.";
...
$_ADMINLANG['userLogin']['createAccount'] = "Créer un compte";
...
$_ADMINLANG['validation']['password']['max'] = "Les mots de passe ne peuvent pas contenir plus de :max caractères.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Autoriser le suivi";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Refuser le suivi";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Aidez-nous à améliorer le WHMCS</strong><br /> Nous utilisons un suivi anonyme pour améliorer le WHMCS. Votre participation nous aide à rendre WHMCS plus intuitif et convivial. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">En savoir plus sur les données que nous collectons</a>.";
