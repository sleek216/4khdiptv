...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Ongeldige tekens verwijderen";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "Het systeem heeft ongeldige UTF-8-tekens van 4 bytes in de opgeslagen configuratiewaarden gedetecteerd en verwijderd.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Aanvullende feedback (optioneel)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Toon en lengte aanpassen";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI analyseert de context van het gesprek en stelt een persoonlijk antwoord op";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "AI-suggestie gegenereerd. Bekijk de suggestie voordat je deze in je antwoord invoegt.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "AI-suggestie ingevoegd. Controleer dit voordat u het verzendt.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "AI-suggestie";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Kon het ticketoverzicht niet extraheren. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Ik heb een ongeldige reactie ontvangen van de AI-service.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "De validatie van de licentie is mislukt. Controleer je inloggegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Het genereren van een AI-prompt is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Het opslaan van de AI-reactie is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "De AI-ondersteuningsdienst heeft een time-out gehad. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "De AI-ondersteuningsdienst is tijdelijk niet beschikbaar.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Authenticatie is mislukt. Controleer de inloggegevens van je AI Agent.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Kan geen verbinding maken met de AI-service. Controleer je netwerkverbinding en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "De bewerking van de database is mislukt. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Het ontsleutelen van gegevens is mislukt. Neem contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "De gegevensversleuteling is mislukt. Neem contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Er is een onverwachte fout opgetreden. Probeer het opnieuw of neem contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Onvoldoende kredietsaldo. Voeg credits toe aan je account en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Er is een interne fout opgetreden. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "De ingevoerde invoer is ongeldig. Controleer je gegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Ongeldig aanvraagformaat. Controleer je invoergegevens en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Verificatie van de handtekening aanvragen is mislukt. Controleer je licentiesleutel.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "De sterrenclassificatie moet tussen 1 en 5 liggen.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Ticketgegevens zijn ongeldig of onjuist.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "De trace-ID moet een geldig UUID-formaat hebben.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Knowledge Base-artikel niet gevonden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Deze licentie is al geregistreerd in het systeem.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Je AI-licentie is verlopen. Verleng alstublieft uw abonnement.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "De verstrekte licentie is ongeldig.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licentie niet gevonden. Controleer je configuratie en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Je AI-licentie is opgeschort. Neem contact op met de klantenservice.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "De API-sleutel van de AI-provider is ongeldig. Controleer je configuratie.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Geen relevante artikelen gevonden in de kennisbank voor dit ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "De AI-provider heeft een foutmelding geretourneerd. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "De snelheidslimiet van de AI-provider is overschreden. Probeer het over enkele ogenblikken opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Het systeem kon geen AI-respons genereren. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Het doorzoeken van de kennisbank met AI is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "De AI-provider is tijdelijk niet beschikbaar. Probeer het later opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Het duurde te lang voordat de AI-dienst reageerde. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Het vereiste gecodeerde gegevensveld ontbreekt.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "De inloggegevens van de OAuth-client zijn ongeldig.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "OAuth-token is ongeldig of ingetrokken.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "OAuth-token is verlopen. Authenticeer alstublieft opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Het ontsleutelen van de ticketgegevens is mislukt. Controleer de coderingssleutels.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "De verstrekte gegevens zijn ongeldig of beschadigd.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Het opschonen van gevoelige gegevens is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Er is een time-out opgetreden voor het opschonen van gegevens. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "De service voor het opschonen van gegevens is tijdelijk niet beschikbaar.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Je hebt je maandelijkse AI-tokenquotum overschreden. Gelieve je abonnement te upgraden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Te veel aanvragen. Probeer het over enkele ogenblikken opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "De gevraagde record is niet gevonden.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "De AI-service is tijdelijk niet beschikbaar. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Je hebt geen toestemming om toegang te krijgen tot dit ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Ticket niet gevonden in het systeem.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Validatie van de aanvraag is mislukt. Controleer je invoer en probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "De uitvoering van de AI-workflow is mislukt. Probeer het nog eens.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Annuleren";
$_ADMINLANG['aiSuggestions']['collapse'] = "Inklappen";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Alles samenvouwen";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Weet je zeker dat je je beoordeling wilt verwijderen?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Bevestig dat u de gezuiverde gegevens hebt bekeken en dat u klaar bent om AI-suggesties te genereren.";
$_ADMINLANG['aiSuggestions']['customer'] = "Klant";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Gegevens geladen en opgeschoond (%s -antwoorden). Bekijk en genereer suggesties.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Beoordeling verwijderen";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documenten gevonden";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "De inhoud van het bericht bewerken:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Beoordeling bewerken";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Dit bericht bewerken...";
$_ADMINLANG['aiSuggestions']['error'] = "Fout:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Kan geen AI-suggestie genereren. Probeer het later nog eens.";
$_ADMINLANG['aiSuggestions']['expand'] = "Uitbreiden";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Alles uitbreiden";
$_ADMINLANG['aiSuggestions']['generate'] = "Genereer";
$_ADMINLANG['aiSuggestions']['generating'] = "Genereren...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "AI-suggestie genereren...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "AI-suggestie genereren...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Genereren is mislukt: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Hoe was deze suggestie?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "In antwoord invoegen";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Ongeldige datum";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Ongeldig antwoord van het sanitize-eindpunt - ontbrekende verplichte velden";
$_ADMINLANG['aiSuggestions']['length'] = "Lengte";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Beknopt";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Gedetailleerd";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Ticketgegevens worden geladen...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "%s ontbreekt in de API-respons";
$_ADMINLANG['aiSuggestions']['networkError'] = "Netwerkfout";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Netwerkfout tijdens %s -bewerking: %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Geen AI-suggestie beschikbaar.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Voor dit antwoord zijn geen referentiedocumenten gebruikt.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Geen antwoordberichten gevonden.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Geen gezuiverde gegevens beschikbaar. Ticketgegevens opnieuw laden.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Geen onderwerp";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "%s -bewerking is mislukt";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Selecteer alstublieft een beoordeling";
$_ADMINLANG['aiSuggestions']['processing'] = "Even wachten...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "We verwerken uw aanvraag, even geduld a.u.b....";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Beoordeel AI-suggestie";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Beoordeling met succes verwijderd";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Uitstekend";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Beoordeling indienen is mislukt. Probeer het opnieuw.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Eerlijk";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Goed";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Matig";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Bedankt voor je feedback!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Heel goed";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Aanbevolen acties:";
$_ADMINLANG['aiSuggestions']['references'] = "Referenties";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "De volgende artikelen en documenten uit de kennisbank zijn gebruikt om dit antwoord te genereren:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenereren";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "U hebt het maximum aantal regeneraties bereikt (3). Gebruik alstublieft de huidige suggestie.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenereren...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Resterende regeneraties: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Gevoelige informatie verwijderen en inhoud voorbereiden voor AI-analyse";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Antwoord #%s reset.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Antwoordthread (%s -berichten)";
$_ADMINLANG['aiSuggestions']['reset'] = "Resetten";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Reactie succesvol gegenereerd";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Je AI-gegenereerde reactie is klaar";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Reactie geregenereerd met nieuwe parameters";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Gespreksgeschiedenis en ticketgegevens ophalen";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Bekijk Conversation voor AI-analyse";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Bekijk de gezuiverde ticketgegevens hieronder zorgvuldig. Zorg ervoor dat je alle gevoelige informatie hebt verwijderd of gemaskeerd voordat je AI-suggesties genereert.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Bekijk de gezuiverde gegevens voordat ze worden gegenereerd";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "De sanering is mislukt.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Ticketgegevens opschonen en laden...";
$_ADMINLANG['aiSuggestions']['staff'] = "Medewerkers";
$_ADMINLANG['aiSuggestions']['stars'] = "sterren";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Beoordeling verzenden";
$_ADMINLANG['aiSuggestions']['submitting'] = "Inzenden...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Voorgestelde reactie:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "Suggestie is mislukt.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Ondersteunend personeel";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Vertel ons meer over je ervaring...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Ticketanalyse:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Ticketgegevens niet beschikbaar";
$_ADMINLANG['aiSuggestions']['tone'] = "Toon";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formeel";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Vriendelijk";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Technisch";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Kan het antwoordvak niet vinden.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Onbekende datum";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Onbekende fout";
$_ADMINLANG['aiSuggestions']['youRated'] = "Je hebt dit beoordeeld:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Jouw feedback:";
...
$_ADMINLANG['billing']['creditnote'] = "Kredietnota";
$_ADMINLANG['billing']['debitnote'] = "Debetnota";
...
$_ADMINLANG['billing']['ledger'] = "Grootboek";
$_ADMINLANG['billing']['netIncome'] = "Netto-inkomen";
$_ADMINLANG['billing']['nocomments'] = "Er zijn geen klantgerichte opmerkingen voor dit document.";
$_ADMINLANG['billing']['offlinecc'] = "Credit Card transacties";
$_ADMINLANG['billing']['title'] = "Betalingen";
$_ADMINLANG['billing']['transaction'] = "Transactie";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Dit is een conceptkredietnota. De klant kan deze creditnota niet zien of openen totdat je op Uitgeven klikt.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Items op creditnota's";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Kredietnota beheren";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Kredietnotanummer";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Kredietnota bekijken";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Dit is een conceptdebetnota. De klant kan deze debetnota niet zien of openen totdat je op Uitgeven klikt.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Items voor debetnota's";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Debetnota beheren";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Nummer van de debetnota";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Debetnota bekijken";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "Het systeem kan het kenmerk \":attribute\" niet wijzigen op een factuurnota met de status \":status\".";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "Het systeem kan geen regelitem toevoegen aan een factuurnota die niet de conceptstatus heeft.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "Het systeem kan geen regelitem toewijzen of wijzigen op een factuurnota die niet de conceptstatus heeft (regelitem-ID: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "Het systeem kan de factuurnota's alleen wijzigen als ze de conceptstatus hebben.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Laatste aanmelding";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Gastheer";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Probeer het later nog eens.";
$_ADMINLANG['errorPage']['429']['title'] = "Tarieflimiet overschreden";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Je kunt dit item niet wijzigen.";
...
$_ADMINLANG['fields']['clientcredit'] = "Krediet voor klanten";
...
$_ADMINLANG['fields']['reference'] = "Referentie";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Voer de gewenste verhoging in tussen gegenereerde creditnotanummers (standaard:1, maximaal: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Verhoging van het kredietnotanummer";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Voer de gewenste verhoging in tussen de gegenereerde debetnotanummers (standaard:1, maximaal: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Verhoging van het nummer van de debetnota";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Automatisch verlengen uitschakelen en factuuritems annuleren voor dit domein?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Met deze actie worden de volgende factuuritems verwijderd: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "De waarde :inputLabel moet tussen 1 en 999 liggen.";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Wachtwoord opnieuw instellen (vereisen dat gebruikers een CAPTCHA voltooien na meerdere pogingen om het wachtwoord opnieuw in te stellen.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Bekijk het activiteitenlogboek voor meer informatie.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Kies de taal die je zult zien in het beheergedeelte.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Kies de taal die uw klanten te zien krijgen wanneer ze inloggen op de klantenzone.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Kies de taal die jij en je klanten standaard zien.";
...
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Lokalisatie";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Taal van het beheerdersgebied";
...
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Standaardtaal";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Selecteer je standaardtaal.";
...
$_ADMINLANG['global']['lastActive'] = "Laatst actief";
...
$_ADMINLANG['global']['manageMember'] = "Beheerder beheren";
...
$_ADMINLANG['global']['products'] = "Producten";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "De onveranderlijkheid van facturen is uitgeschakeld. We hebben de mogelijkheid om facturen te bewerken afgeschaft en we zullen de optie om de wijzigbaarheid van facturen mogelijk te maken in een toekomstige release verwijderen.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "U hebt uw systeem zodanig geconfigureerd dat het bewerken van facturen (wijzigbaarheid van facturen) mogelijk is voor niet-conceptfacturen. We hebben deze mogelijkheid in WHMCS 9.0 afgeschaft en zullen de configuratie die dit gedrag mogelijk maakt in een toekomstige release verwijderen.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Onveranderlijkheid van facturen";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "Er wordt gewerkt aan versleuteling van opslag met twee-factorenauthenticatie.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "De opslag voor tweefactorauthenticatie is veilig.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Opslag voor tweefactorauthenticatie";
...
$_ADMINLANG['healthCheck']['learnMore'] = "U kunt hierover meer lezen in onze documentatie.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "PHP-sessieopslag is niet schrijfbaar. Neem voor hulp contact op met de systeembeheerder. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Meer informatie.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Weet je zeker dat je deze factuur wilt annuleren? Terugkerende items op de factuur worden voor deze datum niet opnieuw gefactureerd.";
$_ADMINLANG['invoices']['cancelPayment'] = "Betaling annuleren";
$_ADMINLANG['invoices']['cancelTitle'] = "Factuur annuleren";
...
$_ADMINLANG['invoices']['delete'] = "Weet je zeker dat je deze factuur wilt verwijderen?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "Het systeem kan het kenmerk \":attribute\" niet wijzigen op een factuur met de status \":status\".";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "Het systeem kan geen regelitem aan een factuur toevoegen, tenzij deze de status Concept heeft.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "Het systeem kan geen regelitem op een factuur toewijzen of wijzigen, tenzij het de status Concept heeft (regelitem-ID: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "Het systeem kan facturen alleen wijzigen als ze de conceptstatus hebben.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "De onveranderlijkheid van facturen is uitgeschakeld. Je kunt ongeldige statuswijzigingen aanvragen op het tabblad 'Factuur beheren' &raquo; .";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "Het systeem kan een factuur alleen overzetten naar Geannuleerd vanaf de volgende statussen: Onbetaald, Betaling in behandeling of Incasso.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "Het systeem kan alleen een conceptfactuur verwijderen.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "Het systeem kan een factuur alleen overzetten naar Betaald via de volgende statussen: Onbetaald, Betaling in behandeling of Incasso.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "Het systeem kan alleen betalingen toepassen op een factuur met de status Onbetaald, Betaling in behandeling of Incasso.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "Het systeem kan alleen betalingen terugbetalen vanaf een factuur met de status Onbetaald, Betaling in behandeling, Betaald of Incasso.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Klik om een creditnota toe te passen voor het resterende saldo, selecteer Betaald en voer eventuele acties na betaling uit.";
...
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Dit is een geannuleerde factuur.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Alstublieft %s eerst toepassen aan een betaling";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Dit is een incassofactuur.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Dit is een conceptfactuur.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Je kunt een factuur die :statusis niet wijzigen.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Dit is een betaalde factuur.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Dit is een factuur in afwachting van betaling.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Deze factuur wordt terugbetaald.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Dit is een onbetaalde factuur.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Klik om de credit- of debetnota's te genereren en toe te passen die nodig zijn om de factuur over te zetten naar Geannuleerd.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Klik om een creditnota te genereren en toe te passen voor het resterende saldo en om de factuur over te zetten naar Betaald. Hiermee worden ook eventuele acties na betaling uitgevoerd.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "Het systeem heeft :successes van de :attempted facturen succesvol overgezet naar Geannuleerd.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "Het systeem heeft met succes :successes van de :attempted facturen verwijderd.";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "Het systeem heeft :successes van de :attempted facturen met succes overgezet naar betaald.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "Het systeem heeft :successes van de :attempted facturen succesvol overgezet naar Unpaid.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Weet u zeker dat u de geselecteerde facturen wilt verwijderen?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Uw selectie omvat niet-conceptfacturen. Het systeem zal deze facturen aanpassen omdat de onveranderlijkheid van facturen is uitgeschakeld.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "Het systeem kon een MarketConnect API-token niet ontcijferen. Controleer uw CC-coderingshash of verbreek de verbinding met uw WHMCS Marketplace-account en maak opnieuw verbinding.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Authenticatie is mislukt. Controleer uw WHMCS Marketplace-inloggegevens bij Configuratie <i class='far fa-wrench' aria-hidden='true'></i> > Systeeminstellingen > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Bied alle <b>:serviceName</b> producten aan.";
$_ADMINLANG['marketConnect']['gdprConsent'] = "Om u aan te melden bij WHMCS Marketplace, moeten WHMCS Ltd. en haar dochterondernemingen uw persoonlijke gegevens opslaan en verwerken in overeenstemming met het <a href=\"https://www.webpros.com/legal\">WebPros Privacybeleid</a>.";
$_ADMINLANG['marketConnect']['introModalTitle'] = "Welkom bij MarketConnect";
$_ADMINLANG['marketConnect']['lastUpdated'] = "Laatst bijgewerkt";
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "Over";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "WHMCS Ltd. en haar filialen in de WebPros-groep kunnen mij nieuws en individuele aanbiedingen over WebPros-producten verstrekken in overeenstemming met het <a href=\"https://www.webpros.com/legal\">WebPros-privacybeleid</a>. Ik kan deze toestemming intrekken door op de link te klikken in elke ontvangen communicatie.";
...
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Aanbevolen verkoopprijs";
$_ADMINLANG['marketConnect']['refresh'] = "Vernieuwen";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Verkoopstatus";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "Over ons";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Activeren";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Deactiveren";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Lees Meer";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Beheer";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Begin met verkopen";
...
$_ADMINLANG['mergefields']['configoptions'] = "Configuratie. Opties (array)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Configuratie. Opties (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Maak een lijst van krediet- en debetnota's";
$_ADMINLANG['permissions']['165'] = "Creditnota of debetnota aanmaken";
$_ADMINLANG['permissions']['166'] = "Creditnota of debetnota bekijken";
$_ADMINLANG['permissions']['167'] = "Creditnota of debetnota beheren";
$_ADMINLANG['permissions']['168'] = "Creditnota of debetnota verwijderen";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Vereiste toestemming ontbreekt.";
...
$_ADMINLANG['products']['productgroupicon'] = "Groepspictogram";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "bijv. een vetvast ventilatorhuis";
...
$_ADMINLANG['status']['issued'] = "Uitgegeven";
...
$_ADMINLANG['support']['aiAssisted'] = "AI-ondersteund";
$_ADMINLANG['support']['aiConfirmReview'] = "Controleer de gegevens";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Bevestig dat je de gezuiverde ticketgegevens hebt bekeken en klaar bent om AI-suggesties te genereren. Verwijder of maskeer alle gevoelige informatie.";
$_ADMINLANG['support']['aiContentRequired'] = "Inhoud is vereist";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Geen toestemming voor deze functie voor jouw rol";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Voer gezuiverde inhoud in";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Voer een gezuiverd onderwerp in";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Optionele feedback";
$_ADMINLANG['support']['aiGenerate'] = "Genereer";
$_ADMINLANG['support']['aiGenerateResponse'] = "AI-suggestie genereren";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Help ons de AI-reacties te verbeteren";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Hoe nuttig was deze reactie?";
$_ADMINLANG['support']['aiInitialMessage'] = "Eerste bericht";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Eerste bericht";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Onderwerp van het ticket";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Vertel ons hoe we deze suggestie kunnen verbeteren";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Creditcardnummers, wachtwoorden of gevoelige gegevens";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Namen, e-mails, telefoonnummers van klanten";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Bekijk en verwijder alle persoonlijk identificeerbare informatie (PII) voordat u AI-suggesties genereert:";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Privacyverklaring:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Persoonlijke adressen of privé-informatie";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Beoordeel deze suggestie";
$_ADMINLANG['support']['aiRatingFeedback'] = "Feedback geven";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Deel je positieve ervaring";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Hoe kunnen we verbeteren?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "We waarderen je feedback. Laat ons weten hoe we de AI-suggesties kunnen verbeteren.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "We zijn blij dat je dit nuttig vond! Vertel alstublieft waarom deze suggestie voor u effectief is geworden.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Het spijt ons dat deze suggestie niet aan je verwachtingen voldeed. Laat ons weten wat we beter kunnen doen.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Voer hier je feedback in...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Vertel wat dit nuttig maakte...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Vertel ons hoe we kunnen verbeteren...";
$_ADMINLANG['support']['aiReplyThread'] = "Discussie beantwoorden";
$_ADMINLANG['support']['aiResponseGenerated'] = "AI-respons gegenereerd:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "Het systeem heeft een voorgestelde reactie gegenereerd. Je kunt het nu in je antwoord invoegen.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Conversatieanalyse bekijken";
$_ADMINLANG['support']['aiSubject'] = "Onderwerp van het ticket";
$_ADMINLANG['support']['aiSubjectRequired'] = "Onderwerp is verplicht";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Feedback verzenden";
$_ADMINLANG['support']['aiSuggestions'] = "AI-suggesties";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Bedankt voor je feedback!";
$_ADMINLANG['support']['aiTicketContent'] = "Inhoud van het ticket";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Er is een fout opgetreden bij het pinnen van het ticket.";
$_ADMINLANG['support']['pinTicket'] = "Pinticket";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Fout bij opslaan van de bijlage: de doelmap is niet schrijfbaar.</br>Controleer de machtigingen voor je mappen.";
...
$_ADMINLANG['support']['ticketemailerror'] = "U moet een bestaande klant opgeven of het e-mailadres van de ontvanger handmatig invoeren.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Je moet de naam invoeren van de persoon voor wie je dit ticket aanmaakt of een bestaande klant specificeren.";
...
$_ADMINLANG['support']['unpinTicket'] = "Ticket loskoppelen";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "U moet Captcha voor aanmeldingsformulieren uitschakelen in <a href='configgeneral.php#tab=10'>Beveiligingsinstellingen</a> om de integratiecode te kunnen gebruiken";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "U moet Captcha voor Domain Checker uitschakelen in <a href='configgeneral.php#tab=10'>Beveiligingsinstellingen</a> om de integratiecode te kunnen gebruiken";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Hiermee kunt u het kredietnummer automatisch periodiek opnieuw instellen.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Kredietnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Nummeringsformaat voor creditnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "Het nummerformaat van de creditnota's. Als u tags toevoegt, zal het systeem deze automatisch vervangen.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Nummering van kredietnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Vink aan om aangepaste nummeringsformaten voor creditnota's in te schakelen.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Nummer van de volgende creditnota";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "Het volgende creditnotanummer dat moet worden toegewezen.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Debetnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Nummeringsformaat voor debetnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "Het nummerformaat van de debetnota's. Als u tags toevoegt, zal het systeem deze automatisch vervangen.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Nummering van debetnota's op maat";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Vink aan om aangepaste nummeringsformaten voor debetnota's in te schakelen.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Nummer van de volgende debetnota";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "Het volgende debetnotanummer dat moet worden toegewezen.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Formaat valideren tijdens het afrekenen";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Niet valideren (uitgeschakeld)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Valideer bij de relevante autoriteit";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Valideer bij het afrekenen en bij de relevante autoriteit";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "BTW-regels automatisch bijwerken";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Schakel deze optie in om automatische controles op bijgewerkte btw-regels in te schakelen. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Meer informatie</a>.";
...
$_ADMINLANG['userLogin']['createAccount'] = "Account aanmaken";
...
$_ADMINLANG['validation']['password']['max'] = "Wachtwoorden mogen niet meer dan :max tekens bevatten.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Tracking toestaan";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Tracking weigeren";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Help ons om WHMCS te verbeteren</strong><br /> We gebruiken geanonimiseerde tracking om WHMCS te verbeteren. Uw deelname helpt ons om WHMCS intuïtiever en gebruiksvriendelijker te maken. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Lees meer over de gegevens die we verzamelen</a>.";
