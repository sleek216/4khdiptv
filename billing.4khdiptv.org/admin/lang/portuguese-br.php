...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Remoção de personagem inválida";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "O sistema detectou e removeu caracteres UTF-8 inválidos de 4 bytes nos valores de configuração salvos.";
...
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Ajuste o tom e o comprimento";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "A IA está analisando o contexto da conversa e criando uma resposta personalizada";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Sugestão de IA gerada. Analise a sugestão antes de inseri-la em sua resposta.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Sugestão de IA inserida. Revise antes de enviar.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Sugestão de IA";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Falha ao extrair o resumo do ticket. Tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Recebeu uma resposta inválida do serviço de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Falha na validação da licença. Verifique suas credenciais e tente novamente.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Falha na autenticação. Verifique suas credenciais de agente de IA.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Não é possível se conectar ao serviço de IA. Verifique sua conexão de rede e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Falha na operação do banco de dados. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Falha ao descriptografar os dados. Entre em contato com o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Falha na criptografia de dados. Entre em contato com o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Ocorreu um erro inesperado. Tente novamente ou entre em contato com o suporte.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "A entrada fornecida é inválida. Verifique seus dados e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Formato de solicitação inválido. Verifique seus dados de entrada e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Falha na verificação da assinatura da solicitação. Verifique sua chave de licença.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "A classificação por estrelas deve estar entre 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Os dados do tíquete são inválidos ou estão malformados.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "O ID de rastreamento deve ter um formato UUID válido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Artigo da base de conhecimento não encontrado.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Essa licença já está registrada no sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Sua licença de IA expirou. Por favor, renove sua assinatura.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "A licença fornecida é inválida.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licença não encontrada. Verifique sua configuração e tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Sua licença de IA foi suspensa. Entre em contato com o suporte.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "A chave da API do provedor de IA é inválida. Verifique sua configuração.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Nenhum artigo relevante foi encontrado na base de conhecimento para esse ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "O provedor de IA retornou um erro. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "O limite de taxa do provedor de IA foi excedido. Tente novamente em alguns instantes.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "O provedor de IA está temporariamente indisponível. Por favor, tente novamente mais tarde.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "O serviço de IA demorou muito para responder. Por favor, tente novamente.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Falta o campo de dados criptografado obrigatório.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Falha ao descriptografar os dados do ticket. Verifique as chaves de criptografia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Os dados fornecidos são inválidos ou estão corrompidos.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Falha ao limpar dados confidenciais. Por favor, tente novamente.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "O serviço de limpeza de dados está temporariamente indisponível.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Você excedeu sua cota mensal de tokens de IA. Atualize seu plano.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Muitos pedidos. Tente novamente em alguns instantes.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "O registro solicitado não foi encontrado.";
...
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Você não tem permissão para acessar esse ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Bilhete não encontrado no sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Falha na validação da solicitação. Verifique sua entrada e tente novamente.";
...
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Tem certeza de que deseja excluir sua avaliação?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Confirme se você revisou os dados higienizados e está pronto para gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Dados carregados e higienizados (respostas%s ). Analise e gere sugestões.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Excluir classificação";
...
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Edite esta mensagem...";
$_ADMINLANG['aiSuggestions']['error'] = "Erro:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Não é possível gerar uma sugestão de IA. Tente novamente mais tarde.";
...
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Como foi essa sugestão?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserir na resposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Data inválida";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Resposta inválida do endpoint de higienização - campos obrigatórios ausentes";
...
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Carregando dados do tíquete...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "%s ausente na resposta da API";
...
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Nenhum documento de referência foi usado para essa resposta.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Nenhuma mensagem de resposta foi encontrada.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Não há dados higienizados disponíveis. Recarregue os dados do tíquete.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Sem assunto";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "Falha na operação %s";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Selecione a classificação";
$_ADMINLANG['aiSuggestions']['processing'] = "Processando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Processando sua solicitação, aguarde...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Classifique a sugestão de IA";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Classificação excluída com sucesso";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Boa";
...
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Boa";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Ruim";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Obrigado pelo seu feedback!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Muito bom";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Ações recomendadas:";
$_ADMINLANG['aiSuggestions']['references'] = "Referências";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Os seguintes artigos e documentos da base de conhecimento foram usados para gerar essa resposta:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerar";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Você atingiu o número máximo de regenerações (3). Use a sugestão atual.";
...
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Removendo informações confidenciais e preparando conteúdo para análise de IA";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Resposta #%s reset.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Tópico de resposta (mensagens%s )";
$_ADMINLANG['aiSuggestions']['reset'] = "Redefinir";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Resposta gerada com sucesso";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Sua resposta gerada pela IA está pronta";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Resposta regenerada com novos parâmetros";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Recuperando o histórico de conversas e os detalhes do ticket";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Revise a conversa para análise de IA";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Analise cuidadosamente os dados higienizados do tíquete abaixo. Certifique-se de ter removido ou mascarado todas as informações confidenciais antes de gerar sugestões de IA.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Revise os dados higienizados antes de gerá-los";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "A higienização falhou.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Higienizando e carregando dados de tíquetes...";
$_ADMINLANG['aiSuggestions']['staff'] = "Operador";
$_ADMINLANG['aiSuggestions']['stars'] = "estrelas";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Enviar avaliação";
...
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Equipe de suporte";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Conte-nos mais sobre sua experiência...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Análise de tíquetes:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Os dados do bilhete não estão disponíveis";
...
$_ADMINLANG['aiSuggestions']['youRated'] = "Você avaliou isso:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Seu feedback:";
...
$_ADMINLANG['billing']['ledger'] = "Livro contábil";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Este é um rascunho de nota de crédito. O cliente não pode ver nem acessar essa nota de crédito até que você clique em Emitir.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Itens de notas de crédito";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Gerenciar nota de crédito";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Número da nota de crédito";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Exibir nota de crédito";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Este é um rascunho de nota de débito. O cliente não pode ver nem acessar essa nota de débito até que você clique em Emitir.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Itens de nota de débito";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Gerenciar nota de débito";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Número da nota de débito";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Exibir nota de débito";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "O sistema não pode modificar o atributo \":attribute\" em uma nota de cobrança que esteja no status \":status”.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "O sistema não pode adicionar um item de linha a uma nota de cobrança que não esteja no status Rascunho.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "O sistema não pode atribuir ou modificar um item de linha em uma nota de cobrança que não esteja no status Rascunho (ID do item de linha: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "O sistema só pode modificar as notas de cobrança enquanto elas estiverem no status Rascunho.";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Você não pode modificar esse item.";
...
$_ADMINLANG['fields']['clientcredit'] = "Crédito do cliente";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Insira o incremento desejado entre os números das notas de crédito geradas (Padrão:1, Máximo: 999).";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Insira o incremento desejado entre os números das notas de débito geradas (Padrão:1, Máximo: 999).";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Desativar a renovação automática e cancelar itens de fatura para este domínio?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Essa ação excluirá os seguintes itens da fatura: <br>%s";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Redefinição de senha (Exija que os usuários concluam um CAPTCHA após várias tentativas de redefinição de senha.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Consulte o Registro de atividades para obter mais detalhes.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Escolha o idioma que você verá na área administrativa.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Escolha o idioma que seus clientes verão quando fizerem login na Área do Cliente.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Escolha o idioma que você e seus clientes veem por padrão.";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Idioma da área administrativa";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Selecione seu idioma padrão.";
...
$_ADMINLANG['global']['lastActive'] = "Ativo pela última vez";
...
$_ADMINLANG['global']['manageMember'] = "Gerenciar administrador";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "A imutabilidade da fatura está desativada. Descontinuamos a capacidade de editar faturas e removeremos a opção de ativar a mutabilidade de faturas em uma versão futura.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Você configurou seu sistema para permitir a edição de faturas (mutabilidade da fatura) para faturas que não sejam rascunhos. Descontinuamos essa capacidade no WHMCS 9.0 e removeremos a configuração que permite esse comportamento em uma versão futura.";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "A criptografia de armazenamento com autenticação de dois fatores está em andamento.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "O armazenamento com autenticação de dois fatores é seguro.";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Você pode aprender mais sobre isso em nossa documentação.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "O armazenamento de sessões PHP não é gravável. Para obter ajuda, entre em contato com o administrador do sistema. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Saiba mais.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Tem certeza de que deseja cancelar essa fatura? Os itens recorrentes na fatura não serão faturados novamente nessa data.";
...
$_ADMINLANG['invoices']['delete'] = "Tem certeza de que deseja excluir essa fatura?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "O sistema não pode modificar o atributo \":attribute\" em uma fatura com o status \":status”.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "O sistema não pode adicionar um item de linha a uma fatura, a menos que esteja no status Rascunho.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "O sistema não pode atribuir ou modificar um item de linha em uma fatura, a menos que esteja no status Rascunho (ID do item de linha: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "O sistema só pode modificar as faturas enquanto elas estiverem no status Rascunho.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "A imutabilidade da fatura está desativada. Você pode solicitar alterações de status inválidas na guia Opções de Gerenciar fatura &raquo; .";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "O sistema só pode fazer a transição de uma fatura para Cancelada a partir dos seguintes status: Não paga, Pagamento pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "O sistema só pode excluir um rascunho de fatura.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "O sistema só pode fazer a transição de uma fatura para Paga a partir dos seguintes status: Não paga, Pagamento pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "O sistema só pode aplicar pagamentos a uma fatura no status Não pago, Pagamento pendente ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "O sistema só pode reembolsar pagamentos de uma fatura no status Não pago, Pagamento pendente, Pago ou Cobranças.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Clique para aplicar uma nota de crédito ao saldo restante, marcar Pago e executar qualquer ação pós-pagamento.";
...
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Esta é uma fatura de cobrança.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Isto é um rascunho de fatura.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Você não pode modificar uma fatura que seja :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Esta é uma fatura paga.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Esta é uma fatura de pagamento pendente.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Essa fatura é reembolsada.";
...
$_ADMINLANG['invoices']['markPaidDesc'] = "Clique para gerar e aplicar uma nota de crédito para o saldo restante e fazer a transição da fatura para Paga. Isso também executará todas as ações de pós-pagamento.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "O sistema fez a transição bem-sucedida das faturas :successes de :attempted para Canceladas.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "O sistema excluiu com êxito as faturas :successes de :attempted .";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "O sistema fez a transição bem-sucedida das faturas :successes de :attempted para pagas.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "O sistema fez a transição bem-sucedida das faturas :successes de :attempted para Não pagas.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Tem certeza de que deseja excluir as faturas selecionadas?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Sua seleção inclui faturas que não são rascunhos. O sistema modificará essas faturas porque a imutabilidade da fatura está desativada.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "O sistema falhou ao descriptografar um token da API MarketConnect. Verifique seu hash de criptografia CC ou desconecte e reconecte sua conta WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Falha na autenticação. Verifique suas credenciais do WHMCS Marketplace em Configuração <i class='far fa-wrench' aria-hidden='true'></i> > Configurações do sistema > MarketConnect.";
...
$_ADMINLANG['marketConnect']['gdprConsent'] = "Para se inscrever no WHMCS Marketplace, a WHMCS Ltd. e suas afiliadas precisam armazenar e processar seus dados pessoais de acordo com a Política de Privacidade <a href=\"https://www.webpros.com/legal\">WebPros</a>.";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "A WHMCS Ltd. e suas afiliadas no grupo WebPros podem me fornecer notícias e ofertas individuais sobre os produtos WebPros de acordo com a Política de Privacidade <a href=\"https://www.webpros.com/legal\">da WebPros</a>. Posso revogar esse consentimento clicando no link em qualquer comunicação recebida.";
...
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Saiba mais";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Gerenciar";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Comece a vender";
...
$_ADMINLANG['mergefields']['configoptions'] = "Configuração. Opções (matriz)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Configuração. Opções (HTML)";
...
$_ADMINLANG['permissions']['166'] = "Exibir nota de crédito ou débito";
$_ADMINLANG['permissions']['167'] = "Gerenciar nota de crédito ou débito";
$_ADMINLANG['permissions']['168'] = "Excluir nota de crédito ou débito";
...
$_ADMINLANG['products']['productgroupicon'] = "Ícone do grupo";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "por exemplo, fa-solid fa-house";
...
$_ADMINLANG['support']['aiConfirmReview'] = "Confirme a análise de dados";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Confirme se você revisou os dados higienizados do ticket e está pronto para gerar sugestões de IA. Remova ou mascare todas as informações confidenciais.";
$_ADMINLANG['support']['aiContentRequired'] = "O conteúdo é obrigatório";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Não há permissão para esse recurso para sua função";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Insira conteúdo higienizado";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Insira o assunto higienizado";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Feedback opcional";
$_ADMINLANG['support']['aiGenerate'] = "Gerar";
$_ADMINLANG['support']['aiGenerateResponse'] = "Gere sugestão de IA";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Ajude-nos a melhorar as respostas de IA";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Quão útil foi essa resposta?";
...
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Conte-nos como podemos melhorar essa sugestão";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Números de cartão de crédito, senhas ou dados confidenciais";
...
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Avalie esta sugestão";
$_ADMINLANG['support']['aiRatingFeedback'] = "Forneça feedback";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Compartilhe sua experiência positiva";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Como podemos melhorar?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Agradecemos seu feedback. Informe-nos como podemos melhorar as sugestões de IA.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "Estamos felizes que você tenha achado isso útil! Compartilhe o que tornou essa sugestão eficaz para você.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Lamentamos que essa sugestão não tenha atendido às suas expectativas. Por favor, deixe-nos saber o que podemos fazer melhor.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Insira seus comentários aqui...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Compartilhe o que tornou isso útil...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Conte-nos como podemos melhorar...";
$_ADMINLANG['support']['aiReplyThread'] = "Tópico de resposta";
$_ADMINLANG['support']['aiResponseGenerated'] = "Resposta de IA gerada:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "O sistema gerou uma resposta sugerida. Agora você pode inseri-lo em sua resposta.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Revise a análise da conversa";
$_ADMINLANG['support']['aiSubject'] = "Assunto do bilhete";
$_ADMINLANG['support']['aiSubjectRequired'] = "O assunto é obrigatório";
...
$_ADMINLANG['support']['aiTicketContent'] = "Conteúdo do ingresso";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Ocorreu um erro ao tentar fixar o tíquete.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Você deve especificar um cliente existente ou inserir o endereço de e-mail do destinatário manualmente.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Você deve inserir o nome da pessoa para quem você está criando esse ticket ou especificar um cliente existente.";
...
$_ADMINLANG['support']['unpinTicket'] = "Bilhete Unpin";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "Você deve desativar o Captcha para formulários de login em <a href='configgeneral.php#tab=10'>Configurações de segurança</a> para usar o Código de Integração";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "Você deve desativar o Captcha para o Domain Checker em <a href='configgeneral.php#tab=10'>Configurações de segurança</a> para usar o Código de Integração";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Permite que você redefina automaticamente o número de crédito periodicamente.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Formato personalizado de numeração de notas de crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "O formato do número das notas de crédito. Se você incluir tags, o sistema as substituirá automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Numeração personalizada de notas de crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Marque para ativar formatos de numeração personalizados para notas de crédito.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Número da próxima nota de crédito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "O próximo número da nota de crédito a ser atribuído.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Notas de débito personalizadas";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Formato personalizado de numeração de notas de débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "O formato do número das notas de débito. Se você incluir tags, o sistema as substituirá automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Numeração personalizada de notas de débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Marque para ativar formatos de numeração personalizados para notas de débito.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Número da próxima nota de débito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "O próximo número da nota de débito a ser atribuído.";
...
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Não validar (desativado)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Valide com a autoridade relevante";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Valide na finalização da compra e com a autoridade relevante";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Atualizar automaticamente as regras de IVA";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Ative a opção para ativar as verificações automáticas das regras de IVA atualizadas. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Saiba mais</a>.";
...
$_ADMINLANG['validation']['password']['max'] = "As senhas não podem conter mais de :max caracteres.";
...
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Ajude-nos a aprimorar o WHMCS</strong><br /> Usamos rastreamento anônimo para melhorar o WHMCS. Sua participação nos ajuda a tornar o WHMCS mais intuitivo e fácil de usar. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Saiba mais sobre os dados que coletamos</a>.";
