...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Odstranění neplatných znaků";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "Systém detekoval a odstranil neplatné 4-bajtové znaky UTF-8 v uložených hodnotách konfigurace.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Další zpětná vazba (volitelné)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Upravte tón a délku";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI analyzuje kontext konverzace a vytváří personalizovanou odpověď";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Generován návrh AI. Před vložením do odpovědi si návrh přečtěte.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Návrh AI vložen. Zkontrolujte před odesláním.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Návrh AI";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Nepodařilo se extrahovat přehled lístků. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Obdržela neplatnou odpověď od služby AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Ověření licence se nezdařilo. Zkontrolujte své přihlašovací údaje a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Nepodařilo se vygenerovat výzvu AI. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Nepodařilo se uložit odpověď AI. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "Časový limit služby podpory AI vypršel. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "Služba podpory AI je dočasně nedostupná.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Ověření se nezdařilo. Zkontrolujte své přihlašovací údaje agenta AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Nelze se připojit ke službě AI. Zkontrolujte připojení k síti a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Operace databáze se nezdařila. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Nepodařilo se dešifrovat data. Obraťte se prosím na podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Šifrování dat se nezdařilo. Obraťte se na podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Došlo k neočekávané chybě. Zkuste to znovu nebo kontaktujte podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Nedostatečný úvěrový zůstatek. Přidejte kredity na svůj účet a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Došlo k interní chybě. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "Zadaný vstup je neplatný. Zkontrolujte svá data a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Neplatný formát požadavku. Zkontrolujte vstupní data a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Ověření podpisu žádosti se nezdařilo. Zkontrolujte licenční klíč.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Hodnocení hvězdiček musí být mezi 1 a 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Údaje o vstupenkách jsou neplatné nebo chybné.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "ID trasování musí mít platný formát UUID.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Článek znalostní báze nebyl nalezen.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Tato licence je již registrována v systému.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Platnost vaší licence AI vypršela. Obnovte prosím své předplatné.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "Poskytnutá licence je neplatná.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licence nebyla nalezena. Zkontrolujte konfiguraci a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Vaše licence na umělou inteligenci byla pozastavena. Obraťte se prosím na podporu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "Klíč API poskytovatele AI je neplatný. Zkontrolujte konfiguraci.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Ve znalostní databázi pro tento lístek nebyly nalezeny žádné relevantní články.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "Poskytovatel AI vrátil chybu. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "Překročen limit sazby poskytovatele AI. Zkuste to znovu za pár okamžiků.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Systém nedokázal vygenerovat odpověď AI. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Nepodařilo se prohledat znalostní databázi pomocí AI. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "Poskytovatel AI je dočasně nedostupný. Zkuste to prosím znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Služba AI trvala příliš dlouho, než odpověděla. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Chybí povinné šifrované datové pole.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Pověření klienta OAuth jsou neplatná.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Token OAuth je neplatný nebo byl zrušen.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Platnost tokenu OAuth vypršela. Ověřte prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Nepodařilo se dešifrovat data tiketu. Zkontrolujte šifrovací klíče.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "Poskytnuté údaje jsou neplatné nebo poškozené.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Nepodařilo se odstranit citlivá data. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Vypršel časový limit pro sanitaci dat. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "Služba sanitace dat je dočasně nedostupná.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Překročili jste měsíční kvótu tokenů AI. Upgradujte prosím svůj plán.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Příliš mnoho žádostí. Zkuste to znovu za pár okamžiků.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Požadovaný záznam nebyl nalezen.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "Služba AI je dočasně nedostupná. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Nemáte oprávnění k přístupu k této vstupence.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Vstupenka nebyla nalezena v systému.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Ověření požadavku se nezdařilo. Zkontrolujte svůj vstup a zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Spuštění pracovního postupu AI se nezdařilo. Zkuste to znovu.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Zrušit";
$_ADMINLANG['aiSuggestions']['collapse'] = "Sbalit";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Sbalit vše";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Opravdu chcete smazat své hodnocení?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Potvrďte, že jste zkontrolovali dezinfikovaná data a jste připraveni generovat návrhy umělé inteligence.";
$_ADMINLANG['aiSuggestions']['customer'] = "Zákazník";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Data byla načtena a dezinfikována (%s odpovědí). Zkontrolujte a generujte návrhy.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Odstranit hodnocení";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "nalezené dokumenty";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Upravit obsah zprávy:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Upravit hodnocení";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Upravit tuto zprávu...";
$_ADMINLANG['aiSuggestions']['error'] = "Chyba:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Nelze vygenerovat návrh AI. Zkuste to znovu později.";
$_ADMINLANG['aiSuggestions']['expand'] = "Rozbalit";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Rozbalit vše";
$_ADMINLANG['aiSuggestions']['generate'] = "Generovat";
$_ADMINLANG['aiSuggestions']['generating'] = "Generování...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generování návrhu AI...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generování návrhu AI...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Generování se nezdařilo: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Jaký byl tento návrh?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Vložit do odpovědi";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Neplatné datum";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Neplatná odpověď z koncového bodu sanitize - chybí povinná pole";
$_ADMINLANG['aiSuggestions']['length'] = "Délka";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Stručný";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Detailní";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Načítání údajů o lístku...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Chybí %s v odpovědi API";
$_ADMINLANG['aiSuggestions']['networkError'] = "Chyba sítě";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Chyba sítě během operace %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Není k dispozici žádný návrh AI.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Pro tuto odpověď nebyly použity žádné referenční dokumenty.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Nebyly nalezeny žádné odpovědi.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Nejsou k dispozici žádná dezinfikovaná data. Znovu načíst data tiketu.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Žádný předmět";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "Operace %s se nezdařila";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Vyberte prosím hodnocení";
$_ADMINLANG['aiSuggestions']['processing'] = "Zpracování...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Zpracováváme váš požadavek, počkejte prosím...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Ohodnoťte návrh AI";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Hodnocení bylo úspěšně smazáno";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Skvělé";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Nepodařilo se odeslat hodnocení. Zkuste to prosím znovu.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Spravedlivý";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Dobré";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Špatné";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Děkujeme za vaši zpětnou vazbu!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Velmi dobrý";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Doporučené akce:";
$_ADMINLANG['aiSuggestions']['references'] = "Reference";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "K vygenerování této odpovědi byly použity následující články a dokumenty znalostní báze:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerovat";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Dosáhli jste maximálního počtu regenerací (3). Použijte prosím aktuální návrh.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerační...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Zbývající regenerace: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Odstranění citlivých informací a příprava obsahu pro analýzu AI";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Odpověď #%s resetovat.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Odpovědět na vlákno (%s messages)";
$_ADMINLANG['aiSuggestions']['reset'] = "Obnovit";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Odpověď byla úspěšně generována";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Vaše reakce generovaná umělou inteligencí je připravena";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Regenerace odezvy s novými parametry";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Načítání historie konverzací a podrobností o lístku";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Recenze konverzace pro analýzu AI";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Pečlivě zkontrolujte níže uvedená dezinfikovaná data vstupenek. Před generováním návrhů AI se ujistěte, že jste odstranili nebo maskovali všechny citlivé informace.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Kontrola vyčištěných dat před generováním";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Sanitizace se nezdařila.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Sanitace a načítání údajů o lístcích...";
$_ADMINLANG['aiSuggestions']['staff'] = "Zaměstnanci";
$_ADMINLANG['aiSuggestions']['stars'] = "hvězdy";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Odeslat hodnocení";
$_ADMINLANG['aiSuggestions']['submitting'] = "Odesíláme...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Navrhovaná odpověď:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "Návrh se nezdařil.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Podpůrný personál";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Řekněte nám více o svých zkušenostech...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Analýza vstupenek:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Údaje o vstupenkách nejsou k dispozici";
$_ADMINLANG['aiSuggestions']['tone'] = "Tón";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formální";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Přátelský";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Technické";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Nelze najít pole odpovědi.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Neznámé datum";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Neznámá chyba";
$_ADMINLANG['aiSuggestions']['youRated'] = "Ohodnotili jste toto:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Vaše zpětná vazba:";
...
$_ADMINLANG['billing']['creditnote'] = "Úvěrová poznámka";
$_ADMINLANG['billing']['debitnote'] = "Debetní poznámka";
...
$_ADMINLANG['billing']['ledger'] = "Zápisník";
$_ADMINLANG['billing']['netIncome'] = "Čistý zisk";
$_ADMINLANG['billing']['nocomments'] = "K tomuto dokumentu nejsou žádné komentáře orientované na klienta.";
$_ADMINLANG['billing']['offlinecc'] = "Offline Zpracování CC";
$_ADMINLANG['billing']['title'] = "Fakturace";
$_ADMINLANG['billing']['transaction'] = "Transakce";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Toto je návrh dobropisu. Klient nemůže tento dobropis vidět ani získat přístup, dokud nekliknete na tlačítko Vydat.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Položky dobropisu";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Správa dobropisu";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Číslo dobropisu";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Zobrazit dobropis";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Toto je návrh debetní poznámky. Klient nemůže tuto debetní poznámku vidět ani získat přístup, dokud nekliknete na tlačítko Vydat.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Položky debetních poznámek";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Správa debetní poznámky";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Číslo debetní poznámky";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Zobrazit debetní poznámku";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "Systém nemůže změnit atribut \":attribute\" na fakturační poznámce, která je ve stavu „:status“.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "Systém nemůže přidat řádkovou položku do fakturační poznámky, která není ve stavu Koncept.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "Systém nemůže přiřadit ani upravit řádkovou položku fakturační poznámky, která není ve stavu Koncept (ID položky řádku: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "Systém může měnit fakturační poznámky pouze v době, kdy jsou ve stavu Koncept.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Poslední Přihlášení";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Hostitel";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Zkuste to znovu později.";
$_ADMINLANG['errorPage']['429']['title'] = "Překročení limitu sazeb";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Tuto položku nelze upravit.";
...
$_ADMINLANG['fields']['clientcredit'] = "Klientský kredit";
...
$_ADMINLANG['fields']['reference'] = "Odkaz";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Zadejte požadovaný přírůstek mezi vygenerovanými čísly dobropisů (výchozí:1, maximum: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Inkrementace čísla dobropisu";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Zadejte požadovaný přírůstek mezi vygenerovanými čísly debetních poznámek (výchozí:1, maximum: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Inkrementace čísla debetní poznámky";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Zakázat automatické obnovení a zrušení položek faktury pro tuto doménu?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Tato akce odstraní následující položky faktury: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "Hodnota :inputLabel musí být mezi 1 a 999.";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Obnovení hesla (po několika pokusech o obnovení hesla vyžaduje, aby uživatelé dokončili CAPTCHA.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Další podrobnosti najdete v protokolu aktivit.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Vyberte jazyk, který uvidíte v administrátorské oblasti.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Vyberte jazyk, který vaši klienti uvidí, když se přihlásí do klientské oblasti.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Vyberte jazyk, který vy a vaši klienti vidíte ve výchozím nastavení.";
...
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Lokalizace";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Jazyk administrativní oblasti";
...
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Výchozí jazyk";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Vyberte výchozí jazyk.";
...
$_ADMINLANG['global']['lastActive'] = "Naposledy aktivní";
...
$_ADMINLANG['global']['manageMember'] = "Správa administrátora";
...
$_ADMINLANG['global']['products'] = "Výrobky";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "Nezměnitelnost faktury je zakázána. Zastarali jsme možnost upravovat faktury a odebereme možnost povolit proměnlivost faktur v budoucím vydání.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Systém jste nakonfigurovali tak, aby umožňoval úpravy faktur (proměnlivost faktury) pro faktury bez návrhu. Tuto schopnost jsme v WHMCS 9.0 zastarali a v budoucí verzi odstraníme konfiguraci, která toto chování umožňuje.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Nezměnitelnost faktury";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "Probíhá šifrování úložiště dvoufaktorového ověřování.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "Úložiště dvoufaktorového ověřování je bezpečné.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Dvoufaktorové úložiště ověřování";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Více se o tom dozvíte v naší dokumentaci.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "Úložiště relací PHP není zapisovatelné. Chcete-li získat pomoc, obraťte se na správce systému. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Další informace.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Opravdu chcete tuto fakturu zrušit? Opakující se položky na faktuře nebudou pro toto datum znovu fakturovány.";
$_ADMINLANG['invoices']['cancelPayment'] = "Zrušit platbu";
$_ADMINLANG['invoices']['cancelTitle'] = "Zrušit fakturu";
...
$_ADMINLANG['invoices']['delete'] = "Opravdu chcete tuto fakturu smazat?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "Systém nemůže změnit atribut \":attribute\" na faktuře, která je ve stavu „:status“.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "Systém nemůže přidat řádkovou položku na fakturu, pokud není ve stavu Koncept.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "Systém nemůže přiřadit ani upravit řádkovou položku na faktuře, pokud není ve stavu Koncept (ID položky řádku: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "Systém může měnit faktury pouze v době, kdy jsou ve stavu Koncept.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "Nezměnitelnost faktury je zakázána. Na kartě Možnosti správy faktury &raquo; můžete požádat o neplatné změny stavu.";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "Systém může převést fakturu na Zrušeno pouze z následujících stavů: Nezaplaceno, Čeká na platbu nebo Inkaso.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "Systém může smazat pouze návrh faktury.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "Systém může převést fakturu na Zaplaceno pouze z následujících stavů: Nezaplaceno, Čeká na platbu nebo Inkaso.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "Systém může použít platby pouze na fakturu ve stavu Nezaplaceno, Čeká na platbu nebo Inkaso.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "Systém může vracet platby pouze z faktury ve stavu Nezaplaceno, Čeká na platbu, Vyplaceno nebo Inkaso.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Kliknutím použijete dobropis na zbývající zůstatek, označte možnost Zaplaceno a provedete jakékoli akce po zaplacení.";
$_ADMINLANG['invoices']['invoiceCreditResult'] = "Tyto transakce vedly k tomu, že byl uživateli poskytnut kredit ve výši ";
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Toto je zrušená faktura.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Pro uplatnění platby prosím nejprve %s";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Toto je inkasní faktura.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Toto je návrh faktury.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Fakturu, která je :status, nelze změnit.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Jedná se o placenou fakturu.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Toto je faktura čekající na platbu.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Tato faktura je vrácena.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Jedná se o nezaplacenou fakturu.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Kliknutím vygenerujete a použijete kreditní nebo debetní poznámky potřebné k přechodu faktury na Zrušeno.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Kliknutím vygenerujete a použijete dobropis pro zbývající zůstatek a převedete fakturu na Zaplaceno. Tím se také provedou jakékoli akce po zaplacení.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "Systém úspěšně převedl :successes z :attempted faktur na Zrušeno.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "Systém úspěšně odstranil :successes z :attempted faktur.";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "Systém úspěšně převedl :successes z :attempted faktur na zaplacené.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "Systém úspěšně převedl :successes z :attempted faktur na nezaplacené.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Opravdu chcete smazat vybrané faktury?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Váš výběr zahrnuje faktury bez návrhu. Systém tyto faktury upraví, protože neměnnost faktur je zakázána.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "Systém se nepodařilo dešifrovat token API MarketConnect. Zkontrolujte hash šifrování CC nebo odpojte a znovu připojte svůj účet WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Ověření se nezdařilo. Zkontrolujte své přihlašovací údaje WHMCS Marketplace na stránce Konfigurace <i class='far fa-wrench' aria-hidden='true'></i> > Nastavení systému > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Nabídka všech produktů <b>:serviceName</b> .";
$_ADMINLANG['marketConnect']['gdprConsent'] = "Chcete-li se zaregistrovat na WHMCS Marketplace, musí společnost WHMCS Ltd. a její přidružené společnosti ukládat a zpracovávat vaše osobní údaje v souladu se zásadami ochrany osobních údajů <a href=\"https://www.webpros.com/legal\">WebPros</a>.";
$_ADMINLANG['marketConnect']['introModalTitle'] = "Vítejte v MarketConnect";
$_ADMINLANG['marketConnect']['lastUpdated'] = "Updated";
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "O";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "Společnost WHMCS Ltd. a její přidružené společnosti ve skupině WebPros mi mohou poskytovat novinky a individuální nabídky týkající se produktů WebPros v souladu se zásadami ochrany osobních údajů <a href=\"https://www.webpros.com/legal\">WebPros</a>. Tento souhlas mohu odvolat kliknutím na odkaz v jakékoli přijaté komunikaci.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/měsíc";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/Měsíc";
$_ADMINLANG['marketConnect']['points'] = "Body";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Doporučená maloobchodní cena";
$_ADMINLANG['marketConnect']['refresh'] = "Obnovit";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Stav prodeje";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "O nás";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Aktivovat";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Deaktivovat";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Dozvědět se více";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Spravovat";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Začněte prodávat";
...
$_ADMINLANG['mergefields']['configoptions'] = "Konfigurace. Možnosti (pole)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Konfigurace. Možnosti (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Seznam kreditních a debetních poznámek";
$_ADMINLANG['permissions']['165'] = "Vytvoření kreditní nebo debetní poznámky";
$_ADMINLANG['permissions']['166'] = "Zobrazit kreditní nebo debetní poznámku";
$_ADMINLANG['permissions']['167'] = "Správa kreditní nebo debetní poznámky";
$_ADMINLANG['permissions']['168'] = "Smazat kreditní nebo debetní poznámku";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Chybí požadované povolení.";
...
$_ADMINLANG['products']['productgroupicon'] = "Skupinová ikona";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "např. fa-solid fa-house";
...
$_ADMINLANG['status']['issued'] = "Vydáno";
...
$_ADMINLANG['support']['aiAssisted'] = "S podporou umělé inteligence";
$_ADMINLANG['support']['aiConfirmReview'] = "Potvrdit kontrolu dat";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Potvrďte, že jste zkontrolovali dezinfikovaná data lístků a jste připraveni generovat návrhy umělé inteligence. Odstraňte nebo maskujte všechny citlivé informace.";
$_ADMINLANG['support']['aiContentRequired'] = "Obsah je vyžadován";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Žádné oprávnění k této funkci pro vaši roli";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Zadejte dezinfikovaný obsah";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Zadejte dezinfikovaný předmět";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Volitelná zpětná vazba";
$_ADMINLANG['support']['aiGenerate'] = "Generovat";
$_ADMINLANG['support']['aiGenerateResponse'] = "Generovat návrh AI";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Pomozte nám zlepšit reakce AI";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Jak užitečná byla tato odpověď?";
$_ADMINLANG['support']['aiInitialMessage'] = "Počáteční zpráva";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Počáteční zpráva";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Předmět vstupenky";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Řekněte nám, jak můžeme tento návrh vylepšit";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Čísla kreditních karet, hesla nebo citlivá data";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Jména zákazníků, e-maily, telefonní čísla";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Před generováním návrhů AI zkontrolujte a odstraňte veškeré osobní identifikovatelné informace (PII):";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Oznámení o ochraně osobních údajů:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Osobní adresy nebo soukromé informace";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Ohodnoťte tento návrh";
$_ADMINLANG['support']['aiRatingFeedback'] = "Poskytněte zpětnou vazbu";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Podělte se o své pozitivní zkušenosti";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Jak se můžeme zlepšit?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Vážíme si vaší zpětné vazby. Dejte nám prosím vědět, jak můžeme vylepšit návrhy AI.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "Jsme rádi, že vám to pomohlo! Podělte se prosím o to, co pro vás učinilo tento návrh účinným.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Je nám líto, že tento návrh nesplnil vaše očekávání. Dejte nám prosím vědět, co můžeme udělat lépe.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Zde zadejte svůj názor...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Podělte se o to, co to pomohlo...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Řekněte nám, jak se můžeme zlepšit...";
$_ADMINLANG['support']['aiReplyThread'] = "Odpovědět na vlákno";
$_ADMINLANG['support']['aiResponseGenerated'] = "Generovaná odpověď AI:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "Systém vygeneroval navrhovanou odpověď. Nyní jej můžete vložit do své odpovědi.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Zkontrolujte analýzu konverzace";
$_ADMINLANG['support']['aiSubject'] = "Předmět vstupenky";
$_ADMINLANG['support']['aiSubjectRequired'] = "Předmět je povinný";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Odeslat zpětnou vazbu";
$_ADMINLANG['support']['aiSuggestions'] = "Návrhy AI";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Děkujeme za vaši zpětnou vazbu!";
$_ADMINLANG['support']['aiTicketContent'] = "Obsah vstupenek";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Při pokusu o připnutí lístku došlo k chybě.";
$_ADMINLANG['support']['pinTicket'] = "Vstupenka na pin";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Chyba při ukládání přílohy: cílová složka není zapisovatelná.</br>Zkontrolujte oprávnění ke složce.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Musíte zadat existujícího klienta nebo zadat e-mailovou adresu příjemce ručně.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Musíte zadat jméno osoby, pro kterou vytváříte tento tiket, nebo zadat existujícího klienta.";
...
$_ADMINLANG['support']['unpinTicket'] = "Zrušit lístek";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "Chcete-li použít integrační kód, musíte deaktivovat Captcha pro přihlašovací formuláře v <a href='configgeneral.php#tab=10'>Security Settings</a>";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "Chcete-li použít integrační kód, musíte deaktivovat Captcha pro kontrolu domény v <a href='configgeneral.php#tab=10'>Security Settings</a>";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Umožňuje automaticky resetovat číslo kreditu pravidelně.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Vlastní kreditní poznámky";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Vlastní formát číslování dobropisů";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "Formát čísla dobropisů. Pokud zahrnete značky, systém je automaticky nahradí.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Vlastní číslování dobropisů";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Zaškrtnutím povolíte vlastní formáty číslování dobropisů.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Další číslo dobropisu";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "Další číslo dobropisu, které chcete přiřadit.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Vlastní debetní poznámky";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Vlastní formát číslování debetních poznámek";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "Formát čísla debetních poznámek. Pokud zahrnete značky, systém je automaticky nahradí.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Vlastní číslování debetních poznámek";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Zaškrtnutím povolíte vlastní formáty číslování pro debetní poznámky.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Další číslo debetní poznámky";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "Další číslo debetní poznámky k přiřazení.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Ověření formátu při placení";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Neověřovat (Zakázáno)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Ověřte u příslušného orgánu";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Ověřte při pokladně a s příslušnou autoritou";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Automatická aktualizace pravidel DPH";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Přepnutím povolíte automatické kontroly aktualizovaných pravidel DPH. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Další informace</a>.";
...
$_ADMINLANG['userLogin']['createAccount'] = "Vytvořit účet";
...
$_ADMINLANG['validation']['password']['max'] = "Hesla nesmí obsahovat více než :max znaků.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Povolit sledování";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Odepřít sledování";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Pomozte nám vylepšit WHMCS</strong><br /> Ke zlepšení WHMCS používáme anonymizované sledování. Vaše účast nám pomáhá učinit WHMCS intuitivnějším a uživatelsky přívětivějším. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Zjistěte více o údajích, které shromažďujeme</a>.";
