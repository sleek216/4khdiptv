...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Invalid Character Removal";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "The system detected and removed invalid 4-byte UTF-8 characters in the saved configuration values.";
...
$_ADMINLANG['administrators']['invitationSuccess'] = "Admin Invite Sent Successfully!";
$_ADMINLANG['administrators']['invitationSuccessInfo'] = "You successfully sent an invitation to the new admin.";
$_ADMINLANG['administrators']['inviteCancelConfirmation'] = "Are you sure you want to cancel this invite?";
$_ADMINLANG['administrators']['inviteCancelSuccess'] = "Admin Invite Cancelled Successfully!";
$_ADMINLANG['administrators']['inviteCancelSuccessInfo'] = "You successfully cancelled the invitation.";
$_ADMINLANG['administrators']['inviteResendConfirmation'] = "Are you sure you want to resend this invite?";
$_ADMINLANG['administrators']['inviteResendSuccessInfo'] = "You successfully resent the invitation.";
...
$_ADMINLANG['administrators']['pending'] = "Pending Invites";
$_ADMINLANG['administrators']['privatenotes'] = "Private Notes";
$_ADMINLANG['administrators']['pwconfirmerror'] = "You must confirm your password.";
...
$_ADMINLANG['administrators']['pwstrengthfail'] = "Your password is not strong enough. Stronger passwords are longer and include numbers, symbols, and lowercase and uppercase letters.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Additional Feedback (Optional)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Adjust Tone & Length";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "AI is analyzing the conversation context and crafting a personalized response";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "AI suggestion generated. Review the suggestion before inserting it into your reply.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "AI suggestion inserted. Review before sending.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "AI Suggestion";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Failed to extract the ticket digest. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Received an invalid response from the AI service.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "License validation failed. Check your credentials and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Failed to generate an AI prompt. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Failed to save the AI response. Try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "The AI support service timed out. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "The AI support service is temporarily unavailable.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Authentication failed. Check your AI Agent credentials.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Unable to connect to the AI service. Check your network connection and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Database operation failed. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Failed to decrypt data. Please contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Data encryption failed. Please contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "An unexpected error occurred. Try again or contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Insufficient credit balance. Add credits to your account and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "An internal error occurred. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "The provided input is invalid. Check your data and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Invalid request format. Check your input data and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Request signature verification failed. Check your license key.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "Star rating must be between 1 and 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "Ticket data is invalid or malformed.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "The trace ID must be a valid UUID format.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Knowledge base article not found.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "This license is already registered in the system.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "Your AI license has expired. Please renew your subscription.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "The provided license is invalid.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "License not found. Check your configuration and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "Your AI license has been suspended. Please contact support.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "The AI provider API key is invalid. Check your configuration.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "No relevant articles found in the knowledge base for this ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "The AI provider returned an error. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "AI provider rate limit exceeded. Try again in a few moments.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "The system failed to generate an AI response. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Failed to search the knowledge base with AI. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "The AI provider is temporarily unavailable. Please try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "The AI service took too long to respond. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Missing required encrypted data field.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "OAuth client credentials are invalid.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "OAuth token is invalid or has been revoked.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "OAuth token has expired. Please authenticate again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Failed to decrypt the ticket data. Check the encryption keys.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "The provided data is invalid or corrupted.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Failed to sanitize sensitive data. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "Data sanitization timed out. Please try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "The data sanitization service is temporarily unavailable.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "You have exceeded your monthly AI token quota. Please upgrade your plan.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Too many requests. Try again in a few moments.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "The requested record was not found.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "The AI service is temporarily unavailable. Try again later.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "You don't have permission to access this ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Ticket not found in the system.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Request validation failed. Check your input and try again.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "AI workflow execution failed. Try again.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Cancel";
$_ADMINLANG['aiSuggestions']['collapse'] = "Collapse";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Collapse All";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Are you sure you want to delete your rating?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Confirm that you have reviewed the sanitized data and are ready to generate AI suggestions.";
$_ADMINLANG['aiSuggestions']['customer'] = "Customer";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Data loaded and sanitized (%s replies). Review and generate suggestions.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Delete Rating";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documents found";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Edit Message Content:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Edit Rating";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Edit this message...";
$_ADMINLANG['aiSuggestions']['error'] = "Error:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Unable to generate an AI suggestion. Try again later.";
$_ADMINLANG['aiSuggestions']['expand'] = "Expand";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Expand All";
$_ADMINLANG['aiSuggestions']['generate'] = "Generate";
$_ADMINLANG['aiSuggestions']['generating'] = "Generating...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generating AI suggestion...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generating AI suggestion...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Generation failed: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "How was this suggestion?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Insert into Reply";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Invalid Date";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Invalid response from sanitize endpoint - missing required fields";
$_ADMINLANG['aiSuggestions']['length'] = "Length";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Concise";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Detailed";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Loading ticket data...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Missing %s in API response";
$_ADMINLANG['aiSuggestions']['networkError'] = "Network Error";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Network error during %s operation: %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "No AI suggestion available.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "No reference documents were used for this response.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "No reply messages found.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "No sanitized data available. Reload ticket data.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "No subject";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "%s operation failed";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Please select rating";
$_ADMINLANG['aiSuggestions']['processing'] = "Processing...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Processing your request, please wait...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Rate AI Suggestion";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Rating deleted successfully";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Excellent";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Failed to submit rating. Please try again.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Fair";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Good";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Poor";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Thank you for your feedback!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Very Good";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Recommended Actions:";
$_ADMINLANG['aiSuggestions']['references'] = "References";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "The following knowledge base articles and documents were used to generate this response:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Regenerate";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "You have reached the maximum number of regenerations (3). Please use the current suggestion.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Regenerating...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Regenerations remaining: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Removing sensitive information and preparing content for AI analysis";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Reply #%s reset.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Reply Thread (%s messages)";
$_ADMINLANG['aiSuggestions']['reset'] = "Reset";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Response generated successfully";
$_ADMINLANG['aiSuggestions']['responseReady'] = "Your AI-generated response is ready";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Response regenerated with new parameters";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Retrieving conversation history and ticket details";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Review Conversation for AI Analysis";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Carefully review the sanitized ticket data below. Ensure you have removed or masked all sensitive information before generating AI suggestions.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Review Sanitized Data Before Generating";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "Sanitization failed.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Sanitizing and loading ticket data...";
$_ADMINLANG['aiSuggestions']['staff'] = "Staff";
$_ADMINLANG['aiSuggestions']['stars'] = "stars";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Submit Rating";
$_ADMINLANG['aiSuggestions']['submitting'] = "Submitting...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Suggested Response:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "Suggestion failed.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Support Staff";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Tell us more about your experience...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Ticket Analysis:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Ticket data not available";
$_ADMINLANG['aiSuggestions']['tone'] = "Tone";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formal";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Friendly";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Technical";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Unable to find reply box.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Unknown Date";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Unknown error";
$_ADMINLANG['aiSuggestions']['youRated'] = "You rated this:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Your feedback:";
...
$_ADMINLANG['apicreds']['adminInviteAccept'] = "Admin Invite Accept";
...
$_ADMINLANG['apicreds']['setCreds'] = "Set Your Login Credentials";
...
$_ADMINLANG['billing']['creditnote'] = "Credit Note";
$_ADMINLANG['billing']['debitnote'] = "Debit Note";
...
$_ADMINLANG['billing']['ledger'] = "Ledger";
$_ADMINLANG['billing']['netIncome'] = "Net Income";
$_ADMINLANG['billing']['nocomments'] = "There are no client-facing comments for this document.";
$_ADMINLANG['billing']['offlinecc'] = "Offline CC Processing";
$_ADMINLANG['billing']['title'] = "Billing";
$_ADMINLANG['billing']['transaction'] = "Transaction";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "This is a draft credit note. The client cannot see or access this credit note until you click Issue.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Credit Note Items";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Manage Credit Note";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Credit Note Number";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "View Credit Note";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "This is a draft debit note. The client cannot see or access this debit note until you click Issue.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Debit Note Items";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Manage Debit Note";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Debit Note Number";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "View Debit Note";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "The system cannot modify the \":attribute\" attribute on a billing note that is in the \":status\" status.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "The system cannot add a line item to a billing note that is not in the Draft status.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "The system cannot assign or modify a line item on a billing note that is not in the Draft status (Line Item ID: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "The system can only modify billing notes while they are in the Draft status.";
...
$_ADMINLANG['clientsummary']['cannotEditAmount'] = "Cannot Edit Amount.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Last Login";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Host";
...
$_ADMINLANG['credit']['cannotEditSystemGenerated'] = "You cannot modify system-generated credit entries.";
...
$_ADMINLANG['credit']['editcredit'] = "Edit Credit";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Try again later.";
$_ADMINLANG['errorPage']['429']['title'] = "Rate Limit Exceeded";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "You cannot modify this item.";
...
$_ADMINLANG['fields']['clientcredit'] = "Client Credit";
...
$_ADMINLANG['fields']['credentialConfiguration'] = "Send Invite";
...
$_ADMINLANG['fields']['expirationDate'] = "Expiration Date";
...
$_ADMINLANG['fields']['invitationExpires'] = "Invitation Expiration Period (In Days)";
...
$_ADMINLANG['fields']['reference'] = "Reference";
...
$_ADMINLANG['fields']['sendInvitationLink'] = "Send Invite Link";
...
$_ADMINLANG['fields']['setCredentials'] = "Set Credentials Manually";
...
$_ADMINLANG['fields']['usernameInviteHelp'] = "Leave blank to allow the admin to set their username.";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Enter the desired increment between generated credit note numbers (Default:1, Maximum: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Credit Note Number Incrementation";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Enter the desired increment between generated debit note numbers (Default:1, Maximum: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Debit Note Number Incrementation";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Disable Auto Renew and cancel invoice items for this domain?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "This action will delete the following invoice items: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "The :inputLabel value must be between 1 and 999.";
...
$_ADMINLANG['general']['mixpaneltrackingenabled'] = "Analytics Tracking";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Password Reset (Require users to complete a CAPTCHA after multiple password reset attempts.)";
...
$_ADMINLANG['general']['seeActivityLog'] = "Review the Activity Log for more details.";
...
$_ADMINLANG['gettingStartedWizard']['company']['about']['exploringOptions'] = "I'm just exploring options.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['notSellingProducts'] = "I'm not selling anything yet.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingNotOnline'] = "I only sell products offline.";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingWithDifferentSystem'] = "I sell products in another system.";
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Choose the language that you will see in the Admin Area.";
$_ADMINLANG['gettingStartedWizard']['description']['analytics'] = "Help us make WHMCS even better.";
$_ADMINLANG['gettingStartedWizard']['description']['checkPayment'] = "Use our Mail In Payment payment gateway to record checks and other physical payments.";
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Choose the language that your clients will see when they log in to the Client Area.";
$_ADMINLANG['gettingStartedWizard']['description']['companyLogo'] = "Your company’s logo will display on your invoices, emails, and in the Client Area.";
$_ADMINLANG['gettingStartedWizard']['description']['connectionError'] = "Check your server information and try again.";
$_ADMINLANG['gettingStartedWizard']['description']['controlPanel'] = "Select your web hosting control panel.";
$_ADMINLANG['gettingStartedWizard']['description']['domains'] = "Connect at least one domain registrar to WHMCS to start selling domains.";
$_ADMINLANG['gettingStartedWizard']['description']['firstServerConnected'] = "You have successfully connected a server. Go to <strong>Configuration (:wrenchIcon) > System Settings > Servers</strong> to edit your server configuration.";
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Choose the language that you and your clients see by default.";
$_ADMINLANG['gettingStartedWizard']['description']['marketConnect'] = "Resell high-quality products and addons from leading service providers.";
$_ADMINLANG['gettingStartedWizard']['description']['paymentDeactivationProhibited'] = "You cannot deactivate this module from within the Getting Started Wizard. To deactivate payment gateways, go to <strong>Configuration (:wrenchIcon) > System Settings > Payment Gateways</strong>.";
$_ADMINLANG['gettingStartedWizard']['description']['paypal'] = "One-click payments with PayPal®.";
$_ADMINLANG['gettingStartedWizard']['description']['primaryIp'] = "Welcome emails will display this address.";
$_ADMINLANG['gettingStartedWizard']['description']['registrarConnect'] = "Already have an account?";
$_ADMINLANG['gettingStartedWizard']['description']['serverDetails'] = "You can modify your server configuration after setup.";
$_ADMINLANG['gettingStartedWizard']['description']['serverName'] = "Enter a name to identify the server.";
$_ADMINLANG['gettingStartedWizard']['description']['setupComplete'] = "To find these steps again, go to <strong>Configuration (:wrenchIcon) > Getting Started Wizard</strong>.";
$_ADMINLANG['gettingStartedWizard']['description']['stripe'] = "One-click payments with Stripe™.";
$_ADMINLANG['gettingStartedWizard']['description']['stripePublishableKey'] = "Your publishable API key identifies your website to Stripe during communications.";
$_ADMINLANG['gettingStartedWizard']['description']['stripeSecretKey'] = "Your secret API Key ensures only communications from Stripe are validated.";
$_ADMINLANG['gettingStartedWizard']['description']['suggestedPrices'] = "Use the suggested retail prices or customize them below.";
$_ADMINLANG['gettingStartedWizard']['description']['tldToSell'] = "You can add more TLDs in your Domain Pricing configuration after you finish setup.";
$_ADMINLANG['gettingStartedWizard']['description']['tlds'] = "Choose Top-Level Domains (TLDs) to sell. You can add more TLDs in your Domain Pricing configuration after you finish setup.";
...
$_ADMINLANG['gettingStartedWizard']['description']['uploadFile'] = "Upload a JPG or PNG file (maximum size: 20MB).";
$_ADMINLANG['gettingStartedWizard']['description']['wireTransfers'] = "Use our Bank Transfers payment gateway to accept wire transfers.";
$_ADMINLANG['gettingStartedWizard']['domains']['countryBased'] = "Country-Based (ccTLDs)";
$_ADMINLANG['gettingStartedWizard']['domains']['enomBadPasswordMessage'] = "Enom requires that API passwords contain at least one lowercase letter (a–z), one uppercase letter (A–Z), one number (0–9), and one of the following special characters: @ * - _ . /";
$_ADMINLANG['gettingStartedWizard']['domains']['enomIpNotPermitted'] = "You must authorize your IP address to use this API. Your IP address is :ip. <a class='underline' target='_blank' href='https://go.whmcs.com/1885/enom#activation'>Learn More</a>.";
$_ADMINLANG['gettingStartedWizard']['domains']['featured'] = "Featured (gTLDs)";
$_ADMINLANG['gettingStartedWizard']['domains']['popular'] = "Popular";
$_ADMINLANG['gettingStartedWizard']['domains']['radix'] = "Radix Domains";
$_ADMINLANG['gettingStartedWizard']['domains']['registrarSignInError'] = "Login failed. Check your credentials.";
$_ADMINLANG['gettingStartedWizard']['extra']['centralNic'] = "Sell domain extensions like <b>.store</b>, <b>.online</b>, .es</b>, <b>.co.uk</b>, or <b>.eu</b>.";
$_ADMINLANG['gettingStartedWizard']['extra']['enom'] = "Sell domain extensions like <b>.com</b>, <b>.net</b>, <b>.biz</b>, or <b>.info</b>.";
$_ADMINLANG['gettingStartedWizard']['extra']['paypal'] = "PayPal could increase your conversions <b>by up to 66%.</b>";
$_ADMINLANG['gettingStartedWizard']['fileUpload']['noFile'] = "No file selected.";
$_ADMINLANG['gettingStartedWizard']['fileUpload']['uploadFile'] = "Upload File";
$_ADMINLANG['gettingStartedWizard']['group']['analytics'] = "Analytics";
$_ADMINLANG['gettingStartedWizard']['group']['company'] = "Your Company";
$_ADMINLANG['gettingStartedWizard']['group']['domains'] = "Set Up Domain Sales";
$_ADMINLANG['gettingStartedWizard']['group']['hosting'] = "Set Up Hosting Servers";
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Localization";
$_ADMINLANG['gettingStartedWizard']['group']['logIntoMarketConnect'] = "Log in to your WHMCS Marketplace account.";
$_ADMINLANG['gettingStartedWizard']['group']['marketConnect'] = "WHMCS MarketConnect";
$_ADMINLANG['gettingStartedWizard']['group']['payments'] = "Set Up Payments";
$_ADMINLANG['gettingStartedWizard']['label']['accountNumber'] = "Account Number";
$_ADMINLANG['gettingStartedWizard']['label']['address'] = "Street Address";
$_ADMINLANG['gettingStartedWizard']['label']['address2'] = "Street Address 2";
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Admin Area Language";
$_ADMINLANG['gettingStartedWizard']['label']['allowTracking'] = "Allow Third-Party Tracking";
$_ADMINLANG['gettingStartedWizard']['label']['bankRoutingNumber'] = "Routing Number";
$_ADMINLANG['gettingStartedWizard']['label']['centralNic'] = "Create a CentralNic Reseller Account";
$_ADMINLANG['gettingStartedWizard']['label']['checkPayment'] = "Check Payments";
$_ADMINLANG['gettingStartedWizard']['label']['city'] = "City";
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Default Language";
$_ADMINLANG['gettingStartedWizard']['label']['company'] = "Company";
$_ADMINLANG['gettingStartedWizard']['label']['companyName'] = "Company Name";
$_ADMINLANG['gettingStartedWizard']['label']['companySize'] = "How many employees does your company have?";
$_ADMINLANG['gettingStartedWizard']['label']['connectedEnom'] = "Enom account connected successfully.";
$_ADMINLANG['gettingStartedWizard']['label']['copyRight'] = "Copyright &copy; WHMCS :year";
$_ADMINLANG['gettingStartedWizard']['label']['country'] = "Country";
$_ADMINLANG['gettingStartedWizard']['label']['createNewAccount'] = "Create A New Account";
$_ADMINLANG['gettingStartedWizard']['label']['currentRevenue'] = "What is your current annual revenue in USD?";
$_ADMINLANG['gettingStartedWizard']['label']['dashboard'] = "Go to the Admin Dashboard";
$_ADMINLANG['gettingStartedWizard']['label']['dontShowAgain'] = "Do not show this again.";
$_ADMINLANG['gettingStartedWizard']['label']['email'] = "Email Address";
$_ADMINLANG['gettingStartedWizard']['label']['enom'] = "Create an Enom Account";
$_ADMINLANG['gettingStartedWizard']['label']['exclusivePricing'] = "Get exclusive pricing for select TLDs:";
$_ADMINLANG['gettingStartedWizard']['label']['firstName'] = "First Name";
$_ADMINLANG['gettingStartedWizard']['label']['forgotPassword'] = "Forgot Password?";
$_ADMINLANG['gettingStartedWizard']['label']['fullList'] = "See the full list.";
$_ADMINLANG['gettingStartedWizard']['label']['help'] = "Need help?";
$_ADMINLANG['gettingStartedWizard']['label']['hostnameIp'] = "Hostname or IP Address";
$_ADMINLANG['gettingStartedWizard']['label']['lastName'] = "Last Name";
$_ADMINLANG['gettingStartedWizard']['label']['learnMore'] = "Learn more.";
$_ADMINLANG['gettingStartedWizard']['label']['logInHere'] = "Log in here.";
$_ADMINLANG['gettingStartedWizard']['label']['logOut'] = "Log Out";
$_ADMINLANG['gettingStartedWizard']['label']['login'] = "Log In";
$_ADMINLANG['gettingStartedWizard']['label']['loginNotice'] = "When you log in or sign up, you agree to our :privacyPolicy and :termsAndConditions.";
$_ADMINLANG['gettingStartedWizard']['label']['marketConnectFromVendor'] = "from :vendorName";
$_ADMINLANG['gettingStartedWizard']['label']['minusMarkdown'] = "- :markdown Markdown";
$_ADMINLANG['gettingStartedWizard']['label']['name'] = "Your Name";
$_ADMINLANG['gettingStartedWizard']['label']['nameOnAccount'] = "Name on Account";
$_ADMINLANG['gettingStartedWizard']['label']['password'] = "Password";
$_ADMINLANG['gettingStartedWizard']['label']['paypal'] = "PayPal Payments";
$_ADMINLANG['gettingStartedWizard']['label']['phoneNumber'] = "Phone Number";
$_ADMINLANG['gettingStartedWizard']['label']['plusMarkup'] = "+ :markup Markup";
$_ADMINLANG['gettingStartedWizard']['label']['primaryIp'] = "Primary IP Address";
$_ADMINLANG['gettingStartedWizard']['label']['primaryNameserver'] = "Primary Nameserver";
$_ADMINLANG['gettingStartedWizard']['label']['privacyPolicy'] = "Privacy Policy";
$_ADMINLANG['gettingStartedWizard']['label']['readyToSell'] = "Are you already selling your products?";
$_ADMINLANG['gettingStartedWizard']['label']['secondaryNameserver'] = "Secondary Nameserver";
$_ADMINLANG['gettingStartedWizard']['label']['securityAnswer'] = "Security Answer";
$_ADMINLANG['gettingStartedWizard']['label']['securityQuestion'] = "Security Question";
$_ADMINLANG['gettingStartedWizard']['label']['selectedTld'] = ":selected / :totalTlds Selected";
$_ADMINLANG['gettingStartedWizard']['label']['serverName'] = "Server Name";
$_ADMINLANG['gettingStartedWizard']['label']['setUp'] = "We will set this up for you.";
$_ADMINLANG['gettingStartedWizard']['label']['setupComplete'] = "Initial setup steps complete!";
$_ADMINLANG['gettingStartedWizard']['label']['signUp'] = "Sign Up";
$_ADMINLANG['gettingStartedWizard']['label']['state'] = "State or Province";
$_ADMINLANG['gettingStartedWizard']['label']['step'] = "Step :step of :maxSteps";
$_ADMINLANG['gettingStartedWizard']['label']['stripe'] = "Stripe";
$_ADMINLANG['gettingStartedWizard']['label']['stripePublishableKey'] = "Stripe Publishable API Key";
$_ADMINLANG['gettingStartedWizard']['label']['stripeSecretKey'] = "Stripe Secret API Key";
$_ADMINLANG['gettingStartedWizard']['label']['termsAndConditions'] = "Terms and Conditions";
$_ADMINLANG['gettingStartedWizard']['label']['testConnection'] = "Test Connection";
$_ADMINLANG['gettingStartedWizard']['label']['uploadLogo'] = "Company Logo";
$_ADMINLANG['gettingStartedWizard']['label']['username'] = "Username";
$_ADMINLANG['gettingStartedWizard']['label']['viewDetails'] = "View Details";
$_ADMINLANG['gettingStartedWizard']['label']['wireTransfers'] = "Wire Transfers";
$_ADMINLANG['gettingStartedWizard']['label']['yourPrice'] = "Your Price";
$_ADMINLANG['gettingStartedWizard']['label']['zipCode'] = "ZIP Code";
$_ADMINLANG['gettingStartedWizard']['marketConnectInvalidCredentials'] = "Login failed. Check your credentials and try again.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['centralNic'] = "Create an account with CentralNic Registry to receive exclusive pricing for WHMCS users on select TLDs.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['checkPayment'] = "Enter the payment address to display on invoices.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['enom'] = "Create an account with Enom instantly.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['registrar'] = "Connect at least one domain registrar to WHMCS to start selling domains.";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['wireTransfers'] = "Enter the details for the bank account that will receive wire transfers.";
$_ADMINLANG['gettingStartedWizard']['payments']['gatewayError'] = "The payment gateway module encountered an unexpected error.";
$_ADMINLANG['gettingStartedWizard']['payments']['stripePublishableKeyError'] = "The :stripePublishableKeyName value must start with 'pk_'.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['accountNumber'] = "Enter your account number.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['address'] = "Enter a street address.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['bankRoutingNumber'] = "Enter your bank routing number.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['city'] = "Enter your city.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyEmail'] = "Enter the main company email address.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyName'] = "Enter your company’s name.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['country'] = "Search for or select your company’s country.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['email'] = "Enter your email address.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['enterAnswer'] = "Enter an answer.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['firstName'] = "Enter your first name.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['hostingUsername'] = "root";
$_ADMINLANG['gettingStartedWizard']['placeholder']['hostnameIp'] = "server1.example.com";
$_ADMINLANG['gettingStartedWizard']['placeholder']['lastName'] = "Enter your last name.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['nameOnAccount'] = "Enter the name on your bank account.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['password'] = "Enter a password.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['phoneNumber'] = "Enter a phone number.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['securityQuestion'] = "Select a question.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['state'] = "Select a state or province.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['username'] = "Enter a username.";
$_ADMINLANG['gettingStartedWizard']['placeholder']['zipCode'] = "Enter a ZIP code.";
$_ADMINLANG['gettingStartedWizard']['servers']['connectionErrorMessage'] = "Check your login credentials.";
$_ADMINLANG['gettingStartedWizard']['title']['aboutCompany'] = "Help us customize your experience.";
$_ADMINLANG['gettingStartedWizard']['title']['analytics'] = "Your privacy is important to us.";
$_ADMINLANG['gettingStartedWizard']['title']['centralNic'] = "Create a CentralNic Registry Reseller Account";
$_ADMINLANG['gettingStartedWizard']['title']['centralNicModal'] = "Log In to CentralNic Registry";
$_ADMINLANG['gettingStartedWizard']['title']['checkPayment'] = "Set up mail-in payments.";
$_ADMINLANG['gettingStartedWizard']['title']['company'] = "Tell us about your company.";
$_ADMINLANG['gettingStartedWizard']['title']['companyAddress'] = "Set Your Business Address";
$_ADMINLANG['gettingStartedWizard']['title']['companyLogo'] = "Upload your logo.";
$_ADMINLANG['gettingStartedWizard']['title']['connectionVerified'] = "Success! Connection verified.";
$_ADMINLANG['gettingStartedWizard']['title']['domainRegistrar'] = "Choose how you register domains.";
$_ADMINLANG['gettingStartedWizard']['title']['domains'] = "Choose which domains to sell.";
$_ADMINLANG['gettingStartedWizard']['title']['enom'] = "Create an Enom account.";
$_ADMINLANG['gettingStartedWizard']['title']['enomModal'] = "Log In to Enom";
$_ADMINLANG['gettingStartedWizard']['title']['hosting'] = "Connect your first server.";
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Select your default language.";
$_ADMINLANG['gettingStartedWizard']['title']['loggedIn'] = "Log in to your WHMCS Marketplace account.";
$_ADMINLANG['gettingStartedWizard']['title']['marketConnect'] = "Boost sales with MarketConnect.";
$_ADMINLANG['gettingStartedWizard']['title']['offlinePayments'] = "Choose which offline payment methods you want to set up:";
$_ADMINLANG['gettingStartedWizard']['title']['onlinePayments'] = "Connect your online payment processor to WHMCS:";
$_ADMINLANG['gettingStartedWizard']['title']['payments'] = "Choose how you process payments.";
$_ADMINLANG['gettingStartedWizard']['title']['registrar'] = "Registrar";
$_ADMINLANG['gettingStartedWizard']['title']['retailPrice'] = "Retail Price";
$_ADMINLANG['gettingStartedWizard']['title']['serverDetails'] = "Server Details";
$_ADMINLANG['gettingStartedWizard']['title']['setPricing'] = "Set your TLD pricing.";
$_ADMINLANG['gettingStartedWizard']['title']['setupComplete'] = "Setup complete.";
$_ADMINLANG['gettingStartedWizard']['title']['tld'] = "TLD";
$_ADMINLANG['gettingStartedWizard']['title']['tldToSell'] = "Choose Top-Level Domains (TLDs) to sell.";
$_ADMINLANG['gettingStartedWizard']['title']['wireTransfers'] = "Set up wire transfers.";
$_ADMINLANG['gettingStartedWizard']['title']['yourCost'] = "Your Cost";
$_ADMINLANG['global']['-any-'] = "- Any -";
$_ADMINLANG['global']['aMonth'] = ":months Month";
$_ADMINLANG['global']['accept'] = "Accept";
...
$_ADMINLANG['global']['daysLeft'] = ":days days left";
...
$_ADMINLANG['global']['discard'] = "Discard";
...
$_ADMINLANG['global']['lastActive'] = "Last Active";
...
$_ADMINLANG['global']['manageMember'] = "Manage Admin";
...
$_ADMINLANG['global']['online'] = "Online";
...
$_ADMINLANG['global']['products'] = "Products";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "Invoice immutability is disabled. We have deprecated the ability to edit invoices and we will remove the option to enable invoice mutability in a future release.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "You have configured your system to allow invoice editing (invoice mutability) for non-Draft invoices. We deprecated this ability in WHMCS 9.0 and will remove the configuration that allows this behavior in a future release.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Invoice Immutability";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['fail'] = "Your Two-Factor Authentication storage is not secured. <a href=\":href\">Click here</a> to manage Two-Factor Authentication settings.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "Two-Factor Authentication storage encryption is in progress.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "Two-Factor Authentication storage is secure.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Two-Factor Authentication Storage";
...
$_ADMINLANG['healthCheck']['learnMore'] = "You can learn more about this in our documentation.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "PHP session storage is not writeable. For help, contact your system administrator. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Learn more.</a>";
...
$_ADMINLANG['help']['setupWizard'] = "Getting Started Wizard";
...
$_ADMINLANG['invoices']['cancel'] = "Are you sure you want to cancel this invoice? Recurring items in the invoice will not be reinvoiced for this date.";
$_ADMINLANG['invoices']['cancelPayment'] = "Cancel Payment";
$_ADMINLANG['invoices']['cancelTitle'] = "Cancel Invoice";
...
$_ADMINLANG['invoices']['delete'] = "Are you sure you want to delete this invoice?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "The system cannot modify the \":attribute\" attribute on an invoice that is in the \":status\" status.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "The system cannot add a line item to an invoice unless it is in Draft status.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "The system cannot assign or modify a line item on an invoice unless it is in Draft status (Line Item ID: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "The system can only modify invoices while they are in Draft status.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "Invoice immutability is disabled. You can request invalid status changes on the Manage Invoice &raquo; Options tab.";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "The system can only transition an invoice to Cancelled from the following statuses: Unpaid, Payment Pending, or Collections.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "The system can only delete a Draft invoice.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "The system can only transition an invoice to Paid from the following statuses: Unpaid, Payment Pending, or Collections.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "The system can only apply payments to an invoice in Unpaid, Payment Pending, or Collections status.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "The system can only refund payments from an invoice in Unpaid, Payment Pending, Paid, or Collections status.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Click to apply a credit note for the remaining balance, mark Paid, and execute any post-payment actions.";
$_ADMINLANG['invoices']['invoiceCreditResult'] = "These transactions resulted in a credit being given to the user in the amount of ";
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "This is a Cancelled Invoice.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Please %s first to apply a payment";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "This is a Collections Invoice.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "This is a Draft Invoice.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "You cannot modify an Invoice that is :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "This is a Paid Invoice.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "This is a Payment Pending Invoice.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "This invoice is Refunded.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "This is an Unpaid Invoice.";
$_ADMINLANG['invoices']['itemDescriptionAmountRequired'] = "You must enter Description and Amount values.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Click to generate and apply the credit or debit notes required to transition the invoice to Cancelled.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Click to generate and apply a credit note for the remaining balance and transition the invoice to Paid. This will also execute any post-payment actions.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "The system successfully transitioned :successes of :attempted invoices to Cancelled.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "The system successfully deleted :successes of :attempted invoices.";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "The system successfully transitioned :successes of :attempted invoices to Paid.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "The system successfully transitioned :successes of :attempted invoices to Unpaid.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Are you sure you want to delete the selected invoices?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "Your selection includes non-Draft invoices. The system will modify these invoices because invoice immutability is disabled.";
...
$_ADMINLANG['invoices']['unsavedChangesLost'] = "You will lose unsaved changes if you leave this page. Are you sure that you want to continue?";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "The system failed to decrypt a MarketConnect API token. Check your CC encryption hash or disconnect and reconnect your WHMCS Marketplace account.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Authentication failed. Check your WHMCS Marketplace credentials at Configuration <i class='far fa-wrench' aria-hidden='true'></i> > System Settings > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Offer all <b>:serviceName</b> products.";
$_ADMINLANG['marketConnect']['gdprConsent'] = "To sign up with WHMCS Marketplace, WHMCS Ltd. and its affiliates need to store and process your personal data in accordance with the <a href=\"https://www.webpros.com/legal\">WebPros Privacy Policy</a>.";
$_ADMINLANG['marketConnect']['introModalTitle'] = "Welcome to MarketConnect";
$_ADMINLANG['marketConnect']['lastUpdated'] = "Last Updated";
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "About";
$_ADMINLANG['marketConnect']['learn']['tab']['faq'] = "FAQ";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "WHMCS Ltd. and its affiliates in the WebPros group may provide me with news and individual offers around WebPros products in accordance with the <a href=\"https://www.webpros.com/legal\">WebPros Privacy Policy</a>. I may revoke this consent by clicking the link in any communication received.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/mo";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/month";
$_ADMINLANG['marketConnect']['points'] = "Points";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Recommended Retail Price";
$_ADMINLANG['marketConnect']['refresh'] = "Refresh";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Selling Status";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "About Us";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Activate";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Deactivate";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Learn more";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Manage";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Start Selling";
...
$_ADMINLANG['marketConnect']['socialbee']['about']['author'] = "- Ovi Negrean, SocialBee’s CEO";
$_ADMINLANG['marketConnect']['socialbee']['about']['p1'] = "SocialBee is an all-in-one social media management tool that empowers its users to share content across multiple social media networks from one place. You can set a posting schedule, share content, analyze performance, and engage with your followers.";
$_ADMINLANG['marketConnect']['socialbee']['about']['p2'] = "SocialBee was founded to simplify social media management for businesses of all sizes. Since its launch in 2016, the platform has grown into a robust tool that enables users to create, schedule, analyze, and engage with content across various platforms—all from one place. With an emphasis on user-friendly design and powerful features like category-based scheduling and analytics, SocialBee is trusted by entrepreneurs, marketers, and agencies to optimize their social presence and build meaningful connections with their audiences.";
...
$_ADMINLANG['marketConnect']['socialbee']['about']['title'] = "About Us";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h1'] = "Which social media platforms can you manage with SocialBee?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h2'] = "What support options are available for SocialBee users?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h3'] = "Are SocialBee’s agency plans different from the regular Pro plan?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h4'] = "Where are SocialBee’s servers located? Where is SocialBee’s data stored?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h5'] = "Why should I sell a social media management tool?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h6'] = "Will businesses pay for social media tools?";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q1'] = "You can manage and schedule content for popular platforms like Facebook, Instagram, Threads, X™ (formerly Twitter™), LinkedIn, Pinterest, Google Business Profile™, TikTok, YouTube™, and Bluesky.";
...
$_ADMINLANG['marketConnect']['socialbee']['faq']['q3'] = "The agency plans (Pro50, Pro100, and Pro150) have the same features as the Pro plan. The main differences are the number of social media profiles that you can connect, the number of workspaces, and the users you can add to a workspace:";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q4'] = "SocialBee’s servers are located in Ireland, Europe.";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q5'] = "Selling a social media management tool like SocialBee allows you to tap into the growing demand for social media marketing solutions. Small and medium-sized businesses need tools to take care of their social media profiles, save time, and increase engagement—creating a strong market for these services for resellers like you.";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q6'] = "Yes, small and medium-sized businesses are rapidly investing in social media tools to manage their social media presence. As one of the most-used marketing channels, social media contributes to business growth, and companies are eager to invest in reliable tools to help them reach their goals.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p1'] = "SocialBee integrates with Canva, Unsplash, and GIPHY, so you can easily create and curate visuals for your posts.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p2'] = "Generate captions and images in seconds with AI, and get access to over 1,000 premade prompts to save time.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p3'] = "Experiment with different post types like images, videos, carousels, stories, and Reels to find what connects best with your audience.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['title'] = "Create";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p1'] = "Schedule posts for major platforms like Facebook®, Instagram, LinkedIn®, TikTok, Pinterest, and more, all from one place.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p2'] = "Organize your posts with a visual calendar that shows your entire social media strategy at a glance.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p3'] = "Plan and queue posts ahead of time to keep your social media accounts active without needing to post manually.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['title'] = "Schedule";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p1'] = "Respond to all your comments, mentions, and DMs across social media platforms from a single, easy-to-manage inbox.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p2'] = "Save time and stay on top of conversations without having to switch between different social media accounts.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p3'] = "Get notified whenever someone engages with your content, so you never miss important messages or engagement opportunities.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['title'] = "Engage";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p1'] = "Share feedback and tag your colleagues directly on content drafts.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p2'] = "Manage multiple brands or clients with separate, organized workspaces.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p3'] = "Avoid duplicate work with a shared space for collaboration.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['title'] = "Collaborate";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p1'] = "Get a clear view of your social media progress with easy-to-understand metrics, visual charts, maps, and more.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p2'] = "Compare platform performance to identify where your efforts pay off the most.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p3'] = "Track engagement, impressions, click-through rates, and follower growth over time for all of your social media accounts.";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['title'] = "Analyze";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['about'] = "About";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['faq'] = "FAQ";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['features'] = "Features";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['lite'] = "Lite Plan";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['pricing'] = "Pricing";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['2years'] = "Up to 2 Years";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['3months'] = "Up to 3 Months";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['AICreation'] = "AI Content Creation";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['GIPHY'] = "GIPHY Integration";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['RRP'] = ":price RRP";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['URL'] = "URL Shortener Integrations";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['accounts'] = "Social Media Accounts";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['addons'] = "Addons for Users, Workspaces,<br>and Profiles";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['automationTool'] = "Automation Tool Integrations";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['browserExtension'] = "Browser Extension";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['canva'] = "Canva Integration";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['categories'] = "Content Categories<br>(Folders)";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['comparePlans'] = "Compare Plans";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['comparePrices'] = "Compare Prices";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentApproval'] = "Content Approval";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCuration'] = "Content Curation";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCurator'] = "Content Curator Integrations";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentResharing'] = "Content Resharing";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentSchedulingPublishing'] = "Content Scheduling<br>and Publishing";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['dataAccess'] = "Historical<br>Data Access";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['exportBrandedReports'] = "Export Branded Reports";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['importFeeds'] = "Import RSS Feeds";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['internalNotes'] = "Internal Notes<br>(Feedback)";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['mobileApp'] = "Mobile App";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postDrafts'] = "Post Drafts";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postingTimeSuggestions'] = "Best Posting Time Suggestions";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['posts'] = "Posts per Category";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['socialMediaAnalytics'] = "Social Media Analytics";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['socialMediaInbox'] = "Social Media Inbox";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['tagAccelerate'] = "Accelerate";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['teamCollaboration'] = "Team Collaboration";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['universalPosting'] = "Universal Posting";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['unlimited'] = "Unlimited";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['unsplash'] = "Unsplash Integration";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['users'] = "Users";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['workspaces'] = "Dedicated Workspaces";
$_ADMINLANG['marketConnect']['socialbee']['profiles'] = ":num social profiles";
$_ADMINLANG['marketConnect']['socialbee']['workspaces'] = ":num workspaces";
$_ADMINLANG['marketConnect']['socialbee']['workspaceusers'] = ":num users per workspace";
...
$_ADMINLANG['mergefields']['adminInvite'] = "Admin Invite";
...
$_ADMINLANG['mergefields']['configoptions'] = "Config. Options (Array)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Config. Options (HTML)";
...
$_ADMINLANG['permissions']['160'] = "View Scheduled Ticket Actions";
$_ADMINLANG['permissions']['161'] = "Create Scheduled Ticket Actions";
$_ADMINLANG['permissions']['162'] = "Edit Scheduled Ticket Actions";
$_ADMINLANG['permissions']['163'] = "Cancel Scheduled Ticket Actions";
$_ADMINLANG['permissions']['164'] = "List Credit and Debit Notes";
$_ADMINLANG['permissions']['165'] = "Create Credit or Debit Note";
$_ADMINLANG['permissions']['166'] = "View Credit or Debit Note";
$_ADMINLANG['permissions']['167'] = "Manage Credit or Debit Note";
$_ADMINLANG['permissions']['168'] = "Delete Credit or Debit Note";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Missing required permission.";
...
$_ADMINLANG['products']['productgroupicon'] = "Group Icon";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "eg. fa-solid fa-house";
...
$_ADMINLANG['status']['issued'] = "Issued";
...
$_ADMINLANG['support']['aiAssisted'] = "AI-Assisted";
$_ADMINLANG['support']['aiConfirmReview'] = "Confirm Data Review";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Confirm that you have reviewed the sanitized ticket data and are ready to generate AI suggestions. Remove or mask all sensitive information.";
$_ADMINLANG['support']['aiContentRequired'] = "Content is required";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "No permission to this feature for your role";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Enter sanitized content";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Enter sanitized subject";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Optional feedback";
$_ADMINLANG['support']['aiGenerate'] = "Generate";
$_ADMINLANG['support']['aiGenerateResponse'] = "Generate AI Suggestion";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Help us improve AI responses";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "How helpful was this response?";
$_ADMINLANG['support']['aiInitialMessage'] = "Initial Message";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Initial Message";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Ticket Subject";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Tell us how we can improve this suggestion";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Credit card numbers, passwords, or sensitive data";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Customer names, emails, phone numbers";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Review and remove any Personal Identifiable Information (PII) before generating AI suggestions:";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Privacy Notice:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Personal addresses or private information";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Rate this suggestion";
$_ADMINLANG['support']['aiRatingFeedback'] = "Provide Feedback";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Share Your Positive Experience";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "How can we improve?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "We appreciate your feedback. Please let us know how we can improve the AI suggestions.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "We're glad you found this helpful! Please share what made this suggestion effective for you.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "We're sorry this suggestion didn't meet your expectations. Please let us know what we can do better.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Enter your feedback here...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Share what made this helpful...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Tell us how we can improve...";
$_ADMINLANG['support']['aiReplyThread'] = "Reply Thread";
$_ADMINLANG['support']['aiResponseGenerated'] = "AI Response Generated:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "The system generated a suggested response. You can now insert it into your reply.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Review Conversation Analysis";
$_ADMINLANG['support']['aiSubject'] = "Ticket Subject";
$_ADMINLANG['support']['aiSubjectRequired'] = "Subject is required";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Submit Feedback";
$_ADMINLANG['support']['aiSuggestions'] = "AI Suggestions";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Thank you for your feedback!";
$_ADMINLANG['support']['aiTicketContent'] = "Ticket Content";
...
$_ADMINLANG['support']['massblockdeleteconfirm'] = "Are you sure you wish to delete the selected tickets and block senders?";
$_ADMINLANG['support']['masscloseconfirm'] = "Are you sure you wish to close the selected tickets?";
$_ADMINLANG['support']['massdeleteconfirm'] = "Are you sure you wish to delete the selected tickets?";
$_ADMINLANG['support']['massmergeconfirm'] = "Are you sure you wish to merge the selected tickets?";
$_ADMINLANG['support']['masspin'] = "Are you sure you want to pin the selected tickets?";
$_ADMINLANG['support']['massunpin'] = "Are you sure you want to unpin the selected tickets?";
...
$_ADMINLANG['support']['pinErrorTicket'] = "An error occurred while trying to pin the ticket.";
$_ADMINLANG['support']['pinTicket'] = "Pin Ticket";
...
$_ADMINLANG['support']['ticket']['action']['customFieldValueUpdate'] = "Field Value";
$_ADMINLANG['support']['ticket']['action']['customFieldValueUpdatePlaceholder'] = "If you do not enter a value, the scheduled action will update the custom field with an empty value.";
...
$_ADMINLANG['support']['ticket']['action']['name']['addnote'] = "Add Note";
$_ADMINLANG['support']['ticket']['action']['name']['addreply'] = "Add Reply";
...
$_ADMINLANG['support']['ticket']['action']['scheduleDuplicateError'] = "The system could not save the action. You cannot schedule multiple updates to the same custom field.";
...
$_ADMINLANG['support']['ticket']['action']['skip']['any_reply'] = "Unschedule After a Ticket Update";
$_ADMINLANG['support']['ticket']['action']['skip']['no_skip'] = "Do Not Unschedule After a Ticket Update";
$_ADMINLANG['support']['ticket']['action']['skip']['nonadmin_reply'] = "Unschedule After a Non-Admin Ticket Update";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Error saving attachment: the destination folder is not writable.</br>Check your folder permissions.";
...
$_ADMINLANG['support']['ticketactions'] = "Scheduled Actions";
$_ADMINLANG['support']['ticketemailerror'] = "You must specify an existing client or enter the recipient's email address manually.";
...
$_ADMINLANG['support']['ticketnameerror'] = "You must enter the name of the person you are creating this ticket for or specify an existing client.";
...
$_ADMINLANG['support']['unpinTicket'] = "Unpin Ticket";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "You must disable Captcha for Login Forms in <a href='configgeneral.php#tab=10'>Security Settings</a> to use Integration Code";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "You must disable Captcha for Domain Checker in <a href='configgeneral.php#tab=10'>Security Settings</a> to use Integration Code";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Allows you to automatically reset the credit number periodically.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Custom Credit Notes";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Custom Credit Note Numbering Format";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "The credit notes number format. If you include tags, the system will automatically replace them.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Custom Credit Note Numbering";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Check to enable custom numbering formats for credit notes.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Next Credit Note Number";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "The next credit note number to assign.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Custom Debit Notes";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Custom Debit Note Numbering Format";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "The debit notes number format. If you include tags, the system will automatically replace them.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Custom Debit Note Numbering";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Check to enable custom numbering formats for debit notes.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Next Debit Note Number";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "The next debit note number to assign.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Validate Format During Checkout";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Do Not Validate (Disabled)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Validate with Relevant Authority";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Validate at Checkout and with Relevant Authority";
...
$_ADMINLANG['taxconfig']['vat']['modeUK']['description'] = "Choose a method for validating UK VAT numbers.";
$_ADMINLANG['taxconfig']['vat']['modeUK']['label'] = "UK VAT Validation Mode";
$_ADMINLANG['taxconfig']['vat']['provider']['VIES']['name'] = "VIES";
$_ADMINLANG['taxconfig']['vat']['provider']['WhmcsVatService']['name'] = "Remote Verification";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAll']['name'] = "Accept All VAT Numbers";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAllToDo']['name'] = "Accept All VAT Numbers and Create a To Do Item";
$_ADMINLANG['taxconfig']['vat']['provider']['denyAll']['name'] = "Deny All";
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Automatically Update VAT Rules";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Toggle to enable automatic checks for updated VAT rules. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Learn more</a>.";
...
$_ADMINLANG['user']['addAdmin'] = "Add Admin";
...
$_ADMINLANG['user']['changePassword'] = "Change Password";
$_ADMINLANG['user']['changePasswordForEmail'] = "Change Password: :email";
...
$_ADMINLANG['user']['sendPasswordResetEmail'] = "Send Password Reset Email";
...
$_ADMINLANG['userLogin']['createAccount'] = "Create Account";
...
$_ADMINLANG['validation']['password']['max'] = "Passwords cannot contain more than :max characters.";
...
$_ADMINLANG['whois']['invalidtld'] = "You cannot perform WHOIS Lookups for the %s TLD.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Allow Tracking";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Deny Tracking";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Help Us Enhance WHMCS</strong><br /> We use anonymized tracking to improve WHMCS. Your participation helps us make WHMCS more intuitive and user-friendly. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Learn more about the data we collect</a>.";
