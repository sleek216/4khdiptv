...
$_ADMINLANG['addonmodules']['invalidCharsRemoved'] = "Rimozione di caratteri non validi";
$_ADMINLANG['addonmodules']['invalidCharsRemovedInfo'] = "Il sistema ha rilevato e rimosso caratteri UTF-8 a 4 byte non validi nei valori di configurazione salvati.";
...
$_ADMINLANG['aiSuggestions']['additionalFeedback'] = "Feedback aggiuntivo (opzionale)";
$_ADMINLANG['aiSuggestions']['adjustToneLength'] = "Regola tono e lunghezza";
$_ADMINLANG['aiSuggestions']['aiAnalyzing'] = "L'intelligenza artificiale sta analizzando il contesto della conversazione e creando una risposta personalizzata";
$_ADMINLANG['aiSuggestions']['aiSuggestionGenerated'] = "Suggerimento generato dall'intelligenza artificiale. Rivedi il suggerimento prima di inserirlo nella risposta.";
$_ADMINLANG['aiSuggestions']['aiSuggestionInserted'] = "Suggerimento AI inserito. Rivedi prima dell'invio.";
$_ADMINLANG['aiSuggestions']['aiSuggestionTitle'] = "Suggerimento AI";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_digest_extraction_failed'] = "Impossibile estrarre il riepilogo del ticket. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_invalid_response'] = "Ho ricevuto una risposta non valida dal servizio AI.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_license_validation_failed'] = "Convalida della licenza non riuscita. Controlla le tue credenziali e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_prompt_generation_failed'] = "Impossibile generare un prompt AI. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_response_store_failed'] = "Impossibile salvare la risposta AI. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_timeout'] = "Il servizio di supporto AI è scaduto. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_aisc_service_unavailable'] = "Il servizio di supporto AI è temporaneamente non disponibile.";
$_ADMINLANG['aiSuggestions']['aiagent_error_auth_failed'] = "Autenticazione fallita. Controlla le tue credenziali di AI Agent.";
$_ADMINLANG['aiSuggestions']['aiagent_error_connection_error'] = "Impossibile connettersi al servizio AI. Controlla la tua connessione di rete e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_database_error'] = "Operazione del database non riuscita. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_decryption_failed'] = "Impossibile decrittografare i dati. Contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_encryption_failed'] = "Crittografia dei dati non riuscita. Contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_general'] = "Si è verificato un errore imprevisto. Riprova o contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_insufficient_balance'] = "Saldo del credito insufficiente. Aggiungi crediti al tuo account e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_internal_error'] = "Si è verificato un errore interno. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_input'] = "L'input fornito non è valido. Controlla i tuoi dati e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_request'] = "Formato di richiesta non valido. Controlla i dati inseriti e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_signature'] = "Richiesta di verifica della firma non riuscita. Controlla la tua chiave di licenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_star_rating'] = "La valutazione a stelle deve essere compresa tra 1 e 5.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_ticket_data'] = "I dati del biglietto non sono validi o non sono validi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_invalid_trace_id'] = "L'ID di traccia deve essere un formato UUID valido.";
$_ADMINLANG['aiSuggestions']['aiagent_error_kb_article_not_found'] = "Articolo della Knowledge Base non trovato.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_duplicated'] = "Questa licenza è già registrata nel sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_expired'] = "La tua licenza AI è scaduta. Rinnova l'abbonamento.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_invalid'] = "La licenza fornita non è valida.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_not_found'] = "Licenza non trovata. Controlla la tua configurazione e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_license_suspended'] = "La tua licenza AI è stata sospesa. Contatta l'assistenza.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_invalid_api_key'] = "La chiave API del provider AI non è valida. Controlla la tua configurazione.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_no_search_results'] = "Nessun articolo pertinente trovato nella knowledge base di questo ticket.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_provider_error'] = "Il provider di intelligenza artificiale ha restituito un errore. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_rate_limit_exceeded'] = "È stato superato il limite tariffario del fornitore di intelligenza artificiale. Riprova tra qualche istante.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_response_generation_failed'] = "Il sistema non è riuscito a generare una risposta AI. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_search_failed'] = "Impossibile eseguire la ricerca nella knowledge base con AI. Riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_service_unavailable'] = "Il provider di intelligenza artificiale è temporaneamente non disponibile. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_llm_timeout'] = "Il servizio di intelligenza artificiale ha impiegato troppo tempo per rispondere. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_missing_encrypted_data'] = "Campo dati crittografato obbligatorio mancante.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_client'] = "Le credenziali del client OAuth non sono valide.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_invalid_token'] = "Il token OAuth non è valido o è stato revocato.";
$_ADMINLANG['aiSuggestions']['aiagent_error_oauth_token_expired'] = "Il token OAuth è scaduto. Effettua nuovamente l'autenticazione.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_decryption_failed'] = "Impossibile decifrare i dati del ticket. Controlla le chiavi di crittografia.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_invalid_data'] = "I dati forniti non sono validi o sono danneggiati.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_sanitization_failed'] = "Impossibile disinfettare i dati sensibili. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_timeout'] = "La sanificazione dei dati è scaduta. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_pii_service_unavailable'] = "Il servizio di sanificazione dei dati è temporaneamente non disponibile.";
$_ADMINLANG['aiSuggestions']['aiagent_error_quota_exceeded'] = "Hai superato la tua quota mensile di token AI. Aggiorna il tuo piano.";
$_ADMINLANG['aiSuggestions']['aiagent_error_rate_limit_exceeded'] = "Troppe richieste. Riprova tra qualche istante.";
$_ADMINLANG['aiSuggestions']['aiagent_error_record_not_found'] = "Il record richiesto non è stato trovato.";
$_ADMINLANG['aiSuggestions']['aiagent_error_service_unavailable'] = "Il servizio AI è temporaneamente non disponibile. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_access_denied'] = "Non sei autorizzato ad accedere a questo biglietto.";
$_ADMINLANG['aiSuggestions']['aiagent_error_ticket_not_found'] = "Ticket non trovato nel sistema.";
$_ADMINLANG['aiSuggestions']['aiagent_error_validation_failed'] = "Convalida della richiesta non riuscita. Controlla i dati inseriti e riprova.";
$_ADMINLANG['aiSuggestions']['aiagent_error_workflow_execution_error'] = "Esecuzione del flusso di lavoro AI non riuscita. Riprova.";
$_ADMINLANG['aiSuggestions']['cancel'] = "Annulla";
$_ADMINLANG['aiSuggestions']['collapse'] = "Comprimi";
$_ADMINLANG['aiSuggestions']['collapseAll'] = "Comprimi tutto";
$_ADMINLANG['aiSuggestions']['confirmDeleteRating'] = "Sei sicuro di voler eliminare la tua valutazione?";
$_ADMINLANG['aiSuggestions']['confirmReviewedData'] = "Conferma di aver esaminato i dati sanificati e di essere pronto a generare suggerimenti di intelligenza artificiale.";
$_ADMINLANG['aiSuggestions']['customer'] = "Cliente";
$_ADMINLANG['aiSuggestions']['dataLoadedSanitized'] = "Dati caricati e sanificati (risposte%s ). Rivedi e genera suggerimenti.";
$_ADMINLANG['aiSuggestions']['deleteRating'] = "Elimina valutazione";
$_ADMINLANG['aiSuggestions']['documentsFound'] = "documenti trovati";
$_ADMINLANG['aiSuggestions']['editMessageContent'] = "Modifica il contenuto del messaggio:";
$_ADMINLANG['aiSuggestions']['editRating'] = "Modifica valutazione";
$_ADMINLANG['aiSuggestions']['editThisMessage'] = "Modifica questo messaggio...";
$_ADMINLANG['aiSuggestions']['error'] = "Errore:";
$_ADMINLANG['aiSuggestions']['errorUnableToGenerate'] = "Impossibile generare un suggerimento basato sull'intelligenza artificiale. Riprova più tardi.";
$_ADMINLANG['aiSuggestions']['expand'] = "Espandi";
$_ADMINLANG['aiSuggestions']['expandAll'] = "Espandi tutto";
$_ADMINLANG['aiSuggestions']['generate'] = "Genera";
$_ADMINLANG['aiSuggestions']['generating'] = "Generazione...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestion'] = "Generazione di suggerimenti AI...";
$_ADMINLANG['aiSuggestions']['generatingAiSuggestionModal'] = "Generazione di suggerimenti AI...";
$_ADMINLANG['aiSuggestions']['generationFailed'] = "Generazione fallita: %s";
$_ADMINLANG['aiSuggestions']['howWasThisSuggestion'] = "Com'è stato questo suggerimento?";
$_ADMINLANG['aiSuggestions']['insertIntoReply'] = "Inserisci nella risposta";
$_ADMINLANG['aiSuggestions']['invalidDate'] = "Data non valida";
$_ADMINLANG['aiSuggestions']['invalidResponseMissingFields'] = "Risposta non valida da sanitize endpoint - campi obbligatori mancanti";
$_ADMINLANG['aiSuggestions']['length'] = "Lunghezza";
$_ADMINLANG['aiSuggestions']['lengthConcise'] = "Conciso";
$_ADMINLANG['aiSuggestions']['lengthDetailed'] = "Dettagliato";
$_ADMINLANG['aiSuggestions']['loadingTicketData'] = "Caricamento dei dati del ticket...";
$_ADMINLANG['aiSuggestions']['missingInResponse'] = "Manca %s nella risposta dell'API";
$_ADMINLANG['aiSuggestions']['networkError'] = "Errore di rete";
$_ADMINLANG['aiSuggestions']['networkErrorDuring'] = "Errore di rete durante l'operazione %s : %s";
$_ADMINLANG['aiSuggestions']['noAiSuggestion'] = "Nessun suggerimento di intelligenza artificiale disponibile.";
$_ADMINLANG['aiSuggestions']['noReferencesAvailable'] = "Per questa risposta non è stato utilizzato alcun documento di riferimento.";
$_ADMINLANG['aiSuggestions']['noRepliesFound'] = "Nessun messaggio di risposta trovato.";
$_ADMINLANG['aiSuggestions']['noSanitizedData'] = "Non sono disponibili dati sanificati. Ricarica i dati del ticket.";
$_ADMINLANG['aiSuggestions']['noSubject'] = "Nessun argomento";
$_ADMINLANG['aiSuggestions']['operationFailed'] = "Operazione %s non riuscita";
$_ADMINLANG['aiSuggestions']['pleaseSelectRating'] = "Seleziona la valutazione";
$_ADMINLANG['aiSuggestions']['processing'] = "Elaborando...";
$_ADMINLANG['aiSuggestions']['processingRequest'] = "Elaborazione della tua richiesta, attendi...";
$_ADMINLANG['aiSuggestions']['rateAiSuggestion'] = "Valuta il suggerimento AI";
$_ADMINLANG['aiSuggestions']['ratingDeleted'] = "Valutazione eliminata con successo";
$_ADMINLANG['aiSuggestions']['ratingExcellent'] = "Eccellente";
$_ADMINLANG['aiSuggestions']['ratingFailed'] = "Impossibile inviare la valutazione. Per favore riprova.";
$_ADMINLANG['aiSuggestions']['ratingFair'] = "Fiera";
$_ADMINLANG['aiSuggestions']['ratingGood'] = "Buono";
$_ADMINLANG['aiSuggestions']['ratingPoor'] = "Scarso";
$_ADMINLANG['aiSuggestions']['ratingSubmitted'] = "Grazie per il tuo feedback!";
$_ADMINLANG['aiSuggestions']['ratingVeryGood'] = "Molto buono";
$_ADMINLANG['aiSuggestions']['recommendedActions'] = "Azioni consigliate:";
$_ADMINLANG['aiSuggestions']['references'] = "Referenze";
$_ADMINLANG['aiSuggestions']['referencesDescription'] = "Per generare questa risposta sono stati utilizzati i seguenti articoli e documenti della knowledge base:";
$_ADMINLANG['aiSuggestions']['regenerate'] = "Rigenera";
$_ADMINLANG['aiSuggestions']['regenerateLimit'] = "Hai raggiunto il numero massimo di rigenerazioni (3). Utilizza il suggerimento attuale.";
$_ADMINLANG['aiSuggestions']['regenerating'] = "Rigenerante...";
$_ADMINLANG['aiSuggestions']['regenerationsRemaining'] = "Rigenerazioni rimanenti: %s";
$_ADMINLANG['aiSuggestions']['removingSensitiveInfo'] = "Rimuovere le informazioni sensibili e preparare i contenuti per l'analisi dell'IA";
$_ADMINLANG['aiSuggestions']['replyReset'] = "Risposta%s reset.";
$_ADMINLANG['aiSuggestions']['replyThread'] = "Thread di risposta (messaggi%s )";
$_ADMINLANG['aiSuggestions']['reset'] = "Reimposta";
$_ADMINLANG['aiSuggestions']['responseGenerated'] = "Risposta generata con successo";
$_ADMINLANG['aiSuggestions']['responseReady'] = "La tua risposta generata dall'intelligenza artificiale è pronta";
$_ADMINLANG['aiSuggestions']['responseRegenerated'] = "Risposta rigenerata con nuovi parametri";
$_ADMINLANG['aiSuggestions']['retrievingConversation'] = "Recupero della cronologia delle conversazioni e dei dettagli del ticket";
$_ADMINLANG['aiSuggestions']['reviewConversationTitle'] = "Rivedi la conversazione per l'analisi dell'IA";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataDesc'] = "Esamina attentamente i dati del biglietto sanificato di seguito. Assicurati di aver rimosso o mascherato tutte le informazioni sensibili prima di generare suggerimenti di intelligenza artificiale.";
$_ADMINLANG['aiSuggestions']['reviewSanitizedDataTitle'] = "Rivedi i dati disinfettati prima di generarli";
$_ADMINLANG['aiSuggestions']['sanitizationFailed'] = "La sanificazione non è riuscita.";
$_ADMINLANG['aiSuggestions']['sanitizingAndLoading'] = "Sanificazione e caricamento dei dati dei ticket...";
$_ADMINLANG['aiSuggestions']['staff'] = "Personale";
$_ADMINLANG['aiSuggestions']['stars'] = "stelle";
$_ADMINLANG['aiSuggestions']['submitRating'] = "Invia valutazione";
$_ADMINLANG['aiSuggestions']['submitting'] = "Invio in corso...";
$_ADMINLANG['aiSuggestions']['suggestedResponse'] = "Risposta suggerita:";
$_ADMINLANG['aiSuggestions']['suggestionFailed'] = "Suggerimento fallito.";
$_ADMINLANG['aiSuggestions']['supportStaff'] = "Personale di supporto";
$_ADMINLANG['aiSuggestions']['tellUsMore'] = "Raccontaci di più sulla tua esperienza...";
$_ADMINLANG['aiSuggestions']['ticketAnalysis'] = "Analisi dei biglietti:";
$_ADMINLANG['aiSuggestions']['ticketDataNotAvailable'] = "Dati del biglietto non disponibili";
$_ADMINLANG['aiSuggestions']['tone'] = "Tono";
$_ADMINLANG['aiSuggestions']['toneFormal'] = "Formale";
$_ADMINLANG['aiSuggestions']['toneFriendly'] = "Amichevole";
$_ADMINLANG['aiSuggestions']['toneTechnical'] = "Tecnico";
$_ADMINLANG['aiSuggestions']['unableToFindReplyBox'] = "Impossibile trovare la casella di risposta.";
$_ADMINLANG['aiSuggestions']['unknownDate'] = "Data sconosciuta";
$_ADMINLANG['aiSuggestions']['unknownError'] = "Errore sconosciuto";
$_ADMINLANG['aiSuggestions']['youRated'] = "Hai valutato questo:";
$_ADMINLANG['aiSuggestions']['yourFeedback'] = "Il tuo feedback:";
...
$_ADMINLANG['billing']['creditnote'] = "Nota di credito";
$_ADMINLANG['billing']['debitnote'] = "Nota di addebito";
...
$_ADMINLANG['billing']['ledger'] = "Libro mastro";
$_ADMINLANG['billing']['netIncome'] = "Incasso Netto";
$_ADMINLANG['billing']['nocomments'] = "Non ci sono commenti rivolti ai clienti per questo documento.";
$_ADMINLANG['billing']['offlinecc'] = "Elaborazione Offline CC";
$_ADMINLANG['billing']['title'] = "Amministrazione";
$_ADMINLANG['billing']['transaction'] = "Transazione";
...
$_ADMINLANG['billingnotes']['creditnote']['draftNotice'] = "Questa è una bozza di nota di credito. Il cliente non può visualizzare o accedere a questa nota di credito finché non fai clic su Emetti.";
$_ADMINLANG['billingnotes']['creditnote']['items'] = "Elementi della nota di credito";
$_ADMINLANG['billingnotes']['creditnote']['manage'] = "Gestisci nota di credito";
$_ADMINLANG['billingnotes']['creditnote']['number'] = "Numero della nota di credito";
$_ADMINLANG['billingnotes']['creditnote']['view'] = "Visualizza nota di credito";
$_ADMINLANG['billingnotes']['debitnote']['draftNotice'] = "Questa è una bozza di nota di addebito. Il cliente non può visualizzare o accedere a questa nota di addebito finché non fai clic su Emetti.";
$_ADMINLANG['billingnotes']['debitnote']['items'] = "Elementi della nota di debito";
$_ADMINLANG['billingnotes']['debitnote']['manage'] = "Gestisci nota di debito";
$_ADMINLANG['billingnotes']['debitnote']['number'] = "Numero della nota di debito";
$_ADMINLANG['billingnotes']['debitnote']['view'] = "Visualizza nota di addebito";
$_ADMINLANG['billingnotes']['immutableAttributeModification'] = "Il sistema non può modificare l'attributo \":attribute\" su una nota di fatturazione con stato \":status».";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemAddition'] = "Il sistema non può aggiungere una voce a una nota di fatturazione che non è in stato Bozza.";
$_ADMINLANG['billingnotes']['immutableBillingNoteLineItemModification'] = "Il sistema non può assegnare o modificare una voce in una nota di fatturazione che non è in stato Bozza (ID elemento riga: :lineItemId).";
$_ADMINLANG['billingnotes']['immutableModification'] = "Il sistema può modificare le note di fatturazione solo mentre sono in stato Bozza.";
...
$_ADMINLANG['clientsummary']['lastlogin']['datetime'] = "Ultimo Accesso";
$_ADMINLANG['clientsummary']['lastlogin']['host'] = "Ospite";
...
$_ADMINLANG['errorPage']['429']['subtitle'] = "Riprova più tardi.";
$_ADMINLANG['errorPage']['429']['title'] = "Limite di velocità superato";
...
$_ADMINLANG['errors']['immutableEntityModification'] = "Non puoi modificare questo articolo.";
...
$_ADMINLANG['fields']['clientcredit'] = "Credito del cliente";
...
$_ADMINLANG['fields']['reference'] = "Riferimento";
...
$_ADMINLANG['general']['creditnoteincinfo'] = "Inserisci l'incremento desiderato tra i numeri delle note di credito generati (impostazione predefinita:1, massimo: 999).";
$_ADMINLANG['general']['creditnoteincrementation'] = "Incremento del numero della nota di credito";
...
$_ADMINLANG['general']['debitnoteincinfo'] = "Inserisci l'incremento desiderato tra i numeri delle note di debito generate (impostazione predefinita:1, massimo: 999).";
$_ADMINLANG['general']['debitnoteincrementation'] = "Incremento del numero della nota di debito";
...
$_ADMINLANG['general']['disautorenewcancelinvoice'] = "Disattivare il rinnovo automatico e annullare le voci della fattura per questo dominio?";
$_ADMINLANG['general']['disautorenewdelinvoiceitems'] = "Questa azione eliminerà le seguenti voci della fattura: <br>%s";
...
$_ADMINLANG['general']['errorbillingnoteincrementinvalid'] = "Il valore :inputLabel deve essere compreso tra 1 e 999.";
...
$_ADMINLANG['general']['recaptchaform-resetPassword'] = "Reimpostazione della password (richiedi agli utenti di completare un CAPTCHA dopo più tentativi di reimpostazione della password).";
...
$_ADMINLANG['general']['seeActivityLog'] = "Consulta il registro delle attività per maggiori dettagli.";
...
$_ADMINLANG['gettingStartedWizard']['description']['adminLanguage'] = "Scegli la lingua che vedrai nell'area di amministrazione.";
...
$_ADMINLANG['gettingStartedWizard']['description']['clientLanguage'] = "Scegli la lingua che i tuoi clienti vedranno quando accederanno all'Area Clienti.";
...
$_ADMINLANG['gettingStartedWizard']['description']['languages'] = "Scegli la lingua che tu e i tuoi clienti visualizzate di default.";
...
$_ADMINLANG['gettingStartedWizard']['group']['languages'] = "Localizzazione";
...
$_ADMINLANG['gettingStartedWizard']['label']['adminLanguage'] = "Lingua dell'area di amministrazione";
...
$_ADMINLANG['gettingStartedWizard']['label']['clientLanguage'] = "Lingua Predefinita";
...
$_ADMINLANG['gettingStartedWizard']['title']['languages'] = "Seleziona la tua lingua predefinita.";
...
$_ADMINLANG['global']['lastActive'] = "Ultimo attivo";
...
$_ADMINLANG['global']['manageMember'] = "Gestisci amministratore";
...
$_ADMINLANG['global']['products'] = "Prodotti";
...
$_ADMINLANG['globalWarning']['invoiceImmutability']['description'] = "L'immutabilità della fattura è disabilitata. Abbiamo reso obsoleta la possibilità di modificare le fatture e rimuoveremo l'opzione per abilitare la mutabilità delle fatture in una versione futura.";
...
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['disabled'] = "Hai configurato il tuo sistema per consentire la modifica delle fatture (mutabilità delle fatture) per le fatture non in bozza. Questa funzionalità è stata resa obsoleta in WHMCS 9.0 e rimuoveremo la configurazione che consente questo comportamento in una versione futura.";
$_ADMINLANG['healthCheck']['checkInvoiceImmutability']['title'] = "Immutabilità della fattura";
...
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['in_progress'] = "La crittografia dell'archiviazione con autenticazione a due fattori è in corso.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['pass'] = "L'archiviazione con autenticazione a due fattori è sicura.";
$_ADMINLANG['healthCheck']['checkTwoFaStorageEncryption']['title'] = "Archiviazione con autenticazione a due fattori";
...
$_ADMINLANG['healthCheck']['learnMore'] = "Puoi saperne di più nella nostra documentazione.";
...
$_ADMINLANG['healthCheck']['phpSessionSupportSavePathIsNotWritableSafe'] = "L'archiviazione delle sessioni PHP non è scrivibile. Per assistenza, contattate il vostro amministratore di sistema. <a href=\"https://go.whmcs.com/2545/php-session-storage\">Scopri di più.</a>";
...
$_ADMINLANG['invoices']['cancel'] = "Sei sicuro di voler cancellare questa fattura? Gli articoli ricorrenti della fattura non verranno fatturati nuovamente per questa data.";
$_ADMINLANG['invoices']['cancelPayment'] = "Annulla pagamento";
$_ADMINLANG['invoices']['cancelTitle'] = "Annulla fattura";
...
$_ADMINLANG['invoices']['delete'] = "Sei sicuro di voler eliminare questa fattura?";
...
$_ADMINLANG['invoices']['immutableAttributeModification'] = "Il sistema non può modificare l'attributo \":attribute\" su una fattura con stato \":status».";
$_ADMINLANG['invoices']['immutableInvoiceLineItemAddition'] = "Il sistema non può aggiungere una voce a una fattura a meno che non sia in stato Bozza.";
$_ADMINLANG['invoices']['immutableInvoiceLineItemModification'] = "Il sistema non può assegnare o modificare una voce su una fattura a meno che non sia in stato Bozza (ID elemento riga: :lineItemId).";
$_ADMINLANG['invoices']['immutableModification'] = "Il sistema può modificare le fatture solo mentre sono in stato Bozza.";
...
$_ADMINLANG['invoices']['invalidMutationHelp'] = "L'immutabilità della fattura è disabilitata. È possibile richiedere modifiche di stato non valide nella scheda Opzioni di gestione della fattura &raquo; .";
$_ADMINLANG['invoices']['invalidStatusForCancelled'] = "Il sistema può trasferire una fattura a Annullata solo dai seguenti stati: Non pagata, Pagamento in sospeso o Incassi.";
$_ADMINLANG['invoices']['invalidStatusForDelete'] = "Il sistema può eliminare solo una bozza di fattura.";
$_ADMINLANG['invoices']['invalidStatusForPaid'] = "Il sistema può trasferire una fattura a Pagata solo dai seguenti stati: Non pagato, Pagamento in sospeso o Incassi.";
$_ADMINLANG['invoices']['invalidStatusForPayment'] = "Il sistema può applicare i pagamenti solo a una fattura con stato Non pagato, Pagamento in sospeso o Incassi.";
$_ADMINLANG['invoices']['invalidStatusForRefund'] = "Il sistema può rimborsare solo i pagamenti da una fattura in stato Non pagato, Pagamento in sospeso, Pagato o Incassi.";
$_ADMINLANG['invoices']['invalidStatusForUnpaid'] = "Fai clic per applicare una nota di credito per il saldo residuo, contrassegna Pagato ed esegui eventuali azioni successive al pagamento.";
...
$_ADMINLANG['invoices']['invoiceIsCancelled'] = "Questa è una fattura annullata.";
$_ADMINLANG['invoices']['invoiceIsCancelledDescription'] = "Per favore %s prima di applicare un pagamento";
$_ADMINLANG['invoices']['invoiceIsCollections'] = "Questa è una fattura di riscossione.";
$_ADMINLANG['invoices']['invoiceIsDraft'] = "Questa è una bozza di fattura.";
$_ADMINLANG['invoices']['invoiceIsImmutable'] = "Non è possibile modificare una fattura che è :status.";
$_ADMINLANG['invoices']['invoiceIsPaid'] = "Questa è una fattura pagata.";
$_ADMINLANG['invoices']['invoiceIsPaymentpending'] = "Questa è una fattura in attesa di pagamento.";
$_ADMINLANG['invoices']['invoiceIsRefunded'] = "Questa fattura è rimborsata.";
$_ADMINLANG['invoices']['invoiceIsUnpaid'] = "Questa è una fattura non pagata.";
...
$_ADMINLANG['invoices']['markCancelDesc'] = "Fai clic per generare e applicare le note di credito o di debito necessarie per trasferire la fattura in Annullata.";
$_ADMINLANG['invoices']['markPaidDesc'] = "Fai clic per generare e applicare una nota di credito per il saldo residuo e trasferire la fattura a Pagato. In questo modo verranno eseguite anche tutte le azioni successive al pagamento.";
...
$_ADMINLANG['invoices']['massUpdateResult']['cancelled'] = "Il sistema ha trasferito con successo le fatture :successes di :attempted a Annullate.";
$_ADMINLANG['invoices']['massUpdateResult']['deleted'] = "Il sistema ha eliminato con successo :successes delle fatture :attempted .";
$_ADMINLANG['invoices']['massUpdateResult']['paid'] = "Il sistema ha trasferito con successo le fatture :successes di :attempted a Pagate.";
$_ADMINLANG['invoices']['massUpdateResult']['unpaid'] = "Il sistema ha trasferito con successo le fatture :successes di :attempted a Unpaid.";
$_ADMINLANG['invoices']['massdeleteconfirm'] = "Sei sicuro di voler rimuovere le fatture selezionate?";
$_ADMINLANG['invoices']['massdeletemutationconfirm'] = "La tua selezione include fatture non in bozza. Il sistema modificherà queste fatture perché l'immutabilità delle fatture è disabilitata.";
...
$_ADMINLANG['marketConnect']['apiTokenDecryptFailed'] = "Il sistema non è riuscito a decrittografare un token API MarketConnect. Controlla l'hash di crittografia CC o disconnetti e ricollega il tuo account WHMCS Marketplace.";
$_ADMINLANG['marketConnect']['authenticationFailed'] = "Autenticazione fallita. Controlla le tue credenziali WHMCS Marketplace in Configurazione <i class='far fa-wrench' aria-hidden='true'></i> > Impostazioni di sistema > MarketConnect.";
...
$_ADMINLANG['marketConnect']['dynamicService']['firstBulletPoint'] = "Offri tutti i prodotti <b>:serviceName</b> .";
$_ADMINLANG['marketConnect']['gdprConsent'] = "Per iscriversi a WHMCS Marketplace, WHMCS Ltd. e le sue affiliate devono archiviare ed elaborare i tuoi dati personali in conformità con l'Informativa sulla privacy <a href=\"https://www.webpros.com/legal\">WebPros</a>.";
...
$_ADMINLANG['marketConnect']['learn']['tab']['about'] = "Dettagli";
...
$_ADMINLANG['marketConnect']['marketingOptIn'] = "WHMCS Ltd. e le sue affiliate del gruppo WebPros possono fornirmi notizie e offerte individuali sui prodotti WebPros in conformità con l'Informativa sulla privacy <a href=\"https://www.webpros.com/legal\">WebPros</a>. Posso revocare questo consenso facendo clic sul collegamento contenuto in qualsiasi comunicazione ricevuta.";
$_ADMINLANG['marketConnect']['perMo'] = ":num/mese";
$_ADMINLANG['marketConnect']['perMonth'] = ":num/mese";
$_ADMINLANG['marketConnect']['points'] = "Punti";
$_ADMINLANG['marketConnect']['pricing']['rrp'] = "Prezzo di vendita consigliato";
$_ADMINLANG['marketConnect']['refresh'] = "Aggiorna";
$_ADMINLANG['marketConnect']['sellingStatus'] = "Stato vendite";
$_ADMINLANG['marketConnect']['service']['about']['title'] = "Su di noi";
$_ADMINLANG['marketConnect']['service']['button']['activate'] = "Attiva";
$_ADMINLANG['marketConnect']['service']['button']['deactivate'] = "Disattiva";
$_ADMINLANG['marketConnect']['service']['button']['learnmore'] = "Dettagli";
$_ADMINLANG['marketConnect']['service']['button']['manage'] = "Gestisci";
$_ADMINLANG['marketConnect']['service']['button']['startSelling'] = "Inizia a vendere";
...
$_ADMINLANG['mergefields']['configoptions'] = "Configurazione. Opzioni (matrice)";
$_ADMINLANG['mergefields']['configoptionshtml'] = "Configurazione. Opzioni (HTML)";
...
$_ADMINLANG['permissions']['164'] = "Elenca note di credito e debito";
$_ADMINLANG['permissions']['165'] = "Crea nota di credito o debito";
$_ADMINLANG['permissions']['166'] = "Visualizza nota di credito o debito";
$_ADMINLANG['permissions']['167'] = "Gestisci nota di credito o debito";
$_ADMINLANG['permissions']['168'] = "Elimina nota di credito o di debito";
...
$_ADMINLANG['permissions']['missingPermShort'] = "Manca l'autorizzazione richiesta.";
...
$_ADMINLANG['products']['productgroupicon'] = "Icona del gruppo";
$_ADMINLANG['products']['productgroupiconPlaceHolder'] = "ad es. fa-solid fa-house";
...
$_ADMINLANG['status']['issued'] = "Emesso";
...
$_ADMINLANG['support']['aiAssisted'] = "Assistito dall'IA";
$_ADMINLANG['support']['aiConfirmReview'] = "Conferma revisione dei dati";
$_ADMINLANG['support']['aiConfirmReviewMessage'] = "Conferma di aver esaminato i dati del ticket sanificati e di essere pronto a generare suggerimenti di intelligenza artificiale. Rimuovi o maschera tutte le informazioni sensibili.";
$_ADMINLANG['support']['aiContentRequired'] = "Il contenuto è obbligatorio";
$_ADMINLANG['support']['aiCopilotNoPermission'] = "Nessuna autorizzazione per questa funzione per il tuo ruolo";
$_ADMINLANG['support']['aiEnterSanitizedContent'] = "Inserisci contenuti sanificati";
$_ADMINLANG['support']['aiEnterSanitizedSubject'] = "Inserisci oggetto sanificato";
$_ADMINLANG['support']['aiFeedbackPlaceholder'] = "Feedback opzionale";
$_ADMINLANG['support']['aiGenerate'] = "Genera";
$_ADMINLANG['support']['aiGenerateResponse'] = "Genera suggerimenti AI";
$_ADMINLANG['support']['aiHelpUsImproveResponses'] = "Aiutaci a migliorare le risposte dell'IA";
$_ADMINLANG['support']['aiHowHelpfulResponse'] = "Quanto è stata utile questa risposta?";
$_ADMINLANG['support']['aiInitialMessage'] = "Messaggio iniziale";
$_ADMINLANG['support']['aiPlaceholderContent'] = "Messaggio iniziale";
$_ADMINLANG['support']['aiPlaceholderSubject'] = "Oggetto del biglietto";
$_ADMINLANG['support']['aiPleaseImproveSuggestion'] = "Dicci come possiamo migliorare questo suggerimento";
$_ADMINLANG['support']['aiPrivacyCreditCard'] = "Numeri di carte di credito, password o dati sensibili";
$_ADMINLANG['support']['aiPrivacyCustomerInfo'] = "Nomi, email, numeri di telefono dei clienti";
$_ADMINLANG['support']['aiPrivacyDescription'] = "Rivedi e rimuovi qualsiasi informazione personale identificabile (PII) prima di generare suggerimenti di intelligenza artificiale:";
$_ADMINLANG['support']['aiPrivacyNotice'] = "Informativa sulla privacy:";
$_ADMINLANG['support']['aiPrivacyPersonalData'] = "Indirizzi personali o informazioni private";
$_ADMINLANG['support']['aiRateThisSuggestion'] = "Valuta questo suggerimento";
$_ADMINLANG['support']['aiRatingFeedback'] = "Fornisci feedback";
$_ADMINLANG['support']['aiRatingFeedbackHigh'] = "Condividi la tua esperienza positiva";
$_ADMINLANG['support']['aiRatingFeedbackLow'] = "Come possiamo migliorare?";
$_ADMINLANG['support']['aiRatingFeedbackMessage'] = "Apprezziamo il tuo feedback. Fateci sapere come possiamo migliorare i suggerimenti sull'intelligenza artificiale.";
$_ADMINLANG['support']['aiRatingFeedbackMessageHigh'] = "Siamo lieti che tu l'abbia trovato utile! Per favore condividi ciò che ha reso questo suggerimento efficace per te.";
$_ADMINLANG['support']['aiRatingFeedbackMessageLow'] = "Ci dispiace che questo suggerimento non abbia soddisfatto le tue aspettative. Fateci sapere cosa possiamo fare meglio.";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholder'] = "Inserisci qui il tuo feedback...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderHigh'] = "Condividi cosa l'ha reso utile...";
$_ADMINLANG['support']['aiRatingFeedbackPlaceholderLow'] = "Dicci come possiamo migliorare...";
$_ADMINLANG['support']['aiReplyThread'] = "Thread di risposta";
$_ADMINLANG['support']['aiResponseGenerated'] = "Risposta AI generata:";
$_ADMINLANG['support']['aiResponseGeneratedDescription'] = "Il sistema ha generato una risposta suggerita. Ora puoi inserirla nella tua risposta.";
$_ADMINLANG['support']['aiReviewConversationAnalysis'] = "Rivedi l'analisi delle conversazioni";
$_ADMINLANG['support']['aiSubject'] = "Oggetto del biglietto";
$_ADMINLANG['support']['aiSubjectRequired'] = "L'oggetto è obbligatorio";
$_ADMINLANG['support']['aiSubmitFeedback'] = "Invia feedback";
$_ADMINLANG['support']['aiSuggestions'] = "Suggerimenti per l'intelligenza artificiale";
$_ADMINLANG['support']['aiThankYouFeedback'] = "Grazie per il tuo feedback!";
$_ADMINLANG['support']['aiTicketContent'] = "Contenuto del biglietto";
...
$_ADMINLANG['support']['pinErrorTicket'] = "Si è verificato un errore durante il tentativo di bloccare il ticket.";
$_ADMINLANG['support']['pinTicket'] = "Biglietto Pin";
...
$_ADMINLANG['support']['ticket']['attachmentStorageError'] = "Errore durante il salvataggio dell'allegato: la cartella di destinazione non è scrivibile.</br>Controlla i permessi della tua cartella.";
...
$_ADMINLANG['support']['ticketemailerror'] = "Devi specificare un cliente esistente o inserire manualmente l'indirizzo email del destinatario.";
...
$_ADMINLANG['support']['ticketnameerror'] = "Devi inserire il nome della persona per cui stai creando questo ticket o specificare un cliente esistente.";
...
$_ADMINLANG['system']['intclientloginCaptchaWarning'] = "È necessario disabilitare Captcha per i moduli di accesso in <a href='configgeneral.php#tab=10'>Impostazioni di sicurezza</a> per utilizzare il codice di integrazione";
...
$_ADMINLANG['system']['intdoCaptchaWarning'] = "È necessario disabilitare Captcha for Domain Checker in <a href='configgeneral.php#tab=10'>Security Settings</a> per utilizzare il codice di integrazione";
...
$_ADMINLANG['taxconfig']['autoResetNumberingDescriptionBillingNote'] = "Consente di reimpostare automaticamente il numero di credito periodicamente.";
...
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNotes'] = "Note di credito personalizzate";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormat'] = "Formato di numerazione delle note di credito personalizzato";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberFormatDescription'] = "Il formato numerico delle note di credito. Se includi dei tag, il sistema li sostituirà automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumbering'] = "Numerazione personalizzata delle note di credito";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['customNumberingDescription'] = "Seleziona questa opzione per abilitare i formati di numerazione personalizzati per le note di credito.";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNoteNumber'] = "Numero della nota di credito successiva";
$_ADMINLANG['taxconfig']['billingNote']['creditNote']['nextCustomNumberDescription'] = "Il numero successivo della nota di credito da assegnare.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNotes'] = "Note di addebito personalizzate";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormat'] = "Formato di numerazione personalizzato delle note di debito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberFormatDescription'] = "Il formato numerico delle note di addebito. Se includi dei tag, il sistema li sostituirà automaticamente.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumbering'] = "Numerazione personalizzata delle note di debito";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['customNumberingDescription'] = "Seleziona per abilitare i formati di numerazione personalizzati per le note di debito.";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNoteNumber'] = "Numero della nota di addebito successiva";
$_ADMINLANG['taxconfig']['billingNote']['debitNote']['nextCustomNumberDescription'] = "Il numero della nota di addebito successiva da assegnare.";
...
$_ADMINLANG['taxconfig']['taxValidationClient'] = "Convalida il formato durante il checkout";
$_ADMINLANG['taxconfig']['taxValidationDisabled'] = "Non convalidare (disabilitato)";
$_ADMINLANG['taxconfig']['taxValidationServer'] = "Convalida con l'autorità competente";
$_ADMINLANG['taxconfig']['taxValidationServerClient'] = "Convalida al momento del pagamento e con l'autorità competente";
...
$_ADMINLANG['taxconfig']['vatAutoConfiguration'] = "Aggiorna automaticamente le regole IVA";
$_ADMINLANG['taxconfig']['vatAutoConfigurationDescription'] = "Attiva o disattiva i controlli automatici per le regole IVA aggiornate. <a href=\"https://go.whmcs.com/2541/auto-update-vat\" target=\"_blank\">Scopri di più</a>.";
...
$_ADMINLANG['userLogin']['createAccount'] = "Crea Account";
...
$_ADMINLANG['validation']['password']['max'] = "Le password non possono contenere più di :max caratteri.";
...
$_ADMINLANG['wizard']['mixpanelBannerAccept'] = "Consenti il tracciamento";
$_ADMINLANG['wizard']['mixpanelBannerDismiss'] = "Negare il tracciamento";
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "<strong>Aiutaci a migliorare WHMCS</strong><br /> Utilizziamo il tracciamento anonimo per migliorare WHMCS. La tua partecipazione ci aiuta a rendere WHMCS più intuitivo e facile da usare. <a href=\"https://go.whmcs.com/2401/analytics-tracking\" target=\"_blank\">Scopri di più sui dati che raccogliamo</a>.";
