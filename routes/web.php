...
// Stripe callbacks (no auth required â€” user returns from Stripe)
...
// Stripe checkout initiation (requires auth â€” creates Stripe session)
...
Route::prefix('admin')->middleware(['admin', 'admin.module'])->name('admin.')->group(function () {
    ...
    // Users Management
    Route::post('users/mark-all-read', [AdminUserController::class, 'markAllRead'])->name('users.mark-all-read');
    ...
    // Contacts Management
    Route::post('contacts/mark-all-read', [AdminContactController::class, 'markAllRead'])->name('contacts.mark-all-read');
    ...
    Route::prefix('affiliate')->name('affiliate.')->group(function () {
        ...
        Route::post('/referrals/{referral}/approve', [AffiliateManagementController::class, 'approveReferral'])->name('referrals.approve');
        Route::post('/referrals/{referral}/adjust-commission', [AffiliateManagementController::class, 'adjustReferralCommission'])->name('referrals.adjust-commission');
